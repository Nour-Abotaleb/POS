                ...
                <div class="flex items-center gap-4">
                    ...
                    <div class="inline-flex rounded-lg shadow-sm">
                        ...
                        <button type="button" wire:click="$set('viewType', 'grid')"
                            style="<?php echo e($viewType === 'grid' ? 'background-color: #011646; color: white;' : ''); ?>"
                         ...
                         <?php $__env->slot('trigger', null, []); ?> 
                            <span class="inline-flex rounded-md">
                                <button type="button"
                                    ...
                                    <?php if(is_null($filterAvailable)): ?>
                                    ...
                                    <svg class="-me-1 ml-1.5 w-5 h-5" fill="currentColor" viewbox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
...
<?php endif; ?>
    ...
    <div class="flex flex-col my-4 px-4">
        ...
        <!-- Card Section -->
        <div class="space-y-8">
            <?php $__currentLoopData = $tables; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $area): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php endif; ?>
                                            ...
                                            <?php if($item->activeOrder->status == 'kot' && user_can('Create Order')): ?>
                                                <?php if (isset($component)) { $__componentOriginal3b0e04e43cf890250cc4d85cff4d94af = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3b0e04e43cf890250cc4d85cff4d94af = $attributes; } ?>
...
$__html = app('livewire')->mount($__name, $__params, 'lw-2440532378-0', $__slots ?? [], get_defined_vars());
...
<?php /**PATH C:\xampp\htdocs\script\resources\views\livewire\table\tables.blade.php ENDPATH**/ ?>