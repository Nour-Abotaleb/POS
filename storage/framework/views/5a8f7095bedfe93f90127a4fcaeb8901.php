        ...
        <div class="grid grid-cols-1 gap-4 mb-4 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <div class="p-4 bg-blue-50 rounded-xl shadow-sm dark:bg-blue-900/10 border border-blue-100 dark:border-blue-800">
                ...
                <?php if(!empty($topWaiters)): ?>
                    <div class="space-y-2">
                        <?php $__currentLoopData = $topWaiters; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $waiter): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <div class="overflow-x-auto bg-white dark:bg-gray-800 p-4">
        <table class="min-w-full border border-gray-200 dark:border-gray-700 rounded-lg overflow-hidden">
            ...
            <tbody class="divide-y divide-gray-200 dark:divide-gray-700 bg-white dark:bg-gray-800">
                <?php $__empty_1 = true; $__currentLoopData = $removedKotItems ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
                        ...
                        <td class="p-4 text-sm font-medium text-gray-900 dark:text-white whitespace-nowrap">
                            <?php if($item->kot && $item->kot->order): ?>
                            ...
                            <?php elseif($item->kot && $item->kot->order && $item->kot->order->waiter): ?>
                                ...
                                <div class="flex items-center">
                                    <div>
                                        ...
                                        <?php if($item->kot->order->waiter->email): ?>
                        ...
                        <td class="p-4 text-sm text-gray-900 dark:text-white">
                            ...
                            ?>
                            <?php if($tableName !== $notAvailableText): ?>
            ...
            <?php if(count($removedKotItems ?? []) > 0): ?>
