                ...
                <div class="overflow-hidden shadow">
                    <table class="min-w-full divide-y divide-gray-200 table-fixed dark:divide-gray-600">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                            <!--[if BLOCK]><![endif]--><?php if($expenses->count() > 0): ?>
                                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $expenses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $expense): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                        ...
                                        <td class="py-2.5 px-4 text-gray-900 dark:text-white">
                                            <?php echo currency_format($expense->amount, restaurant()->currency_id); ?></td>
                                        <td class="py-2.5 px-4 text-gray-900 dark:text-white">
                                            <?php echo e($expense->expense_date->translatedFormat('d M, Y')); ?>
                                        ...
                                        <td class="py-2.5 px-4 text-gray-900 dark:text-white">
                                            <?php echo e($expense->payment_date ? $expense->payment_date->translatedFormat('d M, Y') : '--'); ?>

                                        </td>
                                        <td class="py-2.5 px-4 text-gray-900 dark:text-white">
                                            <?php echo e($expense->payment_due_date ? $expense->payment_due_date->translatedFormat('d M, Y') : '--'); ?>

                                        </td>

                                        <td class="py-2.5 px-4 text-gray-900 dark:text-white">
                                            <!--[if BLOCK]><![endif]--><?php if(!$expense->payment_method): ?>
                                                <span
                                            ...
                                            <?php else: ?>
                                                ...
                                                <!--[if BLOCK]><![endif]--><?php if($expense->payment_method == 'cash'): ?>
                                                    <span
                                                        class="ml-2 inline-flex items-center px-2.5 py-1.5 rounded text-xs font-medium bg-gray-100 text-gray-800">
                                        ...
                                        <td class="py-2.5 px-4 space-x-2 text-right">
                                            <!--[if BLOCK]><![endif]--><?php if(user_can('Update Expense')): ?>
...
<?php endif; ?>
                                            ...
                                            <!--[if BLOCK]><![endif]--><?php if(user_can('Delete Expense')): ?>
...
<?php $component->withAttributes(['wire:model.live' => 'showExpenseDetailsModal']); ?>
         ...
         <?php $__env->slot('content', null, []); ?> 
            <!--[if BLOCK]><![endif]--><?php if($viewExpenseDetails): ?>
                <?php
...
$__html = app('livewire')->mount($__name, $__params, microtime(), $__slots ?? [], get_defined_vars());
...
<?php $component->withAttributes(['wire:model.live' => 'showEditExpenseModal']); ?>
         ...
         <?php $__env->slot('content', null, []); ?> 
            <!--[if BLOCK]><![endif]--><?php if($selectedExpenses): ?>
                <?php
$__split = function ($name, $params = []) {
    return [$name, $params];
};
...
<?php endif; ?>
            ...
            <!--[if BLOCK]><![endif]--><?php if($deleteExpense): ?>
...
<?php /**PATH C:\xampp\htdocs\script\resources\views/livewire/payments/expenses.blade.php ENDPATH**/ ?>