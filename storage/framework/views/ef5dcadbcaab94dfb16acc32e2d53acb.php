                ...
                <tr class="<?php echo e($rowClass); ?>">
                        ...
                        <div class="flex items-center space-x-3">
                            ...
                            <div class="flex-grow">
                                <div class="flex items-center space-x-2">
                                    ...
                                    <?php if($isInstalled && $isLicensed): ?>

                                        <?php if(module_enabled('UniversalBundle') && isInstallFromUniversalBundleModule($module)): ?>
                                ...
                                <?php endif; ?>
                                        ...
                                        <?php if($fetchSetting && $fetchSetting->supported_until && !$universalBundle): ?>
                                            <?php
                    ...
                    <td class="px-3 sm:px-6 py-4 whitespace-nowrap text-sm">
                        <?php if($settingClass): ?>
                            ...
                            <?php if($plugins->where('envato_id', $envatoId)->first() && !(module_enabled('UniversalBundle') && isInstallFromUniversalBundleModule($key))): ?>
...
<?php /**PATH C:\xampp\htdocs\script\resources\views\custom-modules\ajax\custom.blade.php ENDPATH**/ ?>