<div>
    <div class="p-4 bg-white block sm:flex items-center justify-between dark:bg-gray-800 dark:border-gray-700">
        <div class="w-full mb-1">
            ...
            <!--[if BLOCK]><![endif]--><?php if(user_can('Create Area')): ?>
...
<?php endif; ?>
<?php $component->withAttributes(['type' => 'button','wire:click' => '$toggle(\'showAddAreaModal\')']); ?><?php echo app('translator')->get('modules.table.addArea'); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
                ...
                <div class="overflow-hidden shadow">
                    <table class="min-w-full divide-y divide-gray-200 table-fixed dark:divide-gray-600">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700" wire:key='menu-item-list-<?php echo e(microtime()); ?>'>
                            ...
                            <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $areas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="hover:bg-gray-100 dark:hover:bg-gray-700" wire:key='menu-item-<?php echo e($item->id . microtime()); ?>' wire:loading.class.delay='opacity-10'>
                                ...
                                <td class="py-2.5 px-4 space-x-2 whitespace-nowrap text-right">
                                    <!--[if BLOCK]><![endif]--><?php if(user_can('Update Area')): ?>
...
<?php endif; ?>
                                    ...
                                    <!--[if BLOCK]><![endif]--><?php if(user_can('Delete Area')): ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.right-modal','data' => ['wire:model.live' => 'showAddAreaModal']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:model.live' => 'showAddAreaModal']); ?>
...
$__html = app('livewire')->mount($__name, $__params, 'lw-2897426131-0', $__slots ?? [], get_defined_vars());
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.secondary-button','data' => ['wire:click' => '$set(\'showAddAreaModal\', false)','wire:loading.attr' => 'disabled']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:click' => '$set(\'showAddAreaModal\', false)','wire:loading.attr' => 'disabled']); ?>
...
<?php endif; ?>
    ...
    <!--[if BLOCK]><![endif]--><?php if($activeArea): ?>
    <?php if (isset($component)) { $__componentOriginal2b7129b9a6e7f6a1be2b5d072517af13 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal2b7129b9a6e7f6a1be2b5d072517af13 = $attributes; } ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.confirmation-modal','data' => ['wire:model' => 'confirmDeleteAreaModal']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:model' => 'confirmDeleteAreaModal']); ?>
         <?php $__env->slot('title', null, []); ?> 
...
<?php /**PATH C:\xampp\htdocs\script\resources\views/livewire/area/areas.blade.php ENDPATH**/ ?>