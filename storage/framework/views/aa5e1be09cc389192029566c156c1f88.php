...
<?php endif; ?>
    ...
    <div class="flex flex-col my-4 px-4">
        ...
        <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
            <?php $__empty_1 = true; $__currentLoopData = $menus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <!-- Card -->
            <a
            style="<?php echo e($menuId == $item->id ? 'background-color: #011646;' : ''); ?>"
            class="<?php echo \Illuminate\Support\Arr::toCssClasses(['group flex flex-col border shadow-sm rounded-lg hover:shadow-md transition dark:bg-gray-700 dark:border-gray-600', 'bg-white dark:bg-gray-700' => ($menuId != $item->id)]); ?>"
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="grow ms-5">
                            <h3 wire:loading.class.delay='opacity-50'
                                class="<?php echo \Illuminate\Support\Arr::toCssClasses(['font-semibold dark:group-hover:text-neutral-400 dark:text-neutral-200', 'text-gray-800 group-hover-text-theme' => ($menuId != $item->id), 'text-white group-hover:text-white' => ($menuId == $item->id)]); ?>">
...
$__html = app('livewire')->mount($__name, $__params, 'menu-item-'.e(microtime()).'', $__slots ?? [], get_defined_vars());
