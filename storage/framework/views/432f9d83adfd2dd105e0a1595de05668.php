...
?>
<?php if($plugins->where('envato_id', $envatoId)->first()): ?>
    <?php if($latestVersion > $version): ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\script\resources\views\custom-modules\sections\version.blade.php ENDPATH**/ ?>