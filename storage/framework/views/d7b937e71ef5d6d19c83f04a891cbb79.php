                    ...
                    <div class="overflow-hidden shadow">
                        <table class="min-w-full divide-y divide-gray-200 table-fixed dark:divide-gray-600">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700"
                                ...
                                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $languageSettings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="hover:bg-gray-100 dark:hover:bg-gray-700"
                                    ...
                                    <td class="py-2.5 px-4 space-x-2 whitespace-nowrap ltr:text-left rtl:text-right">
                                        <!--[if BLOCK]><![endif]--><?php if($item->is_rtl): ?>
                                    ...
                                    <!--[if BLOCK]><![endif]--><?php if($item->language_code != global_setting()->locale): ?>
                                        <td class="py-2.5 px-4 text-base text-gray-900 whitespace-nowrap dark:text-white ltr:text-left rtl:text-right">
...
$__html = app('livewire')->mount($__name, $__params, 'lw-3312799359-0', $__slots ?? [], get_defined_vars());
...
<?php endif; ?>
    ...
    <!--[if BLOCK]><![endif]--><?php if($showEditLanguageModal): ?>
    <?php if (isset($component)) { $__componentOriginal2b7129b9a6e7f6a1be2b5d072517af13 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal2b7129b9a6e7f6a1be2b5d072517af13 = $attributes; } ?>
...
$__html = app('livewire')->mount($__name, $__params, 'lw-3312799359-1', $__slots ?? [], get_defined_vars());
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.confirmation-modal','data' => ['wire:model' => 'confirmDeleteLanguageModal']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:model' => 'confirmDeleteLanguageModal']); ?>
         <?php $__env->slot('title', null, []); ?> 
...
<?php endif; ?>
            ...
            <!--[if BLOCK]><![endif]--><?php if($language): ?>
...
<?php $__env->stopPush(); ?><?php /**PATH C:\xampp\htdocs\script\resources\views/livewire/settings/language-settings.blade.php ENDPATH**/ ?>