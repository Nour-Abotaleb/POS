<div class="relative">
    ...
    <span
        class="inline-flex items-center justify-center px-2 py-0.5 ms-2 text-xs font-semibold text-white bg-[var(--brand-primary)] rounded-md" style="background-color: var(--brand-primary); border-color: var(--brand-primary);">
        <?php echo e($count); ?>
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\xampp\htdocs\script\resources\views/livewire/dashboard/today-reservations.blade.php ENDPATH**/ ?>