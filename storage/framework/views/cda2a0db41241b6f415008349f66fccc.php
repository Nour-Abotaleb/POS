                ...
                <div class="flex flex-row rtl:flex-row-reverse items-center gap-4">
                    ...
                    <div class="inline-flex flex-row rtl:flex-row-reverse rounded-lg shadow-sm">
                        <button type="button" wire:click="$set('viewType', 'list')"
                            style="<?php echo e($viewType === 'list' ? 'background-color: var(--brand-primary); color: white;' : ''); ?>"
                        ...
                        <button type="button" wire:click="$set('viewType', 'grid')"
                            style="<?php echo e($viewType === 'grid' ? 'background-color: var(--brand-primary); color: white;' : ''); ?>"
                        ...
                        <button type="button" wire:click="$set('viewType', 'layout')"
                            style="<?php echo e($viewType === 'layout' ? 'background-color: var(--brand-primary); color: white;' : ''); ?>"
                         ...
                         <?php $__env->slot('trigger', null, []); ?> 
                            <span class="inline-flex rounded-md">
                                <button type="button"
                                    ...
                                    <!--[if BLOCK]><![endif]--><?php if(is_null($filterAvailable)): ?>
...
<?php endif; ?>
<?php $component->withAttributes(['type' => 'button','wire:click' => '$toggle(\'showAddTableModal\')']); ?><?php echo app('translator')->get('modules.table.addTable'); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
        ...
        <div class="mb-6 lg:flex lg:justify-between">
            <ul class="inline-flex flex-wrap text-sm font-medium text-center text-gray-500 dark:text-gray-400 mb-4 rtl:flex-row-reverse">
                <li class="me-2 rtl:ms-2 rtl:me-0" wire:key='area-fltr-<?php echo e(microtime()); ?>'>
                    ...
                    style="<?php echo e(is_null($areaID) ? 'color: var(--brand-primary); background-color: rgba(1, 22, 70, 0.2);' : ''); ?>"
                ...
                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $areas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <li class="me-2 rtl:ms-2 rtl:me-0" wire:key='area-fltr-<?php echo e($item->id.microtime()); ?>'>
                        <a href="javascript:;" wire:click="$set('areaID', '<?php echo e($item->id); ?>')"
                            style="<?php echo e($areaID == $item->id ? 'color: var(--brand-primary); background-color: rgba(1, 22, 70, 0.2);' : ''); ?>"
        ...
        <div class="space-y-8">
            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $tables; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $area): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="flex flex-col gap-3 sm:gap-4 space-y-1" wire:key='area-<?php echo e($area->id . microtime()); ?>'>
                    ...
                    <!--[if BLOCK]><![endif]--><?php if($viewType === 'layout'): ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.restaurant-table','data' => ['wire:key' => 'table-'.e($item->id . microtime()).'','wire:click' => 'showTableOrder('.e($item->id).')','shape' => $item->seating_capacity >= 4 ? 'rectangle' : 'circle','seats' => $item->seating_capacity,'code' => $item->table_code,'status' => $item->available_status,'isInactive' => $item->status === 'inactive','kotCount' => $item->activeOrder ? $item->activeOrder->kot->count() : 0,'isReservationActive' => $isReservationActive,'class' => 'scale-75']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:key' => 'table-'.e($item->id . microtime()).'','wire:click' => 'showTableOrder('.e($item->id).')','shape' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($item->seating_capacity >= 4 ? 'rectangle' : 'circle'),'seats' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($item->seating_capacity),'code' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($item->table_code),'status' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($item->available_status),'is-inactive' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($item->status === 'inactive'),'kot-count' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($item->activeOrder ? $item->activeOrder->kot->count() : 0),'is-reservation-active' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($isReservationActive),'class' => 'scale-75']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                                            ...
                                            <!--[if BLOCK]><![endif]--><?php if($item->activeOrder->status == 'kot' && user_can('Create Order')): ?>
                                                <?php if (isset($component)) { $__componentOriginal3b0e04e43cf890250cc4d85cff4d94af = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3b0e04e43cf890250cc4d85cff4d94af = $attributes; } ?>
...
<?php endif; ?>
                                        ...
                                        <!--[if BLOCK]><![endif]--><?php if(user_can('Update Table')): ?>
                                        <?php if (isset($component)) { $__componentOriginal3b0e04e43cf890250cc4d85cff4d94af = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3b0e04e43cf890250cc4d85cff4d94af = $attributes; } ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.right-modal','data' => ['wire:model.live' => 'showAddTableModal']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:model.live' => 'showAddTableModal']); ?>
...
$__html = app('livewire')->mount($__name, $__params, 'lw-1299230356-0', $__slots ?? [], get_defined_vars());
...
?>
         ...
         <?php $__env->slot('footer', null, []); ?> 
            <?php if (isset($component)) { $__componentOriginal3b0e04e43cf890250cc4d85cff4d94af = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3b0e04e43cf890250cc4d85cff4d94af = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.secondary-button','data' => ['wire:click' => '$set(\'showAddTableModal\', false)','wire:loading.attr' => 'disabled']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('secondary-button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:click' => '$set(\'showAddTableModal\', false)','wire:loading.attr' => 'disabled']); ?>
...
<?php endif; ?>
    ...
    <!--[if BLOCK]><![endif]--><?php if($activeTable): ?>
    <?php if (isset($component)) { $__componentOriginal2b7129b9a6e7f6a1be2b5d072517af13 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal2b7129b9a6e7f6a1be2b5d072517af13 = $attributes; } ?>
...
<?php /**PATH C:\xampp\htdocs\script\resources\views/livewire/table/tables.blade.php ENDPATH**/ ?>