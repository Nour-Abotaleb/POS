                    ...
                    <div class="w-full md:flex-1">
                        ...
                        <div class="<?php echo \Illuminate\Support\Arr::toCssClasses([
                            ...
                            <button wire:click="addTipModal"
                                ...
                                <?php if($order && $order->tip_amount > 0): ?>
                                    <div class="text-sm">
                ...
                <div x-show="showSplitOptions"
                    ...
                    <div class="flex-1 overflow-y-auto my-4">
                        ...
                        <div x-show="splitType === 'custom'" class="h-full flex flex-col">
                            <div class="flex flex-col sm:flex-row items-start sm:items-center gap-2 border-b pb-4">
                                <div class="flex flex-wrap gap-2 flex-1">
                                    <?php $__currentLoopData = $customSplits; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $splitNumber): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="flex items-center gap-1">
                                            <div class="px-4 py-2 rounded-lg text-sm border">
                                                <span>Split <?php echo e($splitNumber); ?></span>
                                            </div>
                                            <?php if(count($customSplits) > 2): ?>
                        ...
                        <div x-show="splitType === 'items'" class="space-y-6">
                            ...
                            <div class="flex flex-col sm:flex-row items-start sm:items-center gap-2 border-b pb-4">
                                <div class="flex flex-wrap gap-2 flex-1">
                                    <?php $__currentLoopData = $splits; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $splitId => $split): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="flex items-center gap-1">
                                            ...
                                            <?php if(count($splits) > 1 && $splitId !== 1): ?>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div class="space-y-3">
                                    <div class="flex items-center gap-4">
                                        <div class="flex-1 flex justify-between items-center text-gray-500 dark:text-gray-300">
                                            ...
                                            <div class="text-sm">
                                                ...
                                                <?php if(restaurant()->tax_mode === 'item' && isset($splits[$activeSplitId]['tax_total']) && $splits[$activeSplitId]['tax_total'] > 0): ?>
                                    ...
                                    <div class="space-y-2 max-h-[300px] sm:max-h-[400px] overflow-y-auto">
                                        <?php if(empty($splits[$activeSplitId]['items'])): ?>
                                        ...
                                        <?php else: ?>
                                            <?php $__currentLoopData = $splits[$activeSplitId]['items']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div class="space-y-2">
                                    ...
                                    <template x-if="splitType === 'custom'">
                                        <div>
                                            ...
                                            <?php if(($balanceAmount > 0 || $returnAmount > 0)): ?>
                                                <div class="<?php echo \Illuminate\Support\Arr::toCssClasses([
