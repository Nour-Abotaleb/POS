...
<?php endif; ?>
    ...
    <div class="flex flex-col">
        ...
        <div class="overflow-x-auto">
            <div class="mb-4 mx-4">
            <?php $__errorArgs = ['currency_error'];
                            ...
                            <tr class="hover:bg-gray-100 dark:hover:bg-gray-700 <?php echo e($item->id == $defaultCurrencyId ? 'bg-blue-50 dark:bg-blue-900/20 border-l-4 border-blue-500' : ''); ?>" wire:key='member-<?php echo e($item->id . rand(1111, 9999) . microtime()); ?>' wire:loading.class.delay='opacity-10'>
                                <td class="py-2.5 px-4 text-base text-gray-900 whitespace-nowrap dark:text-white">
                                    <div class="flex items-center gap-2">
                                        ...
                                        <?php if($item->id == $defaultCurrencyId): ?>
...
$__html = app('livewire')->mount($__name, $__params, 'lw-3631099674-0', $__slots ?? [], get_defined_vars());
...
<?php /**PATH C:\xampp\htdocs\script\resources\views\livewire\settings\superadmin-currency-settings.blade.php ENDPATH**/ ?>