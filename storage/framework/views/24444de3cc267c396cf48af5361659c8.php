<div>
    ...
    <div class="flex flex-col my-4 px-4">
        ...
        <!-- Card Section -->
        <div class="space-y-8">
            <!--[if BLOCK]><![endif]--><?php if(is_null($areaID)): ?>
                    ...
                    <div class="grid sm:grid-cols-3 lg:grid-cols-4 gap-3 sm:gap-6">
                        <div class='group flex flex-col gap-3 border shadow-sm rounded-lg hover:shadow-md transition dark:bg-gray-700 dark:border-gray-600 p-3'
                            ...
                            <div class="w-full flex justify-center min-h-[120px] items-center bg-gray-100 dark:bg-gray-700 rounded-lg">
                                <!--[if BLOCK]><![endif]--><?php if(branch()->qrCodeFileExists()): ?>
                                    <img src="<?php echo e(branch()->qRCodeUrl); ?>" alt="QR Code">
                                <?php else: ?>
                                    <p class="text-sm text-gray-500 dark:text-gray-400 px-4 text-center"><?php echo app('translator')->get('modules.table.qrCodeNotGenerated'); ?></p>
...
<?php endif; ?>
<?php $component->withAttributes(['wire:click' => 'downloadBranchQrCode','class' => 'text-xs','data-tooltip-target' => 'download-tooltip-toggle','type' => 'button','data-tooltip-placement' => 'top']); ?>
                            ...
                            <div class="<?php echo \Illuminate\Support\Arr::toCssClasses([
                                ...
                                <div class="flex items-center gap-4 justify-between w-full">
                                    ...
                                    <div class="space-y-1">
                                        ...
                                        <!--[if BLOCK]><![endif]--><?php if($item->available_status == 'reserved'): ?>
                                ...
                                <div class="w-full flex justify-center min-h-[120px] items-center bg-gray-100 dark:bg-gray-700 rounded-lg">
                                    <!--[if BLOCK]><![endif]--><?php if($item->qrCodeFileExists()): ?>
...
<?php /**PATH C:\xampp\htdocs\script\resources\views/livewire/qr-code/qr-codes.blade.php ENDPATH**/ ?>