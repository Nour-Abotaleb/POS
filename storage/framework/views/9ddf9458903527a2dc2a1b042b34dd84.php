<div x-data="kioskApp()" class="min-h-screen">
    ...
    <!--[if BLOCK]><![endif]--><?php if(empty($currentKioskId)): ?>
        ...
        <div class="min-h-screen flex items-center justify-center p-6">
            <div class="w-full max-w-md bg-white dark:bg-gray-800 rounded-xl shadow p-6 space-y-4">
                ...
                <!--[if BLOCK]><![endif]--><?php if($kiosks->count() == 0): ?>
                <div class="text-center py-8 space-y-6">
                    ...
                    <div class="space-y-2">
                        <h3 class="text-xl font-semibold text-gray-900 dark:text-gray-100">
                            <?php echo e(trans('kiosk::modules.settings.no_kiosks')); ?>

                        </h3>
                        <p class="text-gray-600 dark:text-gray-400 max-w-sm mx-auto">
                            <?php echo e(trans('kiosk::modules.settings.no_kiosks_subheading')); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.primary-link','data' => ['href' => ''.e(route('settings.index').'?tab=kioskSettings').'','class' => 'inline-flex items-center gap-2 px-6 py-3 text-white font-medium rounded-lg shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-200']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['href' => ''.e(route('settings.index').'?tab=kioskSettings').'','class' => 'inline-flex items-center gap-2 px-6 py-3 text-white font-medium rounded-lg shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-200']); ?>
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"></path>
                            </svg>
                            <?php echo e(trans('kiosk::modules.settings.add_kiosk_button')); ?>
...
<?php endif; ?>
                ...
                <?php else: ?>
                <h2 class="text-lg font-semibold text-gray-900 dark:text-gray-100"><?php echo e(trans('kiosk::modules.settings.selector_heading')); ?></h2>
                <p class="text-sm text-gray-600 dark:text-gray-300"><?php echo e(trans('kiosk::modules.settings.selector_subheading')); ?></p>
                <div>
                    <label for="kioskSelect" class="block text-sm font-medium mb-2 text-gray-700 dark:text-gray-300"><?php echo e(trans('kiosk::modules.settings.selector_label')); ?></label>
                    <select id="kioskSelect" class="w-full rounded border-gray-300 dark:border-gray-600 dark:bg-gray-900 dark:text-gray-100">
                        <option value=""><?php echo e(trans('kiosk::modules.settings.selector_placeholder')); ?></option>
                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $kiosks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($k->code); ?>"><?php echo e($k->name); ?> (<?php echo e($k->code); ?>)</option>
                ...
                <div class="flex justify-end gap-3">
                    ...
                    })()"><?php echo e(trans('kiosk::modules.settings.selector_continue')); ?></button>
                </div>
...
[$__name, $__params] = $__split('kiosk::kiosk.welcome', ['restaurant' => $restaurant, 'shopBranch' => $shopBranch]);

$__html = app('livewire')->mount($__name, $__params, 'lw-2422772238-0', $__slots ?? [], get_defined_vars());
...
[$__name, $__params] = $__split('kiosk::kiosk.order-type', ['restaurant' => $restaurant, 'shopBranch' => $shopBranch]);

$__html = app('livewire')->mount($__name, $__params, 'lw-2422772238-1', $__slots ?? [], get_defined_vars());
...
[$__name, $__params] = $__split('kiosk::kiosk.menu', ['restaurant' => $restaurant, 'shopBranch' => $shopBranch]);

$__html = app('livewire')->mount($__name, $__params, 'lw-2422772238-2', $__slots ?? [], get_defined_vars());
...
[$__name, $__params] = $__split('kiosk::kiosk.item-customisation', ['restaurant' => $restaurant, 'shopBranch' => $shopBranch]);

$__html = app('livewire')->mount($__name, $__params, 'lw-2422772238-3', $__slots ?? [], get_defined_vars());
...
[$__name, $__params] = $__split('kiosk::kiosk.cart-summary', ['restaurant' => $restaurant, 'shopBranch' => $shopBranch, 'kioskId' => session('kiosk_id')]);

$__html = app('livewire')->mount($__name, $__params, 'lw-2422772238-4', $__slots ?? [], get_defined_vars());
...
[$__name, $__params] = $__split('kiosk::kiosk.payment-method', ['restaurant' => $restaurant, 'shopBranch' => $shopBranch, 'kioskId' => session('kiosk_id')]);

$__html = app('livewire')->mount($__name, $__params, 'lw-2422772238-5', $__slots ?? [], get_defined_vars());
...
</div><?php /**PATH C:\xampp\htdocs\script\Modules/Kiosk\Resources/views/livewire/kiosk/dashboard.blade.php ENDPATH**/ ?>