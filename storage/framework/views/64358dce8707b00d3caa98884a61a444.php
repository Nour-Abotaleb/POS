        ...
        <div
            ...
            <div class="flex flex-col justify-center items-center space-y-4">
                <a class="flex gap-2 items-center text-xl font-medium dark:text-white app-logo">
                    <img src="<?php echo e($appTheme->logoUrl); ?>" class="h-8" alt="Logo" />
                    <?php if($appTheme->show_logo_text): ?>
                        <?php echo e($appTheme->name); ?>
...
$__html = app('livewire')->mount($__name, $__params, 'lw-2262895296-0', $__slots ?? [], get_defined_vars());
...
<?php if(global_setting()->is_pwa_install_alert_show == 1): ?>
    <script>
        (function () {
...
<?php /**PATH C:\xampp\htdocs\script\resources\views/layouts/auth.blade.php ENDPATH**/ ?>