<div class="flex flex-col bg-white border shadow-sm rounded-xl dark:bg-gray-900 dark:border-gray-700 dark:shadow-gray-700/70 p-3 space-y-3 min-h-0">
    <div class="flex flex-col sm:flex-row sm:justify-between gap-2">
        <div class="text-base font-semibold text-gray-800 dark:text-white flex items-center gap-2 flex-wrap">
            <?php if(!is_null($reservation->table_id)): ?>
            <div class="flex items-center gap-2">
                ...
                <?php if(user_can('Update Reservation')): ?>
...
<?php endif; ?>
            ...
            <?php if(is_null($reservation->table_id) && user_can('Update Reservation')): ?>
            <?php if (isset($component)) { $__componentOriginal3b0e04e43cf890250cc4d85cff4d94af = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3b0e04e43cf890250cc4d85cff4d94af = $attributes; } ?>
...
<?php endif; ?>
        ...
        <div class="text-gray-700 dark:text-gray-400 flex flex-col space-y-1 sm:space-y-2 text-right">
            ...
            <div class="inline-flex gap-2 items-center text-xs sm:text-sm font-medium text-skin-base justify-end">
                ...
                <span class="text-xs sm:text-sm"><?php echo e($reservation->reservation_date_time->translatedFormat('l, d M, h:i A')); ?></span>
            </div>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-4 p-2 sm:p-3 bg-gray-100 rounded-md dark:bg-gray-700 dark:text-gray-300">
        ...
        <?php if(!is_null($reservation->customer->email)): ?>
        ...
        <?php if(!is_null($reservation->customer->phone)): ?>
        <div class="text-xs inline-flex items-center gap-1">
    ...
    <?php if(!is_null($reservation->special_requests)): ?>
...
<?php $component->withAttributes(['wire:model.live' => 'showTableModal','maxWidth' => '2xl']); ?>
         <?php $__env->slot('title', null, []); ?> 
            <?php if($tableReservation->table_id): ?>
...
$__html = app('livewire')->mount($__name, $__params, 'lw-2964592347-0', $__slots ?? [], get_defined_vars());
...
<?php /**PATH C:\xampp\htdocs\script\resources\views\livewire\reservations\reservation-card.blade.php ENDPATH**/ ?>