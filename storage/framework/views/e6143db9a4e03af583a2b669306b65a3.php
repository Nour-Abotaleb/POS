<button <?php echo e($attributes->merge(['type' => 'submit', 'class' => 'justify-center bg-white sm:w-auto font-semibold rounded-md text-sm px-3 py-1.5 text-center dark:bg-gray-800 dark:hover:bg-gray-700', 'style' => 'color: #011646; border: 1px solid #011646;')); ?>
