...
<div class="payment_methods">
    ...
    <!--[if BLOCK]><![endif]--><?php if($showOnline && $paymentGatewayActive): ?>
        <div class="grid items-baseline grid-cols-1 gap-4 space-y-4 md:grid-cols-3">
            <!--[if BLOCK]><![endif]--><?php if($stripeSettings->stripe_status === 1): ?>
            ...
            <!--[if BLOCK]><![endif]--><?php if($stripeSettings->razorpay_status === 1): ?>
            ...
            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
            <!--[if BLOCK]><![endif]--><?php if($stripeSettings->flutterwave_status === 1): ?>
            ...
            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
            <!--[if BLOCK]><![endif]--><?php if($stripeSettings->payfast_status === 1): ?>
            ...
            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
            <!--[if BLOCK]><![endif]--><?php if($stripeSettings->paystack_status === 1): ?>
            ...
            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
            <!--[if BLOCK]><![endif]--><?php if($stripeSettings->xendit_status === 1): ?>
                <button wire:click="initiateXenditPayment(<?php echo e($selectedPlan?->id); ?>);" class="flex items-center w-full px-4 py-3 border rounded btn-light hover:shadow hover:bg-indigo-50 dark:hover:bg-gray-500 f-15 btn">
                          <svg class="w-4 h-4 me-2" role="img" viewBox="0 0 24 24" width="24" height="24" xmlns="http://www.w3.org/2000/svg" id="Xendit--Streamline-Simple-Icons" height="24" width="24">
                            <desc>
            ...
            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
            <!--[if BLOCK]><![endif]--><?php if($stripeSettings->paddle_status === 1): ?>
                <button
            ...
            <!--[if BLOCK]><![endif]--><?php if($offlinePaymentGateways > 0): ?>
    ...
    <!--[if BLOCK]><![endif]--><?php if(!$showOnline && $offlinePaymentGateways > 0): ?>
        <!--[if BLOCK]><![endif]--><?php if($paymentGatewayActive): ?>
...
<?php /**PATH C:\xampp\htdocs\script\resources\views/plans/payment-methods.blade.php ENDPATH**/ ?>