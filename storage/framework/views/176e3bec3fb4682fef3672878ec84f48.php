    ...
    <a class="<?php echo \Illuminate\Support\Arr::toCssClasses(['group flex flex-col gap-3 items-center ']); ?>"
        ...
        <div class="flex w-full justify-between items-center">
            <!--[if BLOCK]><![endif]--><?php if($order->order_type == 'pickup'): ?>
                <div class="flex flex-col gap-1 text-xs text-gray-600 dark:text-gray-400">
                    <div class="flex items-center gap-1">
                        <span class="font-semibold"><?php echo app('translator')->get('modules.order.pickupDate'); ?></span>
                        <span><?php echo e(\Illuminate\Support\Carbon::parse($order->pickup_date)->translatedFormat('M d, Y h:i A')); ?></span>
                    </div>
                    <div class="flex items-center gap-1">
                        <span class="font-semibold"><?php echo app('translator')->get('modules.order.orderDate'); ?></span>
                        <span><?php echo e($order->date_time->timezone(timezone())->translatedFormat('M d, Y h:i A')); ?></span>
                    </div>
                </div>
            <?php else: ?>
            ...
            <div class="text-sm font-medium text-gray-800 dark:text-gray-400">
                <!--[if BLOCK]><![endif]--><?php if($order->status == 'kot'): ?>
        ...
        <div class="flex w-full justify-between items-center border-t dark:border-gray-500 pt-3">
            ...
            <div class="text-xs text-gray-500 dark:text-gray-400 inline-flex gap-1 items-center">
                ...
                <?php echo app('translator')->get('modules.order.info_' . $order->order_status->value); ?>
            </div>

            <!--[if BLOCK]><![endif]--><?php if($order->status == 'kot' && user_can('Create Order')): ?>
                <div>
...
<?php /**PATH C:\xampp\htdocs\script\resources\views/components/order/order-card.blade.php ENDPATH**/ ?>