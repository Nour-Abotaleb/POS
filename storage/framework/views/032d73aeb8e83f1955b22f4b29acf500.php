...
<?php endif; ?>
                                    ...
                                    <div class="overflow-y-auto max-h-60">
                                        <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $allMenuItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'modifierOptions.'.e($index).'.name','class' => 'mt-1 block w-full','type' => 'text','placeholder' => ''.e(__('placeholders.modifierOptionNamePlaceholder')).'','wire:model' => 'modifierOptionName.'.e($index).'','wire:change' => 'updateModifierOptionTranslation('.e($index).')','wire:key' => 'option-name-'.e($index).'']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalc2fcfa88dc54fee60e0757a7e0572df1)): ?>
<?php $attributes = $__attributesOriginalc2fcfa88dc54fee60e0757a7e0572df1; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.checkbox','data' => ['id' => 'modifierOptions.'.e($index).'.is_available','wire:model' => 'modifierOptions.'.e($index).'.is_available','value' => ''.e($modifierOption['id']).'','wire:key' => 'option-available-'.e($index).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'modifierOptions.'.e($index).'.is_available','wire:model' => 'modifierOptions.'.e($index).'.is_available','value' => ''.e($modifierOption['id']).'','wire:key' => 'option-available-'.e($index).'']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php /**PATH C:\xampp\htdocs\script\resources\views/livewire/forms/update-modifier-group.blade.php ENDPATH**/ ?>