            ...
            <div class="flex flex-col bg-white border shadow-sm rounded-xl dark:bg-gray-800 hover:shadow-md dark:border-gray-700 dark:shadow-gray-800 p-3 space-y-3">
                <div class="flex justify-between">
                    <div class="text-base font-semibold text-gray-800 dark:text-white flex items-center gap-1">
                        ...
                        <div class="<?php echo \Illuminate\Support\Arr::toCssClasses(['p-2 rounded-md tracking-wide', 'bg-[#011646]/20' => (!is_null($reservation->table_id)), 'bg-yellow-200 text-yellow-800' => (is_null($reservation->table_id))]); ?>" style="<?php echo e(!is_null($reservation->table_id) ? 'color: #011646;' : ''); ?>">
                    ...
                    <div class=" text-gray-700 dark:text-neutral-400 flex flex-col space-y-2">
                        ...
                        <div class="inline-flex gap-2 items-center text-sm font-medium" style="color: #011646;">
                            ...
                            <?php echo e($reservation->reservation_date_time->translatedFormat('l, d M, h:i A')); ?>
...
<?php /**PATH C:\xampp\htdocs\script\resources\views\livewire\shop\bookings.blade.php ENDPATH**/ ?>