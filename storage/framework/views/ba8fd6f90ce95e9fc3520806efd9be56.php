...
<?php if($modal): ?>
    <?php if(($globalSetting->last_cron_run && Carbon\Carbon::parse($globalSetting->last_cron_run)->diffInHours() > 48) || $showModalOnboarding): ?>
...
<?php elseif($globalSetting->hide_cron_job !== 1): ?>
    <?php echo $__env->make('superadmin-settings.cron-message', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\script\resources\views\components\cron-message.blade.php ENDPATH**/ ?>