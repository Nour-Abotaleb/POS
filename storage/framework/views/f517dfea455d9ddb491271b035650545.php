<!DOCTYPE html>
<html lang="<?php echo e(session('locale') ?? $restaurant->customer_site_language); ?>" dir="<?php echo e(session('is_rtl') ? 'rtl' : 'ltr'); ?>">
...
[$__name, $__params] = $__split('kiosk::kiosk.dashboard', ['restaurant' => $restaurant,'shopBranch' => $shopBranch]);

$__html = app('livewire')->mount($__name, $__params, 'lw-1261633308-0', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'lw-1261633308-1', $__slots ?? [], get_defined_vars());
...
<?php /**PATH C:\xampp\htdocs\script\Modules/Kiosk\Resources/views/index.blade.php ENDPATH**/ ?>