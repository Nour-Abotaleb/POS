<div class="space-y-4">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
        ...
        <div class="p-5 rounded-xl bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 shadow-sm">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <div class="mt-1 text-3xl font-bold text-gray-900 dark:text-white"><?php echo currency_format($totalCashSalesToday, restaurant()->currency_id); ?></div>
                    <?php $pct = round($pctCashToday, 1); ?>
                    <div class="mt-1 text-xs">
                        <span class="font-medium <?php echo e($pct >= 0 ? 'text-green-600' : 'text-rose-600'); ?>"><?php echo e($pct >= 0 ? '▲' : '▼'); ?> <?php echo e(abs($pct)); ?>%</span>
        ...
        <div class="p-5 rounded-xl bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 shadow-sm">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <div class="mt-1 text-3xl font-bold text-gray-900 dark:text-white"><?php echo currency_format($safeDropsToday, restaurant()->currency_id); ?></div>
                    <?php $pctS = round($pctSafeDropToday, 1); ?>
                    <div class="mt-1 text-xs">
                        <span class="font-medium <?php echo e($pctS >= 0 ? 'text-green-600' : 'text-rose-600'); ?>"><?php echo e($pctS >= 0 ? '▲' : '▼'); ?> <?php echo e(abs($pctS)); ?>%</span>
                        <span class="text-gray-500">vs yesterday</span>
                    </div>
                </div>
                <div class="w-10 h-10 rounded-lg bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-200 flex items-center justify-center shadow">
        ...
        <div class="p-5 rounded-xl bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 shadow-sm">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <div class="mt-1 text-3xl font-bold text-gray-900 dark:text-white"><?php echo e($sessionsWithDiscrepancy7Days); ?></div>
        ...
        <div class="p-5 rounded-xl bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 shadow-sm">
            ...
            <div class="mt-1 text-lg font-semibold text-gray-900 dark:text-white"><?php echo e($largestCashOutReason); ?></div>
            <div class="mt-1 text-2xl font-bold text-gray-900 dark:text-white"><?php echo currency_format($largestCashOutAmount, restaurant()->currency_id); ?></div>
            <div class="mt-1 text-xs">
                <?php $pct = round($pctLargestCashOut30, 1); ?>
                <span class="font-medium <?php echo e($pct >= 0 ? 'text-green-600' : 'text-rose-600'); ?>"><?php echo e($pct >= 0 ? '▲' : '▼'); ?> <?php echo e(abs($pct)); ?>%</span>
        ...
        <div class="p-5 rounded-xl bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 shadow-sm">
            ...
            <div class="mt-1 text-3xl font-bold text-gray-900 dark:text-white"><?php echo currency_format($avgDiscrepancy30Days, restaurant()->currency_id); ?></div>
            <div class="mt-1 text-xs">
                <?php $pct2 = round($pctAvgDisc30, 1); ?>
                <span class="font-medium <?php echo e($pct2 >= 0 ? 'text-rose-600' : 'text-green-600'); ?>"><?php echo e($pct2 >= 0 ? '▲' : '▼'); ?> <?php echo e(abs($pct2)); ?>%</span>
                <span class="text-gray-500">vs previous 30 days</span>
            </div>
        </div>
    </div>
...
<?php /**PATH C:\xampp\htdocs\script\Modules/CashRegister\Resources/views/livewire/dashboard/register-dashboard.blade.php ENDPATH**/ ?>