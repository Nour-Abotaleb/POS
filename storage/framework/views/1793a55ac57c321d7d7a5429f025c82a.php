...
<?php endif; ?>
    ...
    <!--[if BLOCK]><![endif]--><?php if($uploadStage === 'idle'): ?>
    <!-- Upload Section -->
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
        ...
        <div class="space-y-4">
            ...
            <!--[if BLOCK]><![endif]--><?php if(!empty($availableCategories) || !empty($availableMenus)): ?>
            <div class="bg-white dark:bg-gray-800 shadow rounded-lg p-4">
                <div class="flex items-center space-x-2 mb-3">
                ...
                <div class="space-y-3">
                    ...
                    <div>
                        ...
                        <div class="flex flex-wrap gap-1">
                            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $availableCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <!--[if BLOCK]><![endif]--><?php if(!empty($availableMenus)): ?>
                    <div>
                        ...
                        <div class="flex flex-wrap gap-1">
                            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $availableMenus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="space-y-4">
            ...
            <div class="bg-white dark:bg-gray-800 shadow rounded-lg p-4">
                ...
                <div class="upload-area border-2 border-dashed border-gray-300 dark:border-gray-600 rounded p-3 text-center hover:border-blue-400 dark:hover:border-blue-500 transition-colors duration-200 <?php echo e($uploadFile ? 'border-green-400 bg-green-50 dark:bg-green-900/20' : ''); ?>">
                    <div class="space-y-2">
                        <!--[if BLOCK]><![endif]--><?php if($uploadFile): ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input','data' => ['id' => 'uploadFile','type' => 'file','class' => 'block w-full text-xs text-gray-500 file:mr-2 file:py-1 file:px-2 file:rounded file:border-0 file:text-xs file:font-semibold file:bg-blue-50 file:text-blue-700 hover:file:bg-blue-100 dark:file:bg-blue-900/30 dark:file:text-blue-300','wire:model' => 'uploadFile','accept' => '.csv,.xlsx,.xls']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
            ...
            <!--[if BLOCK]><![endif]--><?php if($availableKitchens->count() > 1): ?>
            <div class="bg-white dark:bg-gray-800 shadow rounded-lg p-4">
                <div class="flex items-center space-x-2 mb-3">
                    <div class="flex-shrink-0 w-6 h-6 bg-blue-100 dark:bg-blue-900/30 rounded-full flex items-center justify-center">
                ...
                <div class="space-y-2">
                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $availableKitchens; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kitchen): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded p-2">
                    <div class="flex items-center space-x-2">
                        ...
                        <div>
                            ...
                            <!--[if BLOCK]><![endif]--><?php if($availableKitchens->first()->type): ?>
                ...
                <div class="space-y-2 mb-4">
                    ...
                    <div class="flex items-center space-x-2 p-2 rounded <?php echo e(($availableKitchens->count() === 1 || $selectedKitchenId) ? 'bg-green-50 dark:bg-green-900/20' : 'bg-gray-50 dark:bg-gray-700'); ?>">
                        <div class="flex-shrink-0 w-5 h-5 rounded-full flex items-center justify-center <?php echo e(($availableKitchens->count() === 1 || $selectedKitchenId) ? 'bg-green-100 dark:bg-green-800' : 'bg-gray-200 dark:bg-gray-600'); ?>">
                            <?php if($availableKitchens->count() === 1 || $selectedKitchenId): ?>
                            <svg class="w-3 h-3 text-green-600 dark:text-green-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                            </svg>
                            <?php else: ?>
...
<?php endif; ?>
                ...
                <!--[if BLOCK]><![endif]--><?php if(!$uploadFile || ($availableKitchens->count() > 1 && !$selectedKitchenId)): ?>
    ...
    <!--[if BLOCK]><![endif]--><?php if($uploadStage === 'preview'): ?>
    <!-- Preview Section -->
    <div class="w-full">
...
<?php endif; ?>
            ...
            <div class="mb-3">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-5 gap-2">
                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $csvHeaders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $header): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="overflow-x-auto max-h-80 overflow-y-auto">
                        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                ...
                                <tr>
                                    ...
                                    <th class="px-2 py-1.5 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider whitespace-nowrap">
                                        <div class="flex flex-col">
                                            ...
                                            <!--[if BLOCK]><![endif]--><?php if($columnMapping[$header]): ?>
                            ...
                            <tbody class="bg-white dark:bg-gray-900 divide-y divide-gray-200 dark:divide-gray-700">
                                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $previewRows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="<?php echo e($index % 2 === 0 ? 'bg-white dark:bg-gray-900' : 'bg-gray-50 dark:bg-gray-800'); ?>">
                                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $csvHeaders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $headerIndex => $header): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php endif; ?>
    ...
    <!--[if BLOCK]><![endif]--><?php if($uploadStage === 'validating' || $uploadStage === 'processing'): ?>
    <!-- Processing Section -->
    <div class="w-full">
        <div class="bg-white dark:bg-gray-800 shadow rounded-lg p-4">
            <div class="text-center space-y-8">
                ...
                <!--[if BLOCK]><![endif]--><?php if($uploadStage === 'processing' && $totalRowsToProcess > 0): ?>
                <div class="space-y-3">
                    <div class="flex justify-between text-sm">
                ...
                <!-- Stage Progress -->
                <!--[if BLOCK]><![endif]--><?php if($stageProgress > 0 && $stageProgress < 100): ?>
                <div class="space-y-2">
    ...
    <!--[if BLOCK]><![endif]--><?php if($uploadStage === 'completed'): ?>
    <!-- Success Section -->
    <div class="w-full">
        <div class="bg-white dark:bg-gray-800 shadow rounded-lg p-4">
            ...
            <div>
                ...
                <!--[if BLOCK]><![endif]--><?php if($selectedKitchenId && $availableKitchens->where('id', $selectedKitchenId)->first()): ?>
            ...
            <div class="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-xl p-6">
                ...
                <!--[if BLOCK]><![endif]--><?php if($uploadResults['categories_created'] > 0 || $uploadResults['menus_created'] > 0): ?>
                <div class="border-t border-green-200 dark:border-green-700 pt-4">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <!--[if BLOCK]><![endif]--><?php if($uploadResults['categories_created'] > 0): ?>
                        <div class="text-center">
                        ...
                        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                        <!--[if BLOCK]><![endif]--><?php if($uploadResults['menus_created'] > 0): ?>
                        <div class="text-center">
                ...
                <!--[if BLOCK]><![endif]--><?php if($uploadResults['failed'] > 0): ?>
                <div class="border-t border-green-200 dark:border-green-700 pt-4">
                    <div class="text-center">
...
<?php endif; ?>
    ...
    <!--[if BLOCK]><![endif]--><?php if($uploadStage === 'failed'): ?>
    <!-- Error Section -->
    <div class="w-full">
        <div class="bg-white dark:bg-gray-800 shadow rounded-lg p-4">
            <div class="text-center space-y-8 result-card">
            ...
            <!-- Error Details -->
            <!--[if BLOCK]><![endif]--><?php if(!empty($uploadErrors)): ?>
            <div class="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-xl p-6 text-left">
                ...
                <div class="space-y-2">
                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $uploadErrors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $error): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php /**PATH C:\xampp\htdocs\script\resources\views/livewire/menu/bulk-import-page.blade.php ENDPATH**/ ?>