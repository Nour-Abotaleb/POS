...
$__html = app('livewire')->mount($__name, $__params, 'lw-1877963971-0', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'lw-1877963971-1', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'lw-1877963971-2', $__slots ?? [], get_defined_vars());
...
?>
                    ...
                    <?php endif; ?>
                    <?php if($restaurant->instagram_link): ?>
                    ...
                    <?php endif; ?>
                    <?php if($restaurant->twitter_link): ?>
    ...
    <?php if($restaurant->paymentGateways->razorpay_status): ?>
        <script src="https://checkout.razorpay.com/v1/checkout.js"></script>
    <?php endif; ?>

    <?php if($restaurant->paymentGateways->epay_status): ?>
        <?php
    ...
    <?php if($restaurant->paymentGateways->stripe_status): ?>
...
<?php /**PATH C:\xampp\htdocs\script\resources\views/layouts/guest.blade.php ENDPATH**/ ?>