...
<?php endif; ?>
                    ...
                    <div class="lg:inline-flex items-center gap-4">
                        ...
                        <!--[if BLOCK]><![endif]--><?php if(user_can('Create Staff Member') && ($stats['unlimited'] || $stats['current_count'] < $stats['staff_limit'])): ?>
...
$__html = app('livewire')->mount($__name, $__params, 'staff-table', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'add-staff-form', $__slots ?? [], get_defined_vars());
