  ...
  <div class="px-3 py-3 lg:px-5 lg:pl-3">
    <div class="flex items-center justify-between">
      ...
      <div class="flex items-center justify-start">
        ...
        <a href="javascript:history.back()" title="<?php echo app('translator')->get('menu.back'); ?>" class="ltr:mr-1 rtl:ml-1 p-1.5 text-gray-500 rounded-lg hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:focus:ring-gray-600 rtl:scale-x-[-1]">
        ...
        <a href="<?php echo e(route('dashboard')); ?>" class="flex items-center app-logo">
          <img src="<?php echo e(restaurant()->logoUrl); ?>" class="h-8 ltr:mr-3 rtl:ml-3" alt="" onerror="this.onerror=null; this.style.visibility='hidden';" />

          <!--[if BLOCK]><![endif]--><?php if(restaurant()->show_logo_text): ?>
          <span class="self-center text-xl font-semibold sm:text-xl whitespace-nowrap dark:text-white hidden md:block ltr:mr-2 rtl:ml-2"><?php echo e(Str::limit(restaurant()->name, 10)); ?></span>
          <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
        </a>

        <button id="toggle-sidebar" type="button" class="items-center p-2 text-sm text-gray-500 rounded-lg hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600 mx-2 hidden <?php echo e(request()->routeIs('pos.*') ? '' : 'lg:inline-flex'); ?>">
        ...
        <div class="flex items-center gap-2">
          ...
          <!--[if BLOCK]><![endif]--><?php if(module_enabled('MultiPOS') && ($posMachine = pos_machine()) && $posMachine->status === 'active'): ?>
          <div class="hidden md:flex items-center shrink-0 bg-white dark:bg-gray-600 border border-[#E0E5F2] dark:border-gray-400 py-2.5 px-2 rounded-lg text-sm">
            ...
            <span class="ml-1 text-[#A3A3A3]" style="color: #A3A3A3;"><?php echo e($posMachine->alias ?? __('multipos::messages.registration.device')); ?></span>
            <!--[if BLOCK]><![endif]--><?php if($posMachine->last_seen_at): ?>
              <span class="ms-1 text-[#A3A3A3] rounded-full text-[#A3A3A3]" style="color: #A3A3A3;">. </span>
              <span class="text-[#A3A3A3]" style="color: #A3A3A3;"><?php echo e($posMachine->last_seen_at->diffForHumans()); ?></span>
            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
          </div>
          <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
...
<?php $component->withAttributes(['href' => 'javascript:;','onclick' => '
          ...
          <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <span class="hidden md:block"><?php echo app('translator')->get('app.customer'); ?></span>
...
$__html = app('livewire')->mount($__name, $__params, 'lw-1143471851-0', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'lw-1143471851-1', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'lw-1143471851-2', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'lw-1143471851-3', $__slots ?? [], get_defined_vars());
...
<?php $component->withAttributes(['class' => 'px-2 sm:px-3']); ?>
                <?php $daysLeftInTrial = floor(now(timezone())->diffInDays(\Carbon\Carbon::parse(restaurant()->trial_ends_at)->addDays(1))); ?>
...
<?php endif; ?>
          ...
          <div id="fullscreen-tooltip-toggle" role="tooltip" class="absolute z-10 invisible inline-block px-3 py-2 text-sm font-medium text-white transition-opacity duration-300 bg-gray-900 rounded-lg shadow-sm opacity-0 tooltip"><?php echo app('translator')->get('app.viewInFullscreen'); ?><div class="tooltip-arrow" data-popper-arrow></div></div>
          ...
          <div id="tooltip-toggle" role="tooltip" class="absolute z-10 invisible inline-block px-3 py-2 text-sm font-medium text-white transition-opacity duration-300 bg-gray-900 rounded-lg shadow-sm opacity-0 tooltip"><?php echo app('translator')->get('app.toggleDarkMode'); ?><div class="tooltip-arrow" data-popper-arrow></div></div>
          <?php
$__split = function ($name, $params = []) {
    return [$name, $params];
};
...
$__html = app('livewire')->mount($__name, $__params, 'lw-1143471851-4', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'lw-1143471851-5', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'lw-1143471851-6', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'lw-1143471851-7', $__slots ?? [], get_defined_vars());
...
<?php /**PATH E:\nomufood\POS\resources\views/navigation-menu.blade.php ENDPATH**/ ?>