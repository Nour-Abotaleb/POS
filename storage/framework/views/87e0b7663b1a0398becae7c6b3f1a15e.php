        ...
        <div class="grid grid-cols-1 gap-6 mx-2 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 sm:mx-4">
            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $packages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $package): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="<?php echo \Illuminate\Support\Arr::toCssClasses([
                    ...
                    <!--[if BLOCK]><![endif]--><?php if($package->is_recommended): ?>
                    ...
                    <div class="p-6 text-center border-b border-gray-200 dark:border-gray-700">
                        ...
                        <!-- Price -->
                        <div class="mb-4">
                            <!--[if BLOCK]><![endif]--><?php if($package->is_free): ?>
                        ...
                        <!-- Plan Type Info -->
                        <!--[if BLOCK]><![endif]--><?php if($package->package_type === App\Enums\packageType::DEFAULT): ?>
                    ...
                    <div class="p-6">
                        ...
                        <ul class="space-y-3">
                            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $AllModulesWithFeature; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $moduleName): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php
                                ...
                                <li class="flex items-start gap-3">
                                    <!--[if BLOCK]><![endif]--><?php if($isEnabled): ?>
                                    ...
                                    <div class="flex-1">
                                        ...
                                        <!--[if BLOCK]><![endif]--><?php if($showLimit && $limitValue !== null): ?>
                                            <span class="ml-2 text-xs font-semibold text-skin-base dark:text-skin-base">
                                                <!--[if BLOCK]><![endif]--><?php if($limitValue == -1): ?>
                                                    (<?php echo e(__('modules.billing.unlimited')); ?>)
                                                <?php else: ?>
                                                    <!--[if BLOCK]><![endif]--><?php if($moduleName === 'Order'): ?>
                    ...
                    <!-- Action Button -->
                    <div class="p-6 pt-0">
                        <!--[if BLOCK]><![endif]--><?php if($package->is_free || $paymentActive ||
                            ...
                            <div class="w-full">
                                <!--[if BLOCK]><![endif]--><?php if($package->id == $restaurant->package_id && ($restaurant->package_type == ($isAnnual ? 'annual' : 'monthly') || !in_array($restaurant->package_type, ['annual', 'monthly']))): ?>
...
<?php $component->withAttributes(['wire:model.live' => 'showPaymentMethodModal','maxWidth' => 'xl']); ?>
         ...
         <?php $__env->slot('content', null, []); ?> 
            <!--[if BLOCK]><![endif]--><?php if(!$free): ?>
                <div>
                    <!--[if BLOCK]><![endif]--><?php switch($show):
                        case ('payment-method'): ?>
...
<?php endif; ?>
                ...
                <!--[if BLOCK]><![endif]--><?php if($offlineMethodId): ?>
                <?php if (isset($component)) { $__componentOriginale67687e3e4e61f963b25a6bcf3983629 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginale67687e3e4e61f963b25a6bcf3983629 = $attributes; } ?>
<?php $component = App\View\Components\Button::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('button'); ?>
...
<?php endif; ?>
    ...
    <!--[if BLOCK]><![endif]--><?php if(!$free): ?>
        ...
        <!--[if BLOCK]><![endif]--><?php if($stripeSettings->razorpay_status == 1 || $stripeSettings->stripe_status == 1 || $stripeSettings->flutterwave_status == 1 || $stripeSettings->paypal_status == 1 || $stripeSettings->payfast_status == 1 || $stripeSettings->paystack_status == 1 || $stripeSettings->xendit_status == 1 || $stripeSettings->paddle_status == 1): ?>
...
<?php /**PATH C:\xampp\htdocs\script\resources\views/livewire/plan/plan-list.blade.php ENDPATH**/ ?>