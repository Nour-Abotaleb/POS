...
<?php $component->withAttributes(['align' => 'left']); ?>
             ...
             <?php $__env->slot('content', null, []); ?> 
                ...
                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $filterExpenseCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $expense_category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php $component->withAttributes(['align' => 'left']); ?>
             ...
             <?php $__env->slot('content', null, []); ?> 
                ...
                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $paymentMethods; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $method): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if (isset($component)) { $__componentOriginal68cb1971a2b92c9735f83359058f7108 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal68cb1971a2b92c9735f83359058f7108 = $attributes; } ?>
...
<?php endif; ?>
    ...
    <!--[if BLOCK]><![endif]--><?php if($clearFilterButton): ?>
...
<?php /**PATH C:\xampp\htdocs\script\resources\views/expenses/filter.blade.php ENDPATH**/ ?>