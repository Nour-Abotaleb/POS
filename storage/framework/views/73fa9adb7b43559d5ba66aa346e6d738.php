    ...
    <div class="px-4 py-6">
        ...
        <div class="step-container dark:bg-gray-800">
            ...
            <div class="step-content">
                ...
                <?php if(!$uploadMaxFilesize['greater'] || !$postMaxSize['greater']): ?>
                    ...
                    <div class="bg-amber-50 border-l-4 border-amber-500 p-4 rounded-md shadow-sm mb-4 dark:bg-amber-900/30 dark:border-amber-600">
                        <div class="flex items-start justify-between">
                            ...
                            <div class="ml-4 flex flex-col items-end">
                                ...
                                <div>
                                    <?php if(str_contains(strtolower($_SERVER['SERVER_SOFTWARE']), 'apache')): ?>
        ...
        <div class="step-container dark:bg-gray-800 mt-6">
            ...
            <div class="step-content">
                <ul class="space-y-3" id="files-list">
                    <?php $__empty_1 = true; $__currentLoopData = collect(\Illuminate\Support\Facades\File::files($updateFilePath))->sortByDesc(function($file) {
                                ...
                                <div class="flex items-center justify-between p-4">
                                    <div class="flex-1">
                                        ...
                                        <div class="flex items-center gap-2 mt-1">
                                            ...
                                            <?php if($diffInMinutes < 10): ?>
                                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-green-100 text-green-800">
                                                    <?php if($diffInMinutes < 1): ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\script\resources\views\custom-modules\install.blade.php ENDPATH**/ ?>