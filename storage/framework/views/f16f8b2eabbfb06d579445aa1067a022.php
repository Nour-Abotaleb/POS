                ...
                <div class="overflow-hidden shadow">
                    <table class="min-w-full divide-y divide-gray-200 table-fixed dark:divide-gray-600">
                        ...
                        <tr class="hover:bg-gray-100 dark:hover:bg-gray-700" wire:key='invoice-<?php echo e($invoice->id . rand(1111, 9999) . microtime()); ?>' wire:loading.class.delay='opacity-10'>
                            ...
                            <td class="py-2.5 px-4 text-sm text-gray-900 whitespace-nowrap dark:text-white">
                                <!--[if BLOCK]><![endif]--><?php if($invoice->restaurant): ?>
                            ...
                            <td class="py-2.5 px-4 text-sm text-gray-900 whitespace-nowrap dark:text-white">
                                ...
                                <!--[if BLOCK]><![endif]--><?php if($invoice->package->package_type->value == 'trial'): ?>
                            ...
                            <td class="py-2.5 px-4 text-sm text-gray-900 whitespace-nowrap dark:text-white">
                                <?php echo $invoice->total ? global_currency_format($invoice->total, global_setting()->default_currency_id) : '-'; ?>
...
<?php /**PATH E:\nomu\testfood\POS\resources\views/livewire/billing/invoice-table.blade.php ENDPATH**/ ?>