...
<?php endif; ?>
                    ...
                    <!--[if BLOCK]><![endif]--><?php if(user_can('Create Menu Item') && ($menuItemStats['unlimited'] || $menuItemStats['current_count'] < $menuItemStats['menu_items_limit'])): ?>
                        <?php if (isset($component)) { $__componentOriginala6c1b2378c7a756a2b58951b1494d68f = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginala6c1b2378c7a756a2b58951b1494d68f = $attributes; } ?>
                    ...
                    <table class="min-w-full divide-y divide-gray-200 table-fixed dark:divide-gray-600">
                        <thead class="bg-gray-100 dark:bg-gray-700">
                            <tr>
                                ...
                                <th scope="col"
                                    class="py-2.5 px-4 text-xs font-medium ltr:text-left rtl:text-right text-gray-500 uppercase dark:text-gray-400">
                                    <?php echo app('translator')->get('modules.menu.calories'); ?>
                                </th>
                                <th scope="col"
                                    class="py-2.5 px-4 text-xs font-medium ltr:text-left rtl:text-right text-gray-500 uppercase dark:text-gray-400">
                                    ...
                                    <td class="lg:flex items-center p-4 mr-12 lg:space-x-6 rtl:space-x-reverse">
                                        ...
                                        <div class="text-sm font-normal text-gray-500 dark:text-gray-400 w-40 lg:w-auto">
                                            <div class="text-sm lg:text-base font-semibold text-gray-900 dark:text-white inline-flex items-center">
                                                <img src="<?php echo e(asset('img/'.$item->type.'.svg')); ?>" class="h-4 me-2" title="<?php echo app('translator')->get('modules.menu.' . $item->type); ?>" alt="" />
...
<?php endif; ?>
                                        ...
                                        <!--[if BLOCK]><![endif]--><?php if(user_can('Update Menu Item')): ?>
                                            <?php if (isset($component)) { $__componentOriginala6c1b2378c7a756a2b58951b1494d68f = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginala6c1b2378c7a756a2b58951b1494d68f = $attributes; } ?>
...
<?php endif; ?>
                                        ...
                                        <!--[if BLOCK]><![endif]--><?php if(user_can('Delete Menu Item')): ?>
...
$__html = app('livewire')->mount($__name, $__params, 'lw-3857283571-0', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'item-variations-'.$menuItem->id, $__slots ?? [], get_defined_vars());
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.confirmation-modal','data' => ['wire:model' => 'confirmDeleteMenuItem']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:model' => 'confirmDeleteMenuItem']); ?>
         <?php $__env->slot('title', null, []); ?> 
...
<?php /**PATH E:\nomufood\POS\resources\views/livewire/menu/menu-items.blade.php ENDPATH**/ ?>