...
<?php endif; ?>
                            ...
                            <?php if($order->order_type == 'delivery'): ?>
                                <div class="space-y-3">
                                    ...
                                    <?php if($order->deliveryExecutive): ?>
                                        <div
...
<?php $component->withAttributes(['class' => 'w-full text-sm','wire:model.live' => 'deliveryExecutive','wire:change' => 'saveDeliveryExecutive']); ?>
                                            ...
                                            <?php $__currentLoopData = $deliveryExecutives; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $deliveryExecutive): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php endif; ?>
                            ...
                            <div class="flex-col mt-4">
                                <?php if(user_can('Update Order') && !auth()->user()->roles->pluck('display_name')->contains('Waiter')): ?>
                                    <div class="gap-2">
                                        <?php if (isset($component)) { $__componentOriginaled2cde6083938c436304f332ba96bb7c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginaled2cde6083938c436304f332ba96bb7c = $attributes; } ?>
...
<?php endif; ?>
                ...
                <?php if($orderProgressStatus === 'cancelled'): ?>
                    <div class="p-4 my-4 border border-red-200 rounded-lg bg-red-50 dark:bg-red-900/20 dark:border-red-800">
                        <div class="flex items-start gap-3">
                            ...
                            <div class="flex-1">
                                ...
                                <?php if($order->cancelReason || $order->cancel_reason_text): ?>
                                    <div class="mt-3 space-y-2">
                                        ...
                                        <?php if($order->cancel_reason_text): ?>
                                            <div>
                    ...
                    <div class="flex flex-col space-y-4">
                        ...
                        <?php if(user_can('Update Order')): ?>
                            <div class="flex justify-end items-center mt-4 space-x-2 rtl:!space-x-reverse">
                                <?php if($orderProgressStatus === 'placed'): ?>
...
<?php endif; ?>
                                ...
                                <?php if($currentIndex < count($statuses) - 1): ?>
                                    <?php if (isset($component)) { $__componentOriginal3b0e04e43cf890250cc4d85cff4d94af = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3b0e04e43cf890250cc4d85cff4d94af = $attributes; } ?>
                    ...
                    <table class="flex-1 min-w-full divide-y divide-gray-200 table-fixed dark:divide-gray-600">
                        <thead class="bg-gray-100 dark:bg-gray-700">
                            <tr>
                                ...
                                <?php if(!in_array($order->status, ['paid', 'payment_due', 'canceled']) && user_can('Delete Order')): ?>
                                    <th scope="col"
                                        class="p-2 text-xs font-medium text-right text-gray-500 uppercase dark:text-gray-400">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700"
                            ...
                            <?php $__empty_1 = true; $__currentLoopData = $order->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <?php
                                ...
                                <tr class="hover:bg-gray-100 dark:hover:bg-gray-700"
                                    ...
                                    <td class="flex flex-col p-2 mr-12 lg:min-w-28">
                                        ...
                                        <?php if($item->modifierOptions->isNotEmpty()): ?>
                ...
                <div>
                    <div
                        ...
                        <?php if(!is_null($order->discount_amount)): ?>
                            <div wire:key="discountAmount"
                                ...
                                <div>
                                    <?php echo app('translator')->get('modules.order.discount'); ?> <?php if($order->discount_type == 'percent'): ?>
                    ...
                    <div class="w-full h-auto pt-3 pb-4 select-none">
                        ...
                        <div class="grid grid-cols-2 gap-3 mb-3">
                            <?php if($order->status == 'kot' && !is_null($order->table_id)): ?>
                                <button
                            ...
                            <?php if(($order->status == 'billed' || $order->status == 'payment_due') && user_can('Update Order')): ?>
                                <button
...
<?php endif; ?>
                            ...
                            <?php if(in_array($order->status, ['billed', 'payment_due', 'paid']) && user_can('Delete Order')): ?>
                                <button
                    ...
                    <div class="flex flex-col rounded">
                        <table class="flex-1 min-w-full divide-y divide-gray-200 table-fixed dark:divide-gray-600">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700"
                                ...
                                <?php $__currentLoopData = $order->payments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                        ...
                                        <td class="<?php echo \Illuminate\Support\Arr::toCssClasses([
                                            ...
                                            <div class="inline-flex items-center justify-center gap-2">
                                                <?php if($order->status !== 'pending_verification' && user_can('Update Order')): ?>
                                                    <?php if (isset($component)) { $__componentOriginaled2cde6083938c436304f332ba96bb7c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginaled2cde6083938c436304f332ba96bb7c = $attributes; } ?>
...
<?php $component->withAttributes(['wire:change' => 'updatePaymentMethod('.e($item->id).', $event.target.value)','class' => 'w-32 text-sm']); ?>
                                                        <?php $__currentLoopData = ['cash', 'card', 'upi', 'due' , 'bank_transfer']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $method): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php endif; ?>
                                        ...
                                        <td
                                            ...
                                            <?php if($item->payment_method == 'due' && user_can('Update Order')): ?>
                                                <?php if (isset($component)) { $__componentOriginal3b0e04e43cf890250cc4d85cff4d94af = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3b0e04e43cf890250cc4d85cff4d94af = $attributes; } ?>
                ...
                <?php if($order->order_type == 'delivery' && $order->delivery_address): ?>
                    <div class="p-3 mt-3 rounded-lg bg-gray-50 dark:bg-gray-700">
                        <div class="flex items-center justify-between mb-2">
                            ...
                            <?php if($order->customer_lat && $order->customer_lng && branch()->lat && branch()->lng): ?>
...
$__html = app('livewire')->mount($__name, $__params, 'lw-1894892895-0', $__slots ?? [], get_defined_vars());
