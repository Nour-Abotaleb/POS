...
<?php endif; ?>
                    ...
                    <!--[if BLOCK]><![endif]--><?php if(!user()->hasRole('Waiter_' . user()->restaurant_id)): ?>
                    <?php if (isset($component)) { $__componentOriginaled2cde6083938c436304f332ba96bb7c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginaled2cde6083938c436304f332ba96bb7c = $attributes; } ?>
...
<?php endif; ?>
            ...
            ?>
            <!--[if BLOCK]><![endif]--><?php if($canCreateOrder && $orderStats && ($orderStats['unlimited'] || $orderStats['current_count'] < $orderStats['order_limit'])): ?>
...
<?php endif; ?>
        ...
        <!--[if BLOCK]><![endif]--><?php if($orderLimitExceeded): ?>
...
<?php endif; ?>
    ...
    <!--[if BLOCK]><![endif]--><?php if($playSound): ?>
    <script>    
