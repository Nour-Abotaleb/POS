...
<?php endif; ?>
                ...
                <!--[if BLOCK]><![endif]--><?php if(user_can('Create Expense')): ?>
                    ...
                    <div class="overflow-hidden shadow">
                        <table class="min-w-full divide-y divide-gray-200 table-fixed dark:divide-gray-600">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                                <!--[if BLOCK]><![endif]--><?php if($expenseCategories->count() > 0): ?>
                                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $expenseCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $expenseCategory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                            ...
                                            <td class="py-2.5 px-4 space-x-2 text-end">
                                                ...
                                                <!--[if BLOCK]><![endif]--><?php if(user_can('Update Expense Category')): ?>
...
<?php $component->withAttributes(['wire:click' => 'showEditExpenseCategory('.e($expenseCategory->id).')','wire:key' => 'edit-expenseCategory-button-'.e($expenseCategory->id).'']); ?>
                                                        <svg class="w-4 h-4 me-1" fill="currentColor"
...
<?php endif; ?>
                                                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                                <!--[if BLOCK]><![endif]--><?php if(user_can('Delete Expense Category')): ?>
...
<?php endif; ?>
                ...
                <!--[if BLOCK]><![endif]--><?php if($deleteExpenseCategory): ?>
...
<?php $component->withAttributes(['wire:model.live' => 'showEditExpenseCategoryModal']); ?>
         ...
         <?php $__env->slot('content', null, []); ?> 
            <!--[if BLOCK]><![endif]--><?php if($selectedExpenseCategory): ?>
                <?php
...
$__html = app('livewire')->mount($__name, $__params, 'edit-expense-category-form-'.$selectedExpenseCategory->id, $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'lw-4014546622-0', $__slots ?? [], get_defined_vars());
...
<?php /**PATH C:\xampp\htdocs\script\resources\views/livewire/payments/expense-category.blade.php ENDPATH**/ ?>