            ...
            <!--[if BLOCK]><![endif]--><?php if($order): ?>
                <h2 class="flex justify-between text-lg">
                    ...
                    <div class="flex flex-col">
                        ...
                        ?>
                        <!--[if BLOCK]><![endif]--><?php if($tokenNumber): ?>
                        ...
                        <div class="flex items-center gap-2">
                            <!--[if BLOCK]><![endif]--><?php if($order->order_type == 'pickup'): ?>
                        ...
                        <div>
                            <!--[if BLOCK]><![endif]--><?php if($order->order_type == 'pickup'): ?>
                                <div class="text-xs text-gray-600 dark:text-gray-400">
                                    ...
                                    <?php echo e(\Carbon\Carbon::parse($order->pickup_date)->translatedFormat('M d, Y h:i A')); ?>
                    ...
                    <div class="inline-flex gap-4">
                        <div>
                            <div class="flex gap-x-3">
                                <!--[if BLOCK]><![endif]--><?php if($order->order_type == 'dine_in'): ?>
                                    <!--[if BLOCK]><![endif]--><?php if(!is_null($order->table)): ?>
                                        <div class="inline-flex items-center gap-2">
                                            ...
                                            <!--[if BLOCK]><![endif]--><?php if(user_can('Update Order')): ?>
...
<?php endif; ?>
                                ...
                                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                <div>
                                    <!--[if BLOCK]><![endif]--><?php if($order->customer_id): ?>
                                        <div class="flex items-center gap-2">
                            ...
                            <!--[if BLOCK]><![endif]--><?php if($order->order_type == 'delivery'): ?>
                                <div class="space-y-3">
                                    <!--[if BLOCK]><![endif]--><?php if($order->deliveryPlatform): ?>
                                        <div class="inline-flex flex-col gap-1 text-sm font-semibold text-gray-700 dark:text-gray-300">
                                            <div class="inline-flex items-center gap-2">
                                                <!--[if BLOCK]><![endif]--><?php if($order->deliveryPlatform->logo_url): ?>
                                    ...
                                    <!--[if BLOCK]><![endif]--><?php if($order->deliveryExecutive): ?>
                                        <div
...
<?php $component->withAttributes(['class' => 'w-full text-sm','wire:model.live' => 'deliveryExecutive','wire:change' => 'saveDeliveryExecutive']); ?>
                                            ...
                                            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $deliveryExecutives; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $deliveryExecutive): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php endif; ?>
                            ...
                            <div class="flex-col mt-4">
                                <!--[if BLOCK]><![endif]--><?php if(user_can('Update Order') && !auth()->user()->roles->pluck('display_name')->contains('Waiter')): ?>
                                    <div class="gap-2">
                                        <?php if (isset($component)) { $__componentOriginaled2cde6083938c436304f332ba96bb7c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginaled2cde6083938c436304f332ba96bb7c = $attributes; } ?>
...
<?php endif; ?>
                                ...
                                <?php elseif($selectWaiter): ?>
                                    <div class="gap-1 py-2 text-sm dark:text-gray-300 flex items-center">
                                        ...
                                        <span class="ml-1 font-medium"><?php echo e(optional($users->firstWhere('id', $selectWaiter))->name); ?></span>
                                    </div>
                                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                            </div>
                        </div>
                    ...
                    <div class="flex flex-col gap-1">
                        ...
                        <!--[if BLOCK]><![endif]--><?php if($order->placed_via): ?>
                            <span class="<?php echo \Illuminate\Support\Arr::toCssClasses([
                                ...
                                <!--[if BLOCK]><![endif]--><?php if($order->placed_via === 'pos'): ?>
                ...
                <!--[if BLOCK]><![endif]--><?php if($orderProgressStatus === 'cancelled'): ?>
                    <div class="p-4 my-4 border border-red-200 rounded-lg bg-red-50 dark:bg-red-900/20 dark:border-red-800">
                        <div class="flex items-start gap-3">
                            ...
                            <div class="flex-1">
                                ...
                                <!--[if BLOCK]><![endif]--><?php if($order->cancelReason || $order->cancel_reason_text): ?>
                                    <div class="mt-3 space-y-2">
                                        <!--[if BLOCK]><![endif]--><?php if($order->cancelReason): ?>
                                            <div>
                                        ...
                                        <!--[if BLOCK]><![endif]--><?php if($order->cancel_reason_text): ?>
                                            <div>
                    ...
                    <div class="flex flex-col space-y-4">
                        <div class="flex items-center justify-between text-gray-900 dark:text-white">
                            ...
                            <div class="relative">
                                <div class="relative flex justify-between">
                                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $statuses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="flex flex-col items-center">
                                            <div
                                                class="w-8 h-8 rounded-full flex items-center justify-center mb-2
                                            <?php if($index <= $currentIndex): ?> bg-skin-base text-white
                                            <?php else: ?>
                                                bg-gray-200 dark:bg-gray-700 text-gray-400 dark:text-gray-500 <?php endif; ?>">
                        ...
                        <!--[if BLOCK]><![endif]--><?php if(user_can('Update Order')): ?>
                            <div class="flex justify-end items-center mt-4 space-x-2 rtl:!space-x-reverse">
                                <!--[if BLOCK]><![endif]--><?php if($orderProgressStatus === 'placed'): ?>
...
<?php endif; ?>
                                ...
                                <!--[if BLOCK]><![endif]--><?php if($currentIndex < count($statuses) - 1): ?>
                                    <?php if (isset($component)) { $__componentOriginal3b0e04e43cf890250cc4d85cff4d94af = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3b0e04e43cf890250cc4d85cff4d94af = $attributes; } ?>
                    ...
                    <table class="flex-1 min-w-full divide-y divide-gray-200 table-fixed dark:divide-gray-600">
                        <thead class="bg-gray-100 dark:bg-gray-700">
                            <tr>
                                ...
                                <!--[if BLOCK]><![endif]--><?php if(!in_array($order->status, ['paid', 'payment_due', 'canceled']) && user_can('Delete Order')): ?>
                                    <th scope="col"
                                        class="p-2 text-xs font-medium text-right text-gray-500 uppercase dark:text-gray-400">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700"
                            ...
                            <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $order->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <?php
                                ...
                                <tr class="hover:bg-gray-100 dark:hover:bg-gray-700"
                                            ...
                                            <div class="text-xs text-gray-600 dark:text-white">
                                                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $item->modifierOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $modifier): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <div
                                                        ...
                                                        <span
                                                            class="text-gray-600 dark:text-gray-300"><?php echo currency_format($modifier->pivot->modifier_option_price ?? $modifier->price , $currencyId); ?></span>
                                                    </div>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><!--[if ENDBLOCK]><![endif]-->
                                            </div>
                                        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                    ...
                                    <td
                                        ...
                                        <?php echo currency_format($displayPrice, $currencyId); ?>

                                    </td>
                                    <td
                                        class="p-2 text-xs font-medium text-right text-gray-900 whitespace-nowrap dark:text-white">
                                        <?php echo currency_format($item->amount, $currencyId); ?>
                ...
                <div>
                    <div
                        ...
                        <div class="flex justify-between text-sm text-gray-500 dark:text-gray-400">
                            ...
                            <div>
                                <?php echo currency_format($order->sub_total, $currencyId); ?>
                        ...
                        <!--[if BLOCK]><![endif]--><?php if(!is_null($order->discount_amount)): ?>
                            <div wire:key="discountAmount"
                                ...
                                <div>
                                    -<?php echo currency_format($order->discount_amount, $currencyId); ?>
                        ...
                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $order->charges; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="flex justify-between text-sm text-gray-500 dark:text-gray-400">
                                <div class="inline-flex items-center gap-x-1">
                                    ...
                                    <?php if(!in_array($order->status, ['paid', 'payment_due', 'canceled'])): ?>
                                ...
                                <div>
                                    <?php echo currency_format($item->charge->getAmount($order->sub_total - ($order->discount_amount ?? 0)), $currencyId); ?>
                        ...
                        <!--[if BLOCK]><![endif]--><?php if($order->tip_amount > 0): ?>
                            <div class="flex justify-between text-sm text-gray-500 dark:text-gray-400">
                                ...
                                <div>
                                    <?php echo currency_format($order->tip_amount, $currencyId); ?>
                        ...
                        <div class="flex justify-between text-sm text-gray-500 dark:text-neutral-400">
                            ...
                            <div>
                                <!--[if BLOCK]><![endif]--><?php if($order->delivery_fee > 0): ?>
                                    <?php echo currency_format($order->delivery_fee, $currencyId); ?>
                            ...
                            <!--[if BLOCK]><![endif]--><?php if($order->total_tax_amount > 0): ?>
                                ...
                                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $taxTotals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $taxName => $taxInfo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="flex justify-between text-xs text-gray-500 dark:text-gray-400">
                                        ...
                                        <span><?php echo currency_format($taxInfo['amount'], $currencyId); ?></span>
                                    </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><!--[if ENDBLOCK]><![endif]-->
                                <div class="flex justify-between mt-1 text-sm text-gray-500 dark:text-gray-400">
                                    ...
                                    <div>
                                        <?php echo currency_format($totalTax, $currencyId); ?>
                        ...
                        <div class="flex justify-between font-medium dark:text-gray-400">
                            ...
                            <div>
                                <?php echo currency_format($order->total, $currencyId); ?>
                        ...
                        <div class="flex justify-between font-medium dark:text-gray-400">
                            ...
                            <div>
                                ...
                                <?php echo currency_format($totalBalance > 0 ? $totalBalance : 0, $currencyId); ?>
                    ...
                    <div class="w-full h-auto pt-3 pb-4 select-none">
                        ...
                        <div class="grid grid-cols-2 gap-3 mb-3">
                            <!--[if BLOCK]><![endif]--><?php if($order->status == 'kot' && !is_null($order->table_id)): ?>
                                <button
                            ...
                            <!--[if BLOCK]><![endif]--><?php if(($order->status == 'billed' || $order->status == 'payment_due') && user_can('Update Order')): ?>
                                <button
...
<?php endif; ?>
                            ...
                            <!--[if BLOCK]><![endif]--><?php if(in_array($order->status, ['billed', 'payment_due', 'paid']) && user_can('Delete Order')): ?>
                                <button
                            ...
                            <?php if(!in_array($order->status, ['paid', 'payment_due', 'canceled'])): ?>
                                <!--[if BLOCK]><![endif]--><?php if(user_can('Delete Order')): ?>
                                <button
                    ...
                    <div class="flex flex-col rounded">
                        <table class="flex-1 min-w-full divide-y divide-gray-200 table-fixed dark:divide-gray-600">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700"
                                ...
                                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $order->payments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                        ...
                                        <td class="<?php echo \Illuminate\Support\Arr::toCssClasses([
                                            ...
                                            <div class="inline-flex items-center justify-center gap-2">
                                                <!--[if BLOCK]><![endif]--><?php if($order->status !== 'pending_verification' && user_can('Update Order')): ?>
                                                    <?php if (isset($component)) { $__componentOriginaled2cde6083938c436304f332ba96bb7c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginaled2cde6083938c436304f332ba96bb7c = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.select','data' => ['wire:change' => 'updatePaymentMethod('.e($item->id).', $event.target.value)','class' => 'w-32 text-sm']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('select'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:change' => 'updatePaymentMethod('.e($item->id).', $event.target.value)','class' => 'w-32 text-sm']); ?>
                                                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = ['cash', 'card', 'upi', 'due' , 'bank_transfer']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $method): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e($method); ?>" <?php if($item->payment_method == $method): echo 'selected'; endif; ?>>
...
<?php endif; ?>
                                                <?php else: ?>
                                                    <div class="<?php echo \Illuminate\Support\Arr::toCssClasses([
                                                        ...
                                                        <?php echo app('translator')->get('modules.order.' . $item->payment_method); ?>
                                                    </div>
                                                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                            </div>
                                        </td>
                                        <td
                                            ...
                                            <!--[if BLOCK]><![endif]--><?php if($item->payment_method == 'due' && user_can('Update Order')): ?>
                                                <?php if (isset($component)) { $__componentOriginal3b0e04e43cf890250cc4d85cff4d94af = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3b0e04e43cf890250cc4d85cff4d94af = $attributes; } ?>
                ...
                <!--[if BLOCK]><![endif]--><?php if($order->order_type == 'delivery' && $order->delivery_address): ?>
                    <div class="p-3 mt-3 rounded-lg bg-gray-50 dark:bg-gray-700">
                        <div class="flex items-center justify-between mb-2">
                            ...
                            <!--[if BLOCK]><![endif]--><?php if($order->customer_lat && $order->customer_lng && branch()->lat && branch()->lng): ?>
...
$__html = app('livewire')->mount($__name, $__params, 'lw-1892581269-0', $__slots ?? [], get_defined_vars());
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.confirmation-modal','data' => ['wire:model' => 'cancelOrderModal']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:model' => 'cancelOrderModal']); ?>
         <?php $__env->slot('title', null, []); ?> 
...
<?php endif; ?>
                <?php if (isset($component)) { $__componentOriginaled2cde6083938c436304f332ba96bb7c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginaled2cde6083938c436304f332ba96bb7c = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.select','data' => ['id' => 'cancelReason','class' => 'block w-full mt-2','wire:model' => 'cancelReason']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('select'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'cancelReason','class' => 'block w-full mt-2','wire:model' => 'cancelReason']); ?>
...
<?php endif; ?>
        ...
        <?php if (isset($component)) { $__componentOriginal5b8b2d0f151a30be878e1a760ec3900c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal5b8b2d0f151a30be878e1a760ec3900c = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.confirmation-modal','data' => ['wire:model' => 'deleteOrderModal']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('confirmation-modal'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:model' => 'deleteOrderModal']); ?>
             <?php $__env->slot('title', null, []); ?> 
...
<?php endif; ?>
       ...
       <?php if (isset($component)) { $__componentOriginal5b8b2d0f151a30be878e1a760ec3900c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal5b8b2d0f151a30be878e1a760ec3900c = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.confirmation-modal','data' => ['wire:model' => 'confirmDeleteModal']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('confirmation-modal'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:model' => 'confirmDeleteModal']); ?>
             <?php $__env->slot('title', null, []); ?> 
                <div class="flex items-center gap-4">
...
<?php endif; ?>
    ...
    <?php if (isset($component)) { $__componentOriginal5b8b2d0f151a30be878e1a760ec3900c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal5b8b2d0f151a30be878e1a760ec3900c = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.confirmation-modal','data' => ['wire:model' => 'confirmDeleteItemModal']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('confirmation-modal'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:model' => 'confirmDeleteItemModal']); ?>
         <?php $__env->slot('title', null, []); ?> 
...
<?php endif; ?>
            ...
            <!--[if BLOCK]><![endif]--><?php if($itemToDelete): ?>
            <?php if (isset($component)) { $__componentOriginal656e8c5ea4d9a4fa173298297bfe3f11 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal656e8c5ea4d9a4fa173298297bfe3f11 = $attributes; } ?>
...
<?php /**PATH C:\xampp\htdocs\script\resources\views/livewire/order/order-detail.blade.php ENDPATH**/ ?>