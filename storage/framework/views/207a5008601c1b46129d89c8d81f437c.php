        ...
        <ul class="flex flex-wrap -mb-px settings-tab-bar">
            ...
            <li class="me-2">
                <a href="<?php echo e(route('settings.index').'?tab=restaurant'); ?>" wire:navigate
                    style="<?php echo e($activeSetting == 'restaurant' ? 'color: var(--brand-primary); border-bottom-color: var(--brand-primary);' : ''); ?>"
            ...
            <li class="me-2">
                ...
                style="<?php echo e($activeSetting == 'app' ? 'color: var(--brand-primary); border-bottom-color: var(--brand-primary);' : ''); ?>"
            ...
            <li class="me-2">
                ...
                style="<?php echo e($activeSetting == 'language' ? 'color: var(--brand-primary); border-bottom-color: var(--brand-primary);' : ''); ?>"
            ...
            <li class="me-2">
                ...
                style="<?php echo e($activeSetting == 'branch' ? 'color: var(--brand-primary); border-bottom-color: var(--brand-primary);' : ''); ?>"
            ...
            <li class="me-2">
                ...
                style="<?php echo e($activeSetting == 'currency' ? 'color: var(--brand-primary); border-bottom-color: var(--brand-primary);' : ''); ?>"
            ...
            <li class="me-2">
                ...
                style="<?php echo e($activeSetting == 'email' ? 'color: var(--brand-primary); border-bottom-color: var(--brand-primary);' : ''); ?>"
            ...
            <li class="me-2">
                ...
                style="<?php echo e($activeSetting == 'tax' ? 'color: var(--brand-primary); border-bottom-color: var(--brand-primary);' : ''); ?>"
            ...
            <li class="me-2">
                ...
                style="<?php echo e($activeSetting == 'payment' ? 'color: var(--brand-primary); border-bottom-color: var(--brand-primary);' : ''); ?>"
            ...
            <li class="me-2">
                ...
                style="<?php echo e($activeSetting == 'theme' ? 'color: var(--brand-primary); border-bottom-color: var(--brand-primary);' : ''); ?>"
            ...
            <li class="me-2">
                ...
                style="<?php echo e($activeSetting == 'role' ? 'color: var(--brand-primary); border-bottom-color: var(--brand-primary);' : ''); ?>"
            ...
            <li class="me-2">
                ...
                style="<?php echo e($activeSetting == 'billing' ? 'color: var(--brand-primary); border-bottom-color: var(--brand-primary);' : ''); ?>"
            ...
            <li class="me-2">
                ...
                style="<?php echo e($activeSetting == 'reservation' ? 'color: var(--brand-primary); border-bottom-color: var(--brand-primary);' : ''); ?>"
            ...
            <li class="me-2">
                ...
                style="<?php echo e($activeSetting == 'aboutus' ? 'color: var(--brand-primary); border-bottom-color: var(--brand-primary);' : ''); ?>"
            ...
            <li class="me-2">
                ...
                style="<?php echo e($activeSetting == 'customerSite' ? 'color: var(--brand-primary); border-bottom-color: var(--brand-primary);' : ''); ?>"
              ...
              <li class="me-2">
                ...
                style="<?php echo e($activeSetting == 'receipt' ? 'color: var(--brand-primary); border-bottom-color: var(--brand-primary);' : ''); ?>"
             ...
             <li class="me-2">
                ...
                style="<?php echo e($activeSetting == 'printer' ? 'color: var(--brand-primary); border-bottom-color: var(--brand-primary);' : ''); ?>"
            ...
            <li class="me-2">
                ...
                style="<?php echo e($activeSetting == 'deliverySettings' ? 'color: var(--brand-primary); border-bottom-color: var(--brand-primary);' : ''); ?>"
            ...
            <li class="me-2">
                ...
                style="<?php echo e($activeSetting == 'kotSettings' ? 'color: var(--brand-primary); border-bottom-color: var(--brand-primary);' : ''); ?>"
            ...
            <li class="me-2">
                ...
                style="<?php echo e($activeSetting == 'cancelSettings' ? 'color: var(--brand-primary); border-bottom-color: var(--brand-primary);' : ''); ?>"
            ...
            <li class="me-2">
                ...
                style="<?php echo e($activeSetting == 'orderSettings' ? 'color: var(--brand-primary); border-bottom-color: var(--brand-primary);' : ''); ?>"
...
$__html = app('livewire')->mount($__name, $__params, 'lw-1468016188-0', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'lw-1468016188-1', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'lw-1468016188-2', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'lw-1468016188-3', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'lw-1468016188-4', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'lw-1468016188-5', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'lw-1468016188-6', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'lw-1468016188-7', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'lw-1468016188-8', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'lw-1468016188-9', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'lw-1468016188-10', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'lw-1468016188-11', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'lw-1468016188-12', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'lw-1468016188-13', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'lw-1468016188-14', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'lw-1468016188-15', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'lw-1468016188-16', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'lw-1468016188-17', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'lw-1468016188-18', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'lw-1468016188-19', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'lw-1468016188-20', $__slots ?? [], get_defined_vars());
...
<?php /**PATH E:\nomufood\POS\resources\views/livewire/settings/master.blade.php ENDPATH**/ ?>