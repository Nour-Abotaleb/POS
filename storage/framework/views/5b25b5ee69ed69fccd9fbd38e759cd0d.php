    ...
    <div class="flex items-center justify-between">
      ...
      <div class="flex items-center justify-start">
        ...
        <a href="<?php echo e(route('dashboard')); ?>" class="flex ltr:ml-2 rtl:mr-2 items-center app-logo">
          ...
          <?php if(restaurant()->show_logo_text): ?>
      ...
      <?php endif; ?>
        ...
        <div class="flex gap-2">
          <?php if(in_array('Order', restaurant_modules()) && user_can('Show Order') && restaurant()->hide_new_orders == 0): ?>
            <?php
...
$__html = app('livewire')->mount($__name, $__params, 'lw-103107266-0', $__slots ?? [], get_defined_vars());
...
?>
          ...
          <?php if(in_array('Reservation', restaurant_modules()) && user_can('Show Reservation') && restaurant()->hide_new_reservations == 0 && in_array('Table Reservation', restaurant_modules())): ?>
            <?php
$__split = function ($name, $params = []) {
    return [$name, $params];
};
...
$__html = app('livewire')->mount($__name, $__params, 'lw-103107266-1', $__slots ?? [], get_defined_vars());
...
?>
          ...
          <?php if(in_array('Waiter Request', restaurant_modules()) && user_can('Manage Waiter Request') && restaurant()->hide_new_waiter_request == 0): ?>
            <?php
$__split = function ($name, $params = []) {
    return [$name, $params];
};
...
$__html = app('livewire')->mount($__name, $__params, 'lw-103107266-2', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'lw-103107266-3', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'lw-103107266-4', $__slots ?? [], get_defined_vars());
...
<?php endif; ?>
        ...
        <div class="flex items-center w-8">
          ...
          <div
            ...
            <ul class="py-1" role="none">
              ...
              <?php if(user_can('Manage Settings') && in_array('Settings', restaurant_modules())): ?>
              <li>
        ...
        <div class="flex items-center w-8">
          ...
          <div
            ...
            <ul class="py-1" role="none">
              <?php if(in_array('Customer Display', restaurant_modules())): ?>
              <li>
              ...
              <?php if(module_enabled('Kiosk') && in_array('Kiosk', restaurant_modules())): ?>
                <li>
...
<?php /**PATH C:\xampp\htdocs\script\resources\views\navigation-menu.blade.php ENDPATH**/ ?>