                            ...
                            <template x-if="filterView === 'select'">
                                <div class="relative">
                                    ...
                                    <select id="category-filter" wire:model.live="filterCategories" class="block w-full pl-9 pr-3 py-2 text-sm rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 text-gray-700 dark:text-gray-200 theme-focus">
                                        ...
                                        <?php $__currentLoopData = $this->categoryList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <div
                ...
                <ul class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 2xl:grid-cols-8 gap-3 max-h-[calc(100vh-12rem)] overflow-y-auto"
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $this->menuItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        ...
                        >
                                    ...
                                    <?php if(!$restaurant->hide_menu_item_image_on_pos): ?>
                    ...
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <li class="col-span-full text-center py-8 text-gray-500 dark:text-gray-400">
                            <?php if($this->menuItemsLoaded === 0 && $this->totalMenuItemsCount > 0): ?>
                ...
                <div class="flex items-center justify-center py-6 px-4">
                    <?php if(!$this->allItemsLoaded): ?>
                        <div wire:loading wire:target="loadInitialMenuItems,loadMoreMenuItems" class="flex items-center justify-center gap-3 text-gray-600 dark:text-gray-400">
