    ...
    <div class="p-4 bg-white dark:bg-gray-800 mb-6">
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                ...
                <tbody>
                    <?php $__currentLoopData = $taxBreakdown; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tax): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <div class="p-4 bg-white dark:bg-gray-800 mb-6">
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                ...
                <tbody>
                    <?php $__currentLoopData = $taxByDate; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dateData): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700 cursor-pointer transition-colors"
                            ...
                            <td class="px-6 py-4">
                                <?php if(count($dateData['tax_breakdown']) > 0): ?>
                                    <div class="space-y-1">
                                        <?php $__currentLoopData = $dateData['tax_breakdown']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $taxName => $taxInfo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="text-xs">
    ...
    <div class="p-4 bg-white dark:bg-gray-800 mb-6">
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $orderDetails; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $orderDetail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                            <td class="px-6 py-4 font-medium text-gray-900 dark:text-white">
                            ...
                            <td class="px-6 py-4">
                                <?php if(count($orderDetail['tax_breakdown']) > 0): ?>
                                    <div class="space-y-1">
                                        <?php $__currentLoopData = $orderDetail['tax_breakdown']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $taxName => $taxInfo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="text-xs">
                                                <span class="font-medium"><?php echo e($taxName); ?></span>
                                                <span class="text-green-600 dark:text-green-400">(<?php echo e(number_format($taxInfo['percent'], 2)); ?>%)</span>:
                                                <span class="font-semibold"><?php echo e(currency_format($taxInfo['amount'], restaurant()->currency_id)); ?></span>
...
<?php $component->withAttributes(['wire:model.live' => 'showDateOrdersModal','maxWidth' => '4xl','maxHeight' => 'full']); ?>
         ...
         <?php $__env->slot('content', null, []); ?> 
            <?php if(count($selectedDateOrders) > 0): ?>
            <div class="overflow-x-auto max-h-[70vh]">
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    ...
                    <tbody>
                        <?php $__currentLoopData = $selectedDateOrders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $orderDetail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php /**PATH C:\xampp\htdocs\script\resources\views\livewire\reports\tax-report.blade.php ENDPATH**/ ?>