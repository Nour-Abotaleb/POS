...
$__html = app('livewire')->mount($__name, $__params, 'lw-1156374904-0', $__slots ?? [], get_defined_vars());
...
?>
        ...
        <div class="mb-6">
            ...
            <div class="grid gap-3 sm:grid-cols-2 lg:grid-cols-7 sm:gap-4">
                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $reservationSettings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <!-- Card -->
                <a
            ...
            <!--[if BLOCK]><![endif]--><?php if($menuItems): ?>
                <div class="w-full">
