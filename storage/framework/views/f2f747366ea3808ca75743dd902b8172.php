            ...
            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $tables; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $area): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="flex flex-col gap-3 space-y-1 sm:gap-4" wire:key='area-<?php echo e($area->id . microtime()); ?>'>
                    ...
                    <div class="grid gap-3 sm:grid-cols-3 2xl:grid-cols-4 sm:gap-6">
                        <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $area->tables; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <a
...
<?php /**PATH C:\xampp\htdocs\script\resources\views/livewire/waiter-request/tables.blade.php ENDPATH**/ ?>