        ...
        <div class="w-full max-w-lg text-center px-8">
            ...
            <div class="mb-12">
                <div class="w-28 h-28 rounded-lg mx-auto mb-6 flex items-center justify-center">
                    <img src="<?php echo e($restaurant->logo_url); ?>" alt="<?php echo e($restaurant->name); ?>" class="w-full h-full object-cover">
                </div>
                <h1 class="text-3xl font-bold text-gray-900 mb-3"><?php echo e(__('kiosk::modules.welcome.title', ['name' => $restaurant->name])); ?></h1>
            </div>
            ...
            <button @click="startOrder()" 
                ...
                <?php echo e(__('kiosk::modules.welcome.start_order')); ?>

            </button>
        </div>
    </div>
</div>
<?php /**PATH C:\xampp\htdocs\script\Modules/Kiosk\Resources/views/livewire/kiosk/welcome.blade.php ENDPATH**/ ?>