<div class="grid lg:grid-cols-3">
                    ...
                    <ol class="relative border-s border-gray-200 dark:border-gray-700 space-y-8">
                        ...
                        <li class="ms-6">
                            ...
                            <h3 class="<?php echo \Illuminate\Support\Arr::toCssClasses(["mb-1.5 text-base font-semibold leading-none text-gray-900 dark:text-white flex
                                ...
                                <?php if($onboardingSteps->add_area_completed): ?>
                        ...
                        <li class="ms-6">
                            ...
                            <h3 class="<?php echo \Illuminate\Support\Arr::toCssClasses(["mb-1.5 text-base font-semibold leading-none text-gray-900 dark:text-white flex
                                ...
                                <?php if($onboardingSteps->add_table_completed): ?>
                        ...
                        <li class="ms-6">
                            ...
                            <h3 class="<?php echo \Illuminate\Support\Arr::toCssClasses(["mb-1.5 text-base font-semibold leading-none text-gray-900 dark:text-white flex
                                ...
                                <?php if($onboardingSteps->add_menu_completed): ?>
                        ...
                        <li class="ms-6">
                            ...
                            <h3 class="<?php echo \Illuminate\Support\Arr::toCssClasses(["mb-1.5 text-base font-semibold leading-none text-gray-900 dark:text-white flex
                                ...
                                <?php if($onboardingSteps->add_menu_items_completed): ?>
    ...
    <div class="col-span-2 px-8 lg:px-16 flex items-center w-full onboarding-steps">
        ...
        <?php if(!$onboardingSteps->add_area_completed || $showAddArea): ?>
...
$__html = app('livewire')->mount($__name, $__params, 'lw-2467708211-0', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'lw-2467708211-1', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'lw-2467708211-2', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'lw-2467708211-3', $__slots ?? [], get_defined_vars());
...
<?php /**PATH C:\xampp\htdocs\script\resources\views\livewire\onboarding\onboarding-steps.blade.php ENDPATH**/ ?>