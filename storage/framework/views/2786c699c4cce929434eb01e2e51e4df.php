...
<body class="bg-gray-50">
    <div class="container mx-auto px-4 py-6 max-w-2xl">
        <div class="flex flex-col items-center mb-12">
            <div class="flex items-center">
                <img src="<?php echo e(asset('img/logo.png')); ?>" class="h-12 w-auto" alt="Tabletrack Logo"/>
    ...
    <?php echo $__env->make('vendor.froiden-envato.plugins', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
<?php /**PATH C:\xampp\htdocs\script\resources\views/vendor/froiden-envato/verify_purchase.blade.php ENDPATH**/ ?>