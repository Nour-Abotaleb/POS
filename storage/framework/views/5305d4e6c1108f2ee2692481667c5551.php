...
<?php endif; ?>
                <div class="space-y-4 mt-1">
                    <?php $__currentLoopData = $modifierOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $modifierOption): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php endif; ?>
                                ...
                                <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-2.5 mt-2">
                                    <?php $__currentLoopData = $modifierOptionInput[$index]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lang => $text): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php if(!empty($text)): ?>
                        ...
                        <div @click="isOpen = !isOpen"
                            ...
                            <div class="flex items-center justify-between">
                                <div class="flex flex-wrap gap-1.5 flex-grow">
                                    <?php $__empty_1 = true; $__currentLoopData = $allMenuItems->whereIn('id', $selectedMenuItems)->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <span class="px-2 py-0.5 text-xs font-medium text-gray-700 bg-gray-100 border border-gray-300 rounded dark:bg-gray-700 dark:text-gray-200 dark:border-gray-600 flex items-center" wire:key="selected-item-<?php echo e($item->id); ?>" @click.stop>
                                            ...
                                            <?php if(isset($selectedVariations[$item->id]) && !empty(array_filter($selectedVariations[$item->id]))): ?>
                                                <?php
                                                    $selectedVarNames = [];
                                                    $hasVariations = false;
                                                ...
                                                <?php if(!empty($selectedVarNames)): ?>
                                                    <span class="ml-2 px-2 py-0.5 rounded bg-[#011646] text-white text-xs">
                                                        <?php if(isset($selectedVariations[$item->id]['item']) && $selectedVariations[$item->id]['item']): ?>
                                    ...
                                    <?php if($allMenuItems->whereIn('id', $selectedMenuItems)->count() > 5): ?>
...
<?php endif; ?>
                            ...
                            <div class="overflow-y-auto max-h-60">
                                <?php $__empty_1 = true; $__currentLoopData = $this->menuItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                            ...
                                            <div class="flex items-center gap-2">
                                                ...
                                                <div class="flex-shrink-0">
                                                    <div class="w-4 h-4 border rounded transition-colors duration-150"
                                                        ...
                                                        <?php if(in_array($item->id, $selectedMenuItems)): ?>
                                                ...
                                                <?php if($item->variations->count() > 0): ?>
