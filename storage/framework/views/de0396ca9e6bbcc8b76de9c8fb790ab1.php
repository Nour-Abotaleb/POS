                ...
                <div x-data="{ isOpen: <?php if ((object) ('isOpen') instanceof \Livewire\WireDirective) : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('isOpen'->value()); ?>')<?php echo e('isOpen'->hasModifier('live') ? '.live' : ''); ?><?php else : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('isOpen'); ?>')<?php endif; ?>.live , selectedMenuItems: <?php if ((object) ('selectedMenuItems') instanceof \Livewire\WireDirective) : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('selectedMenuItems'->value()); ?>')<?php echo e('selectedMenuItems'->hasModifier('live') ? '.live' : ''); ?><?php else : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('selectedMenuItems'); ?>')<?php endif; ?> }" @click.away="isOpen = false">
                    <div class="relative">
                        <div @click="isOpen = !isOpen"
                            ...
                            <div class="flex flex-wrap gap-2">
                                <?php $__empty_1 = true; $__currentLoopData = $allMenuItems->whereIn('id', $selectedMenuItems); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
...
<?php /**PATH C:\xampp\htdocs\script\resources\views\livewire\forms\edit-modifier-group.blade.php ENDPATH**/ ?>