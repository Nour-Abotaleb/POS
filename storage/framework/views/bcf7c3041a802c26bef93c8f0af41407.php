    ...
    <div x-show="currentScreen === 'payment'" 
        ...
        <div class="w-full max-w-6xl px-6">
            <div class="text-center mb-12">
                <h1 class="text-4xl font-bold text-gray-900 mb-4"><?php echo e(__('kiosk::modules.payment.heading')); ?></h1>
                <p class="text-xl text-gray-600"><?php echo e(__('kiosk::modules.payment.subheading')); ?></p>
            </div>

            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
                <!-- Order Summary -->
                <div class="bg-white border border-gray-200 rounded-lg p-8">
                    <h2 class="text-2xl font-bold text-gray-900 mb-6"><?php echo e(__('kiosk::modules.payment.order_summary')); ?></h2>
                    <div class="space-y-3 mb-6">
                        <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $cartItemList['items']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <div class="flex justify-between text-lg" wire:key="payment-cart-item-<?php echo e($item['id']); ?>">
                                <span><?php echo e($item['quantity']); ?>x <?php echo e($item['menu_item']['name']); ?></span>
                                <span><?php echo currency_format($item['amount'], $restaurant->currency_id); ?></span>
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                            <div class="text-center py-4 text-gray-500">
                                <span><?php echo e(__('kiosk::modules.payment.empty')); ?></span>
                            </div>
                        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                    </div>
                    <div class="border-t border-gray-200 pt-6 space-y-3">
                        <div class="flex justify-between text-lg">
                            <span class="text-gray-600"><?php echo e(__('kiosk::modules.payment.subtotal')); ?></span>
                        ...
                        <!--[if BLOCK]><![endif]--><?php if($totalTaxAmount > 0): ?>
                            ...
                            <?php else: ?>
                                ...
                                <?php else: ?>
                                    <div class="flex justify-between text-lg">
                                        <span class="text-gray-600"><?php echo e(__('kiosk::modules.payment.tax')); ?></span>
                        ...
                        <div class="flex justify-between text-2xl font-bold text-gray-900 border-t border-gray-200 pt-3">
                            <span><?php echo e(__('kiosk::modules.payment.total')); ?></span>
                ...
                <!-- Payment Methods -->
                <div class="bg-white border border-gray-200 rounded-lg p-8">
                    <h2 class="text-2xl font-bold text-gray-900 mb-6"><?php echo e(__('kiosk::modules.payment.heading')); ?></h2>
                    ...
                    <div class="space-y-4">
                        ...
                        <button @click="selectPaymentMethod('due'); $wire.selectPaymentMethod('due')" 
                            ...
                            <div class="flex items-center">
                                ...
                                <div class="text-left">
                                    <div class="font-bold text-gray-900 text-lg"><?php echo e(__('kiosk::modules.payment.cash')); ?></div>
                                    <div class="text-gray-600"><?php echo e(__('kiosk::modules.payment.cash_desc')); ?></div>
                                </div>
                            </div>
                        ...
                        <!--[if BLOCK]><![endif]--><?php if($paymentGateway && $paymentGateway->is_qr_payment_enabled): ?>
                            <button @click="selectPaymentMethod('upi'); $wire.selectPaymentMethod('upi')" 
                                ...
                                <div class="flex items-center">
                                    ...
                                    <div class="text-left">
                                        <div class="font-bold text-gray-900 text-lg"><?php echo e(__('kiosk::modules.payment.upi')); ?></div>
                                        <div class="text-gray-600"><?php echo e(__('kiosk::modules.payment.upi_desc')); ?></div>
                                    </div>
                                </div>
                            ...
                            <!--[if BLOCK]><![endif]--><?php if($showQrCode && $paymentGateway && $paymentGateway->qr_code_image_url): ?>
                            <div class="mt-4">
                                <div class="text-center">
                                    <img src="<?php echo e($paymentGateway->qr_code_image_url); ?>" alt="UPI QR Code" class=" max-w-48 mx-auto h-48">
                                </div>
                            </div>
                            <p class="text-gray-600 text-sm mt-2 text-center"><?php echo e(__('kiosk::modules.payment.upi_qr_code_desc')); ?></p>
                            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                    </div>
                    ...
                    <div class="mt-8 space-y-4">
                        <button @click="processPayment" wire:click="processPayment" 
                            ...
                            <?php echo e(__('kiosk::modules.payment.place_order')); ?>
                        ...
                        <button @click="currentScreen = 'customer-info'" 
                            ...
                            <?php echo e(__('kiosk::modules.payment.back')); ?>
...
<?php /**PATH C:\xampp\htdocs\script\Modules/Kiosk\Resources/views/livewire/kiosk/payment-method.blade.php ENDPATH**/ ?>