...
<?php endif; ?>
    ...
    <div class="flex flex-col">
        ...
        <div class="overflow-x-auto">
            <div class="mb-4 mx-4">
            <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['currency_error'];
                ...
                <div class="overflow-hidden shadow">
                    ...
                    <table class="min-w-full divide-y divide-gray-200 table-fixed dark:divide-gray-600">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700" wire:key='member-list-<?php echo e(microtime()); ?>'>
                            ...
                            <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $currencies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="hover:bg-gray-100 dark:hover:bg-gray-700 <?php echo e($item->id == $defaultCurrencyId ? 'bg-blue-50 dark:bg-blue-900/20 border-l-4 border-blue-500' : ''); ?>" wire:key='member-<?php echo e($item->id . rand(1111, 9999) . microtime()); ?>' wire:loading.class.delay='opacity-10'>
                                <td class="py-2.5 px-4 text-base text-gray-900 whitespace-nowrap dark:text-white">
                                    <div class="flex items-center gap-2">
                                        ...
                                        <!--[if BLOCK]><![endif]--><?php if($item->id == $defaultCurrencyId): ?>
                                ...
                                <td class="py-2.5 px-4 text-base text-gray-900 whitespace-nowrap dark:text-white">
                                    <?php echo e($item->currency_code); ?> (<?php echo $item->currency_symbol; ?>)
                                </td>

                                <td class="py-2.5 px-4 text-base text-gray-900 whitespace-nowrap dark:text-white">
                                    <?php echo global_currency_format(12345.6789, $item->id); ?>
...
$__html = app('livewire')->mount($__name, $__params, 'lw-1244578296-0', $__slots ?? [], get_defined_vars());
...
<?php /**PATH E:\nomu\testfood\POS\resources\views/livewire/settings/superadmin-currency-settings.blade.php ENDPATH**/ ?>