            ...
            <div class="card">
                ...
                <div class="card-body p-5">
                    ...
                    <div class="mb-6 flex flex-col md:flex-row gap-6">
                        ...
                        <?php if(($windows_file_path === \App\Models\DesktopApplication::WINDOWS_FILE_PATH) && ($mac_file_path === \App\Models\DesktopApplication::MAC_FILE_PATH)): ?>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                        ...
                        <div class="p-4 border rounded bg-gray-50 dark:bg-gray-800">
                            ...
                            <div class="relative">
                                ...
                                <?php if(!empty($windows_file_path)): ?>
                            ...
                            <?php $__errorArgs = ['windows_file_path'];
...
unset($__errorArgs, $__bag); ?>
                            <div class="flex gap-2 mt-3">
                                <?php if($windows_file_path !== \App\Models\DesktopApplication::WINDOWS_FILE_PATH): ?>
...
unset($__errorArgs, $__bag); ?>
                            <div class="flex gap-2 mt-3">
                                <?php if($mac_file_path !== \App\Models\DesktopApplication::MAC_FILE_PATH): ?>
...
<?php /**PATH C:\xampp\htdocs\script\resources\views\livewire\settings\desktop-application-settings.blade.php ENDPATH**/ ?>