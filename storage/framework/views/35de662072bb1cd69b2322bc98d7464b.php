<div
    ...
    <div class="flex items-center justify-between w-full mb-2">
        ...
        <?php if($this->orderTypes->count()): ?>
        <div class="flex items-center gap-2 flex-wrap">
            <?php $__currentLoopData = $this->orderTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <button
                    type="button"
            ...
            <?php if($orderTypeSlug === 'delivery' && $selectedDeliveryApp): ?>
                ...
                <span class="text-sm font-medium text-gray-900 dark:text-white">
                    <?php if($selectedDeliveryApp === 'default'): ?>
                        Default
                    <?php else: ?>
        ...
        <div class="flex items-center gap-4">
            ...
            <?php if($orderType == 'dine_in' && !is_null($tableNo)): ?>
                ...
                <?php if($orderType == 'dine_in'): ?>
                    <div class="flex flex-wrap items-center gap-2 justify-end">
                        ...
                        <div class="inline-flex items-center gap-2">
                            ...
                            <?php if(auth()->user()->roles->pluck('display_name')->contains('Waiter')): ?>
...
<?php endif; ?>
        ...
        <div class="flex-shrink-0 left-0 right-0 pb-8 pt-2 bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700 shadow-[0_-4px_12px_rgba(0,0,0,0.05)]">
            <div class="h-auto p-4 select-none text-center bg-gray-50 rounded space-y-2 dark:bg-gray-700">
                <?php if(count($orderItemList) > 0 && user_can('Add Discount on POS')): ?>
                    <div class="text-left">
                        <?php if (isset($component)) { $__componentOriginal3b0e04e43cf890250cc4d85cff4d94af = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3b0e04e43cf890250cc4d85cff4d94af = $attributes; } ?>
...
<?php endif; ?>
                ...
                <?php if(!$orderID && count($orderItemList) > 0 && $extraCharges): ?>
            ...
            <div class="h-auto pt-3 select-none text-center w-full">
                <?php if(in_array('KOT', restaurant_modules())): ?>
                    <div class="flex gap-3">
                        ...
                        <?php if(!$orderID || ($orderID && $orderDetail && $orderDetail->status !== 'draft')): ?>
...
<?php $component->withAttributes(['wire:model.live' => 'showMergeTableModal','maxWidth' => 'lg']); ?>
             ...
             <?php $__env->slot('content', null, []); ?> 
                <div class="space-y-4">
                    <?php if(count($tablesWithUnpaidOrders) > 0): ?>
                        <div class="text-sm text-gray-600 dark:text-gray-400 mb-4">
                            <?php echo app('translator')->get('modules.order.mergeTableDescription'); ?>
                        </div>
                        <div class="max-h-96 overflow-y-auto">
                            <div class="grid grid-cols-1 gap-3">
                                <?php $__currentLoopData = $tablesWithUnpaidOrders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $table): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <?php if(count($selectedTablesForMerge) > 0): ?>
