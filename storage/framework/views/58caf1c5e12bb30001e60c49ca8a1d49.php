            ...
            <!--[if BLOCK]><![endif]--><?php if($headerType === 'text'): ?>
                ...
                <div id="default-carousel" class="relative w-full touch-pan-y" data-carousel="slide">
                    ...
                    <div class="relative h-24 overflow-hidden border border-gray-200 rounded-lg shadow-lg sm:h-32 md:h-40 lg:h-48 dark:border-gray-700">
                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $headerImages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <?php elseif($headerType === 'image' && count($headerImages) > 0): ?>
                    ...
                    <div id="default-carousel" class="relative w-full touch-pan-y" data-carousel="slide">
                        ...
                        <!--[if BLOCK]><![endif]--><?php if(count($headerImages) > 1): ?>
                            <!-- Slider indicators -->
                            ...
                            <div class="<?php echo \Illuminate\Support\Arr::toCssClasses([
                                ...
                                <div class="flex w-full p-3 space-x-4">
                                    ...
                                    <div class="flex flex-col w-full gap-1 text-sm font-normal text-gray-500 lg:text-base dark:text-gray-400">
                                        ...
                                        <!--[if BLOCK]><![endif]--><?php if($item->calories): ?>
...
$__html = app('livewire')->mount($__name, $__params, 'lw-1656884447-0', $__slots ?? [], get_defined_vars());
...
<?php endif; ?>
    ...
    <!--[if BLOCK]><![endif]--><?php if($showCart): ?>
        ...
        <div class="px-4 mt-4 space-y-4">
            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $orderItemList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="flex items-center justify-between gap-6 transition bg-white border rounded-lg shadow-sm hover:shadow-md dark:border-gray-600 dark:lg:bg-gray-900 dark:shadow-sm"
                    ...
                    <div class="flex w-full p-4 space-x-4 dark:bg-gray-800 dark:text-gray-200">
                        ...
                        <div class="flex-1 min-w-0">
                            <div
                                ...
                                <div class="flex flex-wrap items-center justify-between gap-3 sm:w-auto md:w-1/3">
                                    ...
                                    <div class="flex flex-col items-end gap-1">
                                        <!--[if BLOCK]><![endif]--><?php if($taxMode === 'item' && $restaurant?->tax_inclusive): ?>
                                            <div class="text-xs text-gray-500 dark:text-gray-400">
                                                <?php echo currency_format($displayPrice, $restaurant->currency_id); ?> ×
                                        ...
                                        <span
                                            ...
                                            <?php echo currency_format($totalAmount, $restaurant->currency_id); ?>
                                    ...
                                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $itemModifiersSelected[$key]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $modifierOptionId): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <span
                                            ...
                                            <span class="ml-1" style="color: var(--brand-primary);">
                                                <?php echo currency_format($this->modifierOptions[$modifierOptionId]->price, $this->modifierOptions[$modifierOptionId]->modifierGroup->branch->restaurant->currency_id); ?>
                            ...
                            <!-- Item Notes Section -->
                            <div class="mt-2">
                                <!--[if BLOCK]><![endif]--><?php if(isset($this->itemNotes[$key]) && !empty($this->itemNotes[$key])): ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input','data' => ['xRef' => 'noteInput','xModel' => 'noteText','type' => 'text','class' => 'w-full pr-20 text-sm border border-gray-300 rounded-md dark:bg-gray-700 dark:border-gray-600 dark:text-white focus:ring-[var(--brand-primary)] focus:border-[var(--brand-primary)]','placeholder' => __('placeholders.addItemNotesPlaceholder'),'@keydown.enter' => '$wire.set(\'itemNotes.'.e($key).'\', noteText); showNoteInput = false']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['x-ref' => 'noteInput','x-model' => 'noteText','type' => 'text','class' => 'w-full pr-20 text-sm border border-gray-300 rounded-md dark:bg-gray-700 dark:border-gray-600 dark:text-white focus:ring-[var(--brand-primary)] focus:border-[var(--brand-primary)]','placeholder' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('placeholders.addItemNotesPlaceholder')),'@keydown.enter' => '$wire.set(\'itemNotes.'.e($key).'\', noteText); showNoteInput = false']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                        ...
                        <div class="flex justify-between text-sm text-gray-500 dark:text-gray-400">
                            ...
                            <div>
                                <?php echo currency_format($subTotal, $restaurant->currency_id); ?>

                            </div>
                        </div>

                        <!--[if BLOCK]><![endif]--><?php if(count($orderItemList) > 0 && $extraCharges && count($extraCharges) > 0): ?>
                            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $extraCharges; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $charge): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div wire:key="extra-charge-<?php echo e($loop->index); ?>"
                                    ...
                                    <div>
                                        <?php echo currency_format($charge->getAmount($subTotal), $restaurant->currency_id); ?>
                        ...
                        <!--[if BLOCK]><![endif]--><?php if($taxMode == 'order'): ?>
                            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $taxes ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="flex justify-between text-sm text-gray-500 dark:text-gray-400" wire:key="order-tax-<?php echo e($item->id); ?>">
                                    ...
                                    <div>
                                        <?php echo currency_format(($item->tax_percent / 100) * $subTotal, $restaurant->currency_id); ?>

                                    </div>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><!--[if ENDBLOCK]><![endif]-->
                        <?php else: ?>
                            <!--[if BLOCK]><![endif]--><?php if(!empty($orderItemTaxDetails) && count($orderItemTaxDetails)): ?>
                                <?php
                                    $taxTotals = [];
                                    $totalTax = 0;
                                ...
                                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $taxTotals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $taxName => $taxInfo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="flex justify-between text-xs text-gray-500 dark:text-neutral-400">
                                        ...
                                        <div>
                                            <?php echo currency_format($taxInfo['amount'], $restaurant->currency_id); ?>
                                ...
                                <div class="flex justify-between mt-2 text-sm text-gray-500 dark:text-neutral-400">
                                    ...
                                    <div>
                                        <?php echo currency_format($totalTax, $restaurant->currency_id); ?>
                        ...
                        <!--[if BLOCK]><![endif]--><?php if($orderType === 'delivery' && !is_null($deliveryFee)): ?>
                            <div class="flex justify-between text-sm text-gray-500 dark:text-gray-400">
                                <div>
                                ...
                                <div>
                                    <!--[if BLOCK]><![endif]--><?php if($deliveryFee > 0): ?>
                                        <?php echo currency_format($deliveryFee, $restaurant->currency_id); ?>
                        ...
                        <div class="flex justify-between font-medium text-gray-900 dark:text-white">
                            ...
                            <div>
                                <?php echo currency_format($total, $restaurant->currency_id); ?>

                            </div>
                        </div>
                    </div>

                    <!--[if BLOCK]><![endif]--><?php if($orderType === 'delivery' && !empty($deliveryAddress)): ?>
                        <div class="w-full h-auto p-4 mt-3 rounded select-none bg-gray-50 dark:bg-gray-700">
                            <div class="flex items-center justify-between mb-3">
                                ...
                                <!--[if BLOCK]><![endif]--><?php if(!empty($deliveryAddress)): ?>
                                    <?php if (isset($component)) { $__componentOriginal3b0e04e43cf890250cc4d85cff4d94af = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3b0e04e43cf890250cc4d85cff4d94af = $attributes; } ?>
...
<?php endif; ?>
                    ...
                    <div class="w-full h-auto pt-3 pb-4 text-center select-none"
                        ...
                        <div class="flex gap-2">
                            ...
                            <!--[if BLOCK]><![endif]--><?php if(is_null($customer) && ($restaurant->customer_login_required || $orderTypeSlug == 'delivery')): ?>
                                <?php if (isset($component)) { $__componentOriginale67687e3e4e61f963b25a6bcf3983629 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginale67687e3e4e61f963b25a6bcf3983629 = $attributes; } ?>
<?php $component = App\View\Components\Button::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('button'); ?>
                            ...
                            <?php else: ?>
                                <div class="grid w-full grid-cols-2 gap-2">
                                    ...
                                    <!--[if BLOCK]><![endif]--><?php if(!$order): ?>
                                        <!--[if BLOCK]><![endif]--><?php if($showPayNow): ?>
                                            <?php if (isset($component)) { $__componentOriginale67687e3e4e61f963b25a6bcf3983629 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginale67687e3e4e61f963b25a6bcf3983629 = $attributes; } ?>
<?php $component = App\View\Components\Button::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('button'); ?>
...
<?php endif; ?>
                                            ...
                                            <!--[if BLOCK]><![endif]--><?php if(!$isPaymentEnabled): ?>
                                                <?php if (isset($component)) { $__componentOriginal3b0e04e43cf890250cc4d85cff4d94af = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3b0e04e43cf890250cc4d85cff4d94af = $attributes; } ?>
                                ...
                                <div x-data="{ isOpen: <?php if ((object) ('phoneCodeIsOpen') instanceof \Livewire\WireDirective) : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('phoneCodeIsOpen'->value()); ?>')<?php echo e('phoneCodeIsOpen'->hasModifier('live') ? '.live' : ''); ?><?php else : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('phoneCodeIsOpen'); ?>')<?php endif; ?>.live }" @click.away="isOpen = false" class="relative w-28">
                                    <div @click="isOpen = !isOpen"
                                        ...
                                        <div class="flex items-center justify-between">
                                            <span class="text-sm">
                                                <!--[if BLOCK]><![endif]--><?php if($customerPhoneCode): ?>
...
<?php endif; ?>
                        ...
                        <!--[if BLOCK]><![endif]--><?php if($orderType === 'delivery' || $orderTypeSlug === 'delivery'): ?>
                            <div>
                                <?php if (isset($component)) { $__componentOriginald8ba2b4c22a13c55321e34443c386276 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginald8ba2b4c22a13c55321e34443c386276 = $attributes; } ?>
...
<?php $component->withAttributes(['wire:model.live' => 'showTableModal','maxWidth' => '2xl']); ?>
         ...
         <?php $__env->slot('content', null, []); ?> 
            <!--[if BLOCK]><![endif]--><?php if($showTableModal && $getTable): ?>
                <!-- Card Section -->
                <div class="col-span-2 space-y-8">
                    <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $tables; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $area): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="flex flex-col gap-3 space-y-3 sm:gap-4"
                            ...
                            <div class="grid grid-cols-2 gap-3 md:grid-cols-4 sm:gap-4">
                                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $area->tables; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <a class="<?php echo \Illuminate\Support\Arr::toCssClasses([
                                        ...
                                        <div class="p-3">
                                            <div class="flex flex-col items-center justify-center space-y-2">
                                                <!--[if BLOCK]><![endif]--><?php if($item->status == 'inactive'): ?>
...
<?php $component->withAttributes(['wire:model.live' => 'showVariationModal','maxWidth' => 'xl']); ?>
         ...
         <?php $__env->slot('content', null, []); ?> 
            <!--[if BLOCK]><![endif]--><?php if($menuItem): ?>
                <?php
$__split = function ($name, $params = []) {
    return [$name, $params];
};
                ...
                <div class="flex flex-col gap-2">
                    <div class="flex flex-col gap-2">
                        ...
                        <div class="flex flex-col gap-1">
                            ...
                            <!--[if BLOCK]><![endif]--><?php if($selectedItem->calories): ?>
                                <div class="text-sm text-gray-500 dark:text-gray-400">
                                    <?php echo e($selectedItem->calories); ?>

                                </div>
                            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                            <!--[if BLOCK]><![endif]--><?php if(strlen($selectedItem->description) > 100): ?>
...
<?php endif; ?>
    ...
    <!--[if BLOCK]><![endif]--><?php if($paymentOrder): ?>
        <?php if (isset($component)) { $__componentOriginal49bd1c1dd878e22e0fb84faabf295a3f = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal49bd1c1dd878e22e0fb84faabf295a3f = $attributes; } ?>
             ...
             <?php $__env->slot('content', null, []); ?> 
                <div
                    ...
                    <div class="inline-flex flex-col text-base font-semibold text-right text-gray-900 dark:text-white">
                        <div><?php echo currency_format($paymentOrder->total, $restaurant->currency_id); ?></div>
                    </div>
                </div>
...
<?php $component->withAttributes(['wire:model.live' => 'showModifiersModal','maxWidth' => 'xl']); ?>
         ...
         <?php $__env->slot('content', null, []); ?> 
            <!--[if BLOCK]><![endif]--><?php if($selectedModifierItem): ?>
                <?php
$__split = function ($name, $params = []) {
    return [$name, $params];
};
                    ...
                    <div class="flex flex-col">
                        <div class="flex gap-4 mb-4">
                            ...
                            <div class="text-sm font-normal text-gray-500 dark:text-gray-400">
                                ...
                                <!--[if BLOCK]><![endif]--><?php if($menuItem->calories): ?>
                                    <div class="text-xs text-gray-500 dark:text-gray-400 mt-1">
                                        <?php echo e($menuItem->calories); ?>
                                ...
                                <div class="overflow-hidden shadow">
                                    <table
                                        ...
                                        <tbody
                                            ...
                                            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $menuItem->variations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php $component->withAttributes(['wire:model.live' => 'showDeliveryAddressModal','maxWidth' => '4xl']); ?>
         ...
         <?php $__env->slot('content', null, []); ?> 
            <!--[if BLOCK]><![endif]--><?php if($shopBranch?->deliverySetting): ?>
                <?php
$__split = function ($name, $params = []) {
    return [$name, $params];
};
...
<?php /**PATH E:\nomufood\POS\resources\views/livewire/shop/cart.blade.php ENDPATH**/ ?>