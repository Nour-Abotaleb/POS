...
<?php endif; ?>
                    ...
                    <div class="lg:inline-flex items-center gap-4">
                        ...
                        <?php if(user_can('Create Staff Member') && ($stats['unlimited'] || $stats['current_count'] < $stats['staff_limit'])): ?>
...
$__html = app('livewire')->mount($__name, $__params, 'staff-table-'.e(microtime()).'', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'add-staff-' . now()->timestamp, $__slots ?? [], get_defined_vars());
...
<?php /**PATH C:\xampp\htdocs\script\resources\views\livewire\staff\staff-list.blade.php ENDPATH**/ ?>