...
$__html = app('livewire')->mount($__name, $__params, 'lw-2260127911-0', $__slots ?? [], get_defined_vars());
...
?>
    ...
    <div class="overflow-hidden rounded-lg bg-gray-50 dark:bg-gray-800">
        ...
        <div class="px-4 py-3 border-gray-200 bg-gray-50 dark:bg-gray-700 dark:border-gray-600">
            <?php if($order->order_status->value === 'cancelled'): ?>
            ...
            <?php else: ?>
                ...
                <div>
                    ...
                    <div class="flex flex-col justify-between text-gray-500 sm:flex-row sm:items-center sm:-mt-5 dark:text-gray-400">
                        <?php $__currentLoopData = $steps; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div class="flex items-start justify-between gap-3">
                                    <div class="space-y-1">
                                        ...
                                        <div class="flex flex-wrap items-center gap-1.5 text-xs text-gray-600 dark:text-gray-400">
                                            ...
                                            ?>
                                            <?php if($taxMode === 'item' && $restaurant?->tax_inclusive && $item->tax_amount > 0): ?>
                                    ...
                                    <span class="text-sm font-semibold text-gray-900 dark:text-white whitespace-nowrap">
                                        <?php echo e(currency_format(($item->price + $modifierTotal) * $item->quantity, $restaurant->currency_id)); ?>
                ...
                <div class="space-y-2">
                    <div class="flex items-center justify-between">
                        ...
                        <span class="font-medium text-gray-900 dark:text-white">
                            <?php echo e(currency_format($order->sub_total, $restaurant->currency_id)); ?>
                    ...
                    <?php if($canAddTip || $order->tip_amount > 0): ?>
                            ...
                            <div class="flex items-center justify-between gap-3 mt-2">
                                ...
                                <div class="flex items-center gap-2">
                                    ...
                                    <div>
                                        ...
                                        <?php if($order->tip_amount > 0 && $order->tip_note): ?>
                                ...
                                <div class="flex items-center gap-2">
                                    <?php if($order->tip_amount > 0 && !$canAddTip): ?>
...
<?php endif; ?>
                ...
                <div class="flex gap-4">
                    <?php if(is_null($customer) && ($restaurant->customer_login_required || $orderType == 'delivery')): ?>
                        <?php if (isset($component)) { $__componentOriginale67687e3e4e61f963b25a6bcf3983629 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginale67687e3e4e61f963b25a6bcf3983629 = $attributes; } ?>
<?php $component = App\View\Components\Button::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('button'); ?>
...
<?php endif; ?>
                    <?php else: ?>
                        <div class="grid w-full grid-cols-2 gap-4">
                            <?php if($paymentGateway->is_qr_payment_enabled || $paymentGateway->stripe_status || $paymentGateway->razorpay_status || $paymentGateway->is_offline_payment_enabled || $paymentGateway->flutterwave_status || $paymentGateway->paypal_status || $paymentGateway->epay_status): ?>
                                <?php if($order && $order->order_status->value !== 'cancelled' && $order->status !== 'pending_verification'): ?>
                                    <?php if (isset($component)) { $__componentOriginale67687e3e4e61f963b25a6bcf3983629 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginale67687e3e4e61f963b25a6bcf3983629 = $attributes; } ?>
<?php $component = App\View\Components\Button::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('button'); ?>
...
<?php endif; ?>
                    <div class="grid grid-cols-4 gap-3">
                        <?php $__currentLoopData = [5, 10, 15, 20]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $percentage): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php
