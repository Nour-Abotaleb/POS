...
<?php endif; ?>
    ...
    <?php if (isset($component)) { $__componentOriginal49bd1c1dd878e22e0fb84faabf295a3f = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal49bd1c1dd878e22e0fb84faabf295a3f = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.dialog-modal','data' => ['wire:model' => 'showLocationModal','maxWidth' => 'sm']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('dialog-modal'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:model' => 'showLocationModal','maxWidth' => 'sm']); ?>
         <?php $__env->slot('title', null, []); ?> 
...
<?php endif; ?>
            ...
            <?php if($headerType === 'text'): ?>
                ...
                <div id="default-carousel" class="relative w-full touch-pan-y" data-carousel="slide">
                    ...
                    <div class="relative h-24 overflow-hidden border border-gray-200 rounded-lg shadow-lg sm:h-32 md:h-40 lg:h-48 dark:border-gray-700">
                        <?php $__currentLoopData = $headerImages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <?php if(!$showCart && !$showOrderTypeModal): ?>
        ...
        <div class="flex flex-col px-4 my-4" x-data="{ showAll: false }">
            ...
            <div class="grid grid-cols-2 gap-3 lg:grid-cols-4 sm:gap-4">
                ...
                <!-- Dynamic Menu Cards -->
                <?php $__empty_1 = true; $__currentLoopData = $this->menuList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                ...
                <div x-show="open" x-cloak x-transition:enter="transition ease-out duration-200"
                    ...
                    <div class="overflow-y-auto max-h-80">
                        <button wire:click="filterMenu(null); $nextTick(() => { open = false })"
                            class="w-full px-4 py-2.5 text-left text-sm hover:bg-gray-50 dark:hover:bg-gray-600 transition-colors <?php echo e(is_null($filterCategories) ? 'bg-gray-50 dark:bg-gray-600' : 'text-gray-700 dark:text-gray-200'); ?>" style="<?php echo e(is_null($filterCategories) ? 'color: #011646;' : ''); ?>">
                            <?php echo app('translator')->get('app.showAll'); ?>
                        </button>

                        <?php $__currentLoopData = $this->categoryList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <button wire:click="filterMenu(<?php echo e($item->id); ?>); $nextTick(() => { open = false })"
                                class="w-full px-4 py-2.5 text-left text-sm hover:bg-gray-50 dark:hover:bg-gray-600 transition-colors flex items-center justify-between <?php echo e($filterCategories == $item->id ? 'bg-gray-50 dark:bg-gray-600' : 'text-gray-700 dark:text-gray-200'); ?>" style="<?php echo e($filterCategories == $item->id ? 'color: #011646;' : ''); ?>">
...
<?php endif; ?>
    ...
    <?php if($showMenu && !$showOrderTypeModal): ?>
        <div class="px-4 mb-32 space-y-4 lg:gap-8"
            ...
            <?php $__empty_1 = true; $__currentLoopData = $this->menuItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $itemCat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                ...
                <div class="space-y-4 lg:space-y-0 lg:grid lg:grid-cols-3 lg:gap-8">
                    <?php $__currentLoopData = $itemCat; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="<?php echo \Illuminate\Support\Arr::toCssClasses([
                            ...
                            <div class="flex w-full p-3 space-x-4">
                                <?php if($restaurant && !$restaurant->hide_menu_item_image_on_customer_site): ?>
                                ...
                                <div
                                    ...
                                    <div class="flex items-center justify-between w-full">
                                        <div>
                                            <?php if($item->variations_count == 0): ?>
                                                <span
                                        ...
                                        <?php if($canCreateOrder): ?>
                                            ...
                                            <?php elseif($restaurant->allow_customer_orders): ?>
                                                <?php if(isset($cartItemQty[$item->id]) && $cartItemQty[$item->id] > 0): ?>
                                                ...
                                                <?php else: ?>
                                                    ...
                                                    ?>
                                                    <?php if(($orderStats['unlimited'] || $orderStats['current_count'] < $orderStats['order_limit'])): ?>
...
<?php endif; ?>
            ...
            <div class="fixed flex justify-center w-full max-w-lg gap-6 -ml-4 bottom-24 lg:hidden">
                <?php if($this->shouldShowWaiterButtonMobile): ?>
                    <?php
...
$__html = app('livewire')->mount($__name, $__params, 'lw-1286856005-0', $__slots ?? [], get_defined_vars());
...
?>
                <?php endif; ?>
                <?php if(is_null(customer()) && $restaurant->customer_login_required): ?>
                    <?php if (isset($component)) { $__componentOriginale67687e3e4e61f963b25a6bcf3983629 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginale67687e3e4e61f963b25a6bcf3983629 = $attributes; } ?>
<?php $component = App\View\Components\Button::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('button'); ?>
...
<?php endif; ?>
    ...
    <?php if($showCart): ?>
        ...
        <div class="px-4 mt-4 space-y-4">
            <?php $__currentLoopData = $orderItemList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="flex-1 min-w-0">
                            <div
                                ...
                                <div class="flex flex-wrap items-center gap-2">
                                    ...
                                    <?php if(isset($orderItemVariation[$key])): ?>
                                        <span
                                ...
                                <div class="flex flex-wrap items-center justify-between gap-3 sm:w-auto md:w-1/3">
                                    ...
                                    <div class="flex flex-col items-end gap-1">
                                        <?php if($taxMode === 'item' && $restaurant?->tax_inclusive): ?>
                            ...
                            <?php if(!empty($itemModifiersSelected[$key])): ?>
                                <div class="flex flex-wrap gap-2 mt-2">
                                    <?php $__currentLoopData = $itemModifiersSelected[$key]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $modifierOptionId): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <span
                            ...
                            <!-- Item Notes Section -->
                            <div class="mt-2">
                                <?php if(isset($this->itemNotes[$key]) && !empty($this->itemNotes[$key])): ?>
                                        ...
                                        <div x-show="showNoteInput" x-cloak @click.away="showNoteInput = false"
                                            ...
                                            <div class="flex w-full">
                                                <div class="relative flex-1">
                                                    <?php if (isset($component)) { $__componentOriginalc2fcfa88dc54fee60e0757a7e0572df1 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalc2fcfa88dc54fee60e0757a7e0572df1 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input','data' => ['xRef' => 'noteInput','xModel' => 'noteText','type' => 'text','class' => 'w-full pr-20 text-sm border border-gray-300 rounded-md dark:bg-gray-700 dark:border-gray-600 dark:text-white focus:ring-[#011646] focus:border-[#011646]','placeholder' => __('placeholders.addItemNotesPlaceholder'),'@keydown.enter' => '$wire.set(\'itemNotes.'.e($key).'\', noteText); showNoteInput = false']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['x-ref' => 'noteInput','x-model' => 'noteText','type' => 'text','class' => 'w-full pr-20 text-sm border border-gray-300 rounded-md dark:bg-gray-700 dark:border-gray-600 dark:text-white focus:ring-[#011646] focus:border-[#011646]','placeholder' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('placeholders.addItemNotesPlaceholder')),'@keydown.enter' => '$wire.set(\'itemNotes.'.e($key).'\', noteText); showNoteInput = false']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalc2fcfa88dc54fee60e0757a7e0572df1)): ?>
<?php $attributes = $__attributesOriginalc2fcfa88dc54fee60e0757a7e0572df1; ?>
...
<?php endif; ?>
                        ...
                        <?php if(count($orderItemList) > 0 && $extraCharges && count($extraCharges) > 0): ?>
                            <?php $__currentLoopData = $extraCharges; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $charge): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div wire:key="extra-charge-<?php echo e($loop->index); ?>"
                                    ...
                                    <div class="inline-flex items-center gap-x-1"><?php echo e($charge->charge_name); ?>
                                        ...
                                        <?php if($charge->charge_type == 'percent'): ?>
                        ...
                        <?php if($taxMode == 'order'): ?>
                            <?php $__currentLoopData = $taxes ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="flex justify-between text-sm text-gray-500 dark:text-gray-400" wire:key="order-tax-<?php echo e($item->id); ?>">
                                    ...
                                    <div>
                                        <?php echo e(currency_format(($item->tax_percent / 100) * $subTotal, $restaurant->currency_id)); ?>

                                    </div>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <?php else: ?>
                            <?php if(!empty($orderItemTaxDetails) && count($orderItemTaxDetails)): ?>
                                <?php
                                    $taxTotals = [];
                                    $totalTax = 0;
                        ...
                        <?php if($orderType === 'delivery' && !is_null($deliveryFee)): ?>
                            <div class="flex justify-between text-sm text-gray-500 dark:text-gray-400">
                                <div>
                    ...
                    <?php if($orderType === 'delivery' && !empty($deliveryAddress)): ?>
...
<?php endif; ?>
                    ...
                    <div class="w-full h-auto pt-3 pb-4 text-center select-none"
                        ...
                        <div class="flex gap-2">
                            ...
                            <?php if(is_null($customer) && ($restaurant->customer_login_required || $orderTypeSlug == 'delivery')): ?>
                                <?php if (isset($component)) { $__componentOriginale67687e3e4e61f963b25a6bcf3983629 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginale67687e3e4e61f963b25a6bcf3983629 = $attributes; } ?>
<?php $component = App\View\Components\Button::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('button'); ?>
...
<?php $attributes = $attributes->except(\App\View\Components\Button::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'justify-center w-full','wire:click' => 'showPickupDateTime']); ?>
                                    <?php echo app('translator')->get('app.next'); ?>
                                 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginale67687e3e4e61f963b25a6bcf3983629)): ?>
...
<?php $attributes = $attributes->except(\App\View\Components\Button::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'flex items-center justify-center w-full gap-2','wire:click' => 'placeOrder(true)','wire:loading.delay.attr' => 'disabled']); ?>
                                                <span wire:loading.delay
                                                    wire:target="placeOrder(true)"><?php echo $loadingSpinner; ?></span>
...
<?php endif; ?>
                                            ...
                                            <?php if(!$isPaymentEnabled): ?>
                                                <?php if (isset($component)) { $__componentOriginal3b0e04e43cf890250cc4d85cff4d94af = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3b0e04e43cf890250cc4d85cff4d94af = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.secondary-button','data' => ['class' => 'flex items-center justify-center w-full gap-2','wire:click' => 'placeOrder','wire:loading.delay.attr' => 'disabled']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('secondary-button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'flex items-center justify-center w-full gap-2','wire:click' => 'placeOrder','wire:loading.delay.attr' => 'disabled']); ?>
                                                    <span wire:loading.delay
                                                        wire:target="placeOrder"><?php echo $loadingSpinner; ?></span>
...
<?php endif; ?>
                        ...
                        <div class="flex mt-4">
                            <a href="javascript:;" wire:click="showMenuItems"
                                class="relative text-gray-500 transition-colors duration-300 group hover:text-[#011646]">
                                <span class="inline-block"><?php echo app('translator')->get('app.back'); ?></span>
                                <span
                                    class="absolute bottom-0 left-0 w-0 h-0.5 bg-[#011646] group-hover:w-full transition-all duration-300 ease-in-out"></span>
                            </a>
                        </div>
                    </div>
                            ...
                            <div class="flex gap-2 mt-1">
                                ...
                                <div x-data="{ isOpen: <?php if ((object) ('phoneCodeIsOpen') instanceof \Livewire\WireDirective) : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('phoneCodeIsOpen'->value()); ?>')<?php echo e('phoneCodeIsOpen'->hasModifier('live') ? '.live' : ''); ?><?php else : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('phoneCodeIsOpen'); ?>')<?php endif; ?>.live }" @click.away="isOpen = false" class="relative w-28">
                                    ...
                                    <ul x-show="isOpen" x-transition class="absolute z-50 w-full mt-1 overflow-auto bg-white rounded-lg shadow-lg max-h-60 ring-1 ring-black ring-opacity-5 dark:bg-gray-700 dark:border-gray-600 dark:text-gray-300">
                                        ...
                                        <?php $__empty_1 = true; $__currentLoopData = $phonecodes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $phonecode): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
...
<?php endif; ?>
                        ...
                        <?php if($orderType === 'delivery' || $orderTypeSlug === 'delivery'): ?>
                            <div>
                                <?php if (isset($component)) { $__componentOriginald8ba2b4c22a13c55321e34443c386276 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginald8ba2b4c22a13c55321e34443c386276 = $attributes; } ?>
...
<?php endif; ?>
    ...
    <?php if (isset($component)) { $__componentOriginal49bd1c1dd878e22e0fb84faabf295a3f = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal49bd1c1dd878e22e0fb84faabf295a3f = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.dialog-modal','data' => ['wire:model.live' => 'showPickupDateTimeModal','maxWidth' => 'sm']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('dialog-modal'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:model.live' => 'showPickupDateTimeModal','maxWidth' => 'sm']); ?>
         <?php $__env->slot('title', null, []); ?> 
                ...
                <div class="space-y-4">
                    <div class="relative">
                         ...
                         <input type="datetime-local" id="delivery_datetime"
                            ...
                            wire:model.defer="deliveryDateTime" min="<?php echo e(now($restaurant->timezone ?? config('app.timezone'))->format('Y-m-d\TH:i')); ?>" max="<?php echo e($maxDate); ?>"
...
<?php $attributes = $attributes->except(\App\View\Components\ButtonCancel::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:click' => '$toggle(\'showPickupDateTimeModal\')','wire:loading.attr' => 'disabled']); ?><?php echo app('translator')->get('app.cancel'); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginala6eb8d48d97827815852966e89cf193a)): ?>
<?php $attributes = $__attributesOriginala6eb8d48d97827815852966e89cf193a; ?>
<?php unset($__attributesOriginala6eb8d48d97827815852966e89cf193a); ?>
...
<?php $component->withAttributes(['wire:model.live' => 'showTableModal','maxWidth' => '2xl']); ?>
         ...
         <?php $__env->slot('content', null, []); ?> 
            <?php if($showTableModal && $getTable): ?>
                <!-- Card Section -->
                <div class="col-span-2 space-y-8">
                    <?php $__empty_1 = true; $__currentLoopData = $tables; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $area): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="flex flex-col gap-3 space-y-3 sm:gap-4"
                            ...
                            <div class="grid grid-cols-2 gap-3 md:grid-cols-4 sm:gap-4">
                                <?php $__currentLoopData = $area->tables; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <a class="<?php echo \Illuminate\Support\Arr::toCssClasses([
                ...
                <div class="flex flex-col gap-2">
                    <div class="flex flex-col gap-2">
                        ...
                        <div class="flex flex-col gap-1">
                            ...
                            <?php if(strlen($selectedItem->description) > 100): ?>
             ...
             <?php $__env->slot('content', null, []); ?> 
                <div
                    ...
                    <div class="inline-flex flex-col text-base font-semibold text-right text-gray-900 dark:text-white">
                        <div><?php echo e(currency_format($paymentOrder->total, $restaurant->currency_id)); ?></div>
                    </div>
                </div>

                <?php if($showQrCode || $showPaymentDetail): ?>
                    <?php if (isset($component)) { $__componentOriginal3b0e04e43cf890250cc4d85cff4d94af = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3b0e04e43cf890250cc4d85cff4d94af = $attributes; } ?>
...
<?php endif; ?>
                    ...
                    <div class="flex items-center mt-2">
                        ...
                        <?php else: ?>
                            <span class="p-3 font-bold text-gray-700 rounded"><?php echo app('translator')->get('modules.billing.accountDetails'); ?></span>
                            <span><?php echo e($paymentGateway->offline_payment_detail); ?></span>
                        <?php endif; ?>
                    </div>
                 <?php else: ?>
                    <div class="grid items-center w-full grid-cols-1 gap-6 mt-4 md:grid-cols-2">
                        <?php if($paymentGateway->stripe_status): ?>
                            <?php if (isset($component)) { $__componentOriginal3b0e04e43cf890250cc4d85cff4d94af = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3b0e04e43cf890250cc4d85cff4d94af = $attributes; } ?>
...
<?php endif; ?>
                        ...
                        <?php if($paymentGateway->razorpay_status): ?>
                            <?php if (isset($component)) { $__componentOriginal3b0e04e43cf890250cc4d85cff4d94af = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3b0e04e43cf890250cc4d85cff4d94af = $attributes; } ?>
...
<?php endif; ?>
                        ...
                        <?php if($paymentGateway->flutterwave_status): ?>
                            <?php if (isset($component)) { $__componentOriginal3b0e04e43cf890250cc4d85cff4d94af = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3b0e04e43cf890250cc4d85cff4d94af = $attributes; } ?>
...
<?php endif; ?>
                        ...
                        <?php if($paymentGateway->paypal_status): ?>
                            <?php if (isset($component)) { $__componentOriginal3b0e04e43cf890250cc4d85cff4d94af = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3b0e04e43cf890250cc4d85cff4d94af = $attributes; } ?>
...
<?php endif; ?>
                        ...
                        <?php if($paymentGateway->payfast_status): ?>
                            <?php if (isset($component)) { $__componentOriginal3b0e04e43cf890250cc4d85cff4d94af = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3b0e04e43cf890250cc4d85cff4d94af = $attributes; } ?>
...
<?php endif; ?>
                        ...
                        <?php if($paymentGateway->paystack_status): ?>
                            <?php if (isset($component)) { $__componentOriginal3b0e04e43cf890250cc4d85cff4d94af = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3b0e04e43cf890250cc4d85cff4d94af = $attributes; } ?>
...
<?php endif; ?>
                        ...
                        <?php if($paymentGateway->xendit_status): ?>
                            <?php if (isset($component)) { $__componentOriginal3b0e04e43cf890250cc4d85cff4d94af = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3b0e04e43cf890250cc4d85cff4d94af = $attributes; } ?>
...
<?php endif; ?>
                        ...
                        <?php if($paymentGateway->epay_status): ?>
                            <?php if (isset($component)) { $__componentOriginal3b0e04e43cf890250cc4d85cff4d94af = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3b0e04e43cf890250cc4d85cff4d94af = $attributes; } ?>
...
<?php endif; ?>
                        ...
                        <?php if($paymentGateway->is_qr_payment_enabled && $paymentGateway->qr_code_image_url): ?>
                            <!-- Button -->
                            <?php if (isset($component)) { $__componentOriginal3b0e04e43cf890250cc4d85cff4d94af = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3b0e04e43cf890250cc4d85cff4d94af = $attributes; } ?>
...
<?php endif; ?>
                        ...
                        <?php if($paymentGateway->is_offline_payment_enabled && $paymentGateway->offline_payment_detail): ?>
                            <!-- Button -->
                            <?php if (isset($component)) { $__componentOriginal3b0e04e43cf890250cc4d85cff4d94af = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3b0e04e43cf890250cc4d85cff4d94af = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.secondary-button','data' => ['wire:click' => 'togglePaymenntDetail']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('secondary-button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:click' => 'togglePaymenntDetail']); ?>
                                <span class="inline-flex items-center">
                                    ...
                                    <span class="ml-2"><?php echo app('translator')->get('modules.billing.bankTransfer'); ?></span>
                                </span>
                             <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal3b0e04e43cf890250cc4d85cff4d94af)): ?>
...
<?php endif; ?>
                        ...
                        <?php if($paymentGateway->is_cash_payment_enabled): ?>
                            <?php if (isset($component)) { $__componentOriginal3b0e04e43cf890250cc4d85cff4d94af = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3b0e04e43cf890250cc4d85cff4d94af = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.secondary-button','data' => ['wire:click' => 'placeOrder(false, '.e($paymentOrder->id).', \'cash\')']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('secondary-button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:click' => 'placeOrder(false, '.e($paymentOrder->id).', \'cash\')']); ?>
                                <span class="inline-flex items-center">
                                    ...
                                    <span class="ml-2"><?php echo app('translator')->get('modules.order.payViaCash'); ?></span>
                                </span>
                             <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal3b0e04e43cf890250cc4d85cff4d94af)): ?>
...
<?php $attributes = $attributes->except(\App\View\Components\Button::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'ml-3','wire:click' => 'placeOrder(false, '.e($paymentOrder->id).', \''.e($showQrCode ? 'upi' : 'others').'\')','wire:loading.attr' => 'disabled']); ?><?php echo app('translator')->get('modules.billing.paymentDone'); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginale67687e3e4e61f963b25a6bcf3983629)): ?>
<?php $attributes = $__attributesOriginale67687e3e4e61f963b25a6bcf3983629; ?>
<?php unset($__attributesOriginale67687e3e4e61f963b25a6bcf3983629); ?>
...
<?php $attributes = $attributes->except(\App\View\Components\Button::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'ml-3','wire:click' => 'placeOrder(false, '.e($paymentOrder->id).', \'bank_transfer\')','wire:loading.attr' => 'disabled']); ?><?php echo app('translator')->get('modules.billing.paymentDone'); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginale67687e3e4e61f963b25a6bcf3983629)): ?>
<?php $attributes = $__attributesOriginale67687e3e4e61f963b25a6bcf3983629; ?>
<?php unset($__attributesOriginale67687e3e4e61f963b25a6bcf3983629); ?>
                                ...
                                <div class="overflow-hidden shadow">
                                    <table
                                        ...
                                        <tbody
                                            ...
                                            <?php $__currentLoopData = $menuItem->variations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php $component->withAttributes(['wire:model.live' => 'showDeliveryAddressModal','maxWidth' => '4xl']); ?>
         ...
         <?php $__env->slot('content', null, []); ?> 
            <?php if($shopBranch?->deliverySetting): ?>
                <?php
$__split = function ($name, $params = []) {
    return [$name, $params];
};
...
<?php /**PATH C:\xampp\htdocs\script\resources\views\livewire\shop\cart.blade.php ENDPATH**/ ?>