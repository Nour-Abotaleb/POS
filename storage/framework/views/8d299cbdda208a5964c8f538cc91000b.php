<div class="max-w-4xl mx-auto bg-white dark:bg-gray-800 rounded-xl p-2">
    ...
    <?php if($inRange && $isDeliveryTimeAvailable): ?>
...
<?php $component->withAttributes(['class' => 'mt-4']); ?>
            <div class="flex items-center">
                <?php if($isFreeDelivery): ?>
                    ...
                    <?php if(isset($freeDeliveryOverAmount) && $orderGrandTotal >= $freeDeliveryOverAmount): ?>
...
<?php endif; ?>
    ...
    <div class="flex justify-end mb-4">
        <?php if($customerAllAddresses?->isNotEmpty()): ?>
...
<?php endif; ?>
    ...
    <div class="space-y-6">
        ...
        <?php if($customerAllAddresses?->isNotEmpty() && !$showManualLocation): ?>
            <div class="grid gap-6 md:grid-cols-2">
                <?php $__currentLoopData = $customerAllAddresses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $address): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="flex h-full gap-3">
                                <div class="flex-shrink-0">
                                    <div class="w-6 h-6 rounded-full border-2 flex items-center justify-center
                                        ...
                                        <?php if($selectedAddressId == $address->id): ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.textarea','data' => ['id' => 'delivery-address','wire:model' => 'selectedAddress','rows' => '3','class' => 'w-full resize-none','placeholder' => ''.e(__('modules.delivery.fullAddressPlaceholder')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['id' => 'delivery-address','wire:model' => 'selectedAddress','rows' => '3','class' => 'w-full resize-none','placeholder' => ''.e(__('modules.delivery.fullAddressPlaceholder')).'']); ?>
                     <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php /**PATH C:\xampp\htdocs\script\resources\views\livewire\customer\location-selector.blade.php ENDPATH**/ ?>