      ...
      <div class="flex items-center justify-between">
        ...
        <div class="flex items-center justify-start">
          ...
          <a href="<?php echo e(route('superadmin.dashboard')); ?>" class="flex ltr:ml-2 rtl:mr-24 items-center app-logo">
            ...
            <?php if(restaurantOrGlobalSetting()->show_logo_text): ?>
...
$__html = app('livewire')->mount($__name, $__params, 'lw-3723706066-0', $__slots ?? [], get_defined_vars());
...
<?php /**PATH C:\xampp\htdocs\script\resources\views\livewire\superadmin-navigation-menu.blade.php ENDPATH**/ ?>