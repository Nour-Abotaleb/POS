<div>
    <div class="my-4 grid gap-6 grid-cols-3">
                            ...
                            <a href="javascript:;" wire:click="setOrderTable(<?php echo e($item); ?>)" wire:key="table-<?php echo e($item->id); ?>"
                                ...
                                <div class="p-3">
                                    <div class="flex flex-col space-y-2 items-center justify-center">
                                        <!--[if BLOCK]><![endif]--><?php if($isInactive): ?>
        ...
        <div class="col-span-1 space-y-3">
            ...
            <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $reservations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    ...
                    <div class="flex justify-between">
                        ...
                        <div class="text-gray-700 dark:text-neutral-400 flex flex-col space-y-1">
                            ...
                            <div class="inline-flex gap-2 items-center text-xs">
                                ...
                                <?php echo e($item->reservation_date_time->translatedFormat('h:i A')); ?>
...
<?php /**PATH C:\xampp\htdocs\script\resources\views/livewire/pos/set-table.blade.php ENDPATH**/ ?>