    ...
    <div class="overflow-x-auto bg-white dark:bg-gray-800 p-4">
        <table class="min-w-full border border-gray-200 dark:border-gray-700 rounded-lg overflow-hidden">
            ...
            <tbody class="divide-y divide-gray-200 dark:divide-gray-700 bg-white dark:bg-gray-800">
                <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $cancelledOrders ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
                        ...
                        <td class="p-4 text-sm text-gray-900 dark:text-white whitespace-nowrap">
                            <?php echo e($order->date_time ? \Carbon\Carbon::parse($order->date_time)->format('M d, Y h:i A') : __('modules.report.notAvailable')); ?>

                        </td>
                        <td class="p-4 text-sm text-gray-900 dark:text-white whitespace-nowrap">
                            <?php echo e($order->updated_at ? \Carbon\Carbon::parse($order->updated_at)->format('M d, Y h:i A') : __('modules.report.notAvailable')); ?>

                        </td>
                        <td class="p-4 text-sm text-gray-900 dark:text-white">
                            <?php echo e($order->customer->name ?? __('modules.report.walkIn')); ?>

                            <!--[if BLOCK]><![endif]--><?php if($order->customer && $order->customer->phone): ?>
                        ...
                        <td class="p-4 text-sm text-gray-900 dark:text-white">
                            ...
                            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                            <!--[if BLOCK]><![endif]--><?php if($order->waiter_id && $order->waiter && $order->waiter->roles->pluck('display_name')->contains('Waiter')): ?>
                                <!--[if BLOCK]><![endif]--><?php if($order->table): ?>
                                    <br>
                                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                            ...
                            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                            <!--[if BLOCK]><![endif]--><?php if(!$order->table && !($order->waiter_id && $order->waiter && $order->waiter->roles->pluck('display_name')->contains('Waiter'))): ?>
                        ...
                        <td class="p-4 text-sm text-gray-900 dark:text-white">
                            <!--[if BLOCK]><![endif]--><?php if($order->cancelledBy): ?>
                                <div class="flex items-center">
                                    <div>
                                        <div class="font-medium"><?php echo e($order->cancelledBy->name); ?></div>
                                        <!--[if BLOCK]><![endif]--><?php if($order->cancelledBy->email): ?>
            ...
            <!--[if BLOCK]><![endif]--><?php if(count($cancelledOrders ?? []) > 0): ?>
...
<?php /**PATH C:\xampp\htdocs\script\resources\views/livewire/reports/cancelled-order-report.blade.php ENDPATH**/ ?>