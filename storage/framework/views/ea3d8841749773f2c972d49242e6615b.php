...
<?php endif; ?>
            ...
            <!--[if BLOCK]><![endif]--><?php if(user_can('Create Reservation') && in_array('Table Reservation', restaurant_modules()) && restaurant()->enable_admin_reservation): ?>
...
<?php $component->withAttributes(['wire:model.live' => 'showAddReservation']); ?>
         ...
         <?php $__env->slot('content', null, []); ?> 
            <!--[if BLOCK]><![endif]--><?php if($showAddReservation): ?>
                <?php
$__split = function ($name, $params = []) {
    return [$name, $params];
};
...
$__html = app('livewire')->mount($__name, $__params, 'lw-1480574698-0', $__slots ?? [], get_defined_vars());
