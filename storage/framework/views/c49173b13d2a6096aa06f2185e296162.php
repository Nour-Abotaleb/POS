    ...
    <div class="fixed inset-0 flex items-center justify-center bg-black/40 backdrop-blur-sm z-50 p-4">
        <div class="bg-white dark:bg-gray-900 rounded-2xl shadow-2xl w-full max-w-3xl max-h-[90vh] flex flex-col overflow-hidden">
            ...
            <div class="px-6 py-4 border-b border-gray-100 dark:border-gray-800 bg-gradient-to-r from-gray-50 to-white dark:from-gray-800 dark:to-gray-900">
                <div class="flex flex-col md:flex-row items-center justify-between gap-4">
                    ...
                    <div class="flex items-center gap-2">
                        <?php if($selectionStage === 'delivery_platform'): ?>
            ...
            <div class="flex-1 overflow-y-auto p-6">
                ...
                <?php if($selectionStage === 'order_type'): ?>
                    <!-- Order Types Selection -->
                    <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
                        <?php $__empty_1 = true; $__currentLoopData = $orderTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $orderType): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <button wire:click="selectOrderType(<?php echo e($orderType->id); ?>, '<?php echo e($orderType->slug); ?>')"
                            ...
                            <?php if($selectedOrderTypeSlug === $orderType->slug): ?>
                            ...
                            <div class="mb-3 p-3 rounded-lg <?php echo e($selectedOrderTypeSlug === $orderType->slug ? 'bg-[#011646]/10' : 'bg-gray-50 dark:bg-gray-900 group-hover:bg-[#011646]/5'); ?> transition-colors duration-200">
                                <?php if($orderType->slug === 'dine_in'): ?>
                ...
                <?php else: ?>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <?php $__currentLoopData = $deliveryPlatforms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $platform): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php /**PATH C:\xampp\htdocs\script\resources\views\livewire\forms\order-type-selection.blade.php ENDPATH**/ ?>