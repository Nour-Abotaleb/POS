         ...
         <!-- Language Enable Radio Buttons -->
                <div class="mb-6">
                    ...
                    <div class="flex flex-wrap gap-4">
                        <?php $__currentLoopData = $languageEnable; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input','data' => ['type' => 'text','id' => 'priceTitle','wire:model' => 'priceTitle','class' => 'mt-1 block w-full']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['type' => 'text','id' => 'priceTitle','wire:model' => 'priceTitle','class' => 'mt-1 block w-full']); ?>
...
<?php /**PATH C:\xampp\htdocs\script\resources\views\livewire\landing-site\price-setting.blade.php ENDPATH**/ ?>