    ...
    <div class="p-4 bg-white dark:bg-gray-800">
        ...
        <div class="mb-6 p-6 rounded-xl border" style="background: rgba(194, 194, 194, 0.08); border-color: rgba(206, 206, 206, 0.25);">
            <h2 class="text-xl font-bold text-gray-900 dark:text-white mb-4 flex items-center gap-2">
                ...
                <?php echo app('translator')->get('modules.report.todaysTaxSummary'); ?>
            </h2>
            <div class="grid grid-cols-1 gap-4 sm:grid-cols-3">
                <div class="bg-white dark:bg-gray-800 p-4 rounded-lg shadow">
                    <p class="text-sm text-gray-600 dark:text-gray-400 mb-1"><?php echo app('translator')->get('modules.report.todaysTaxCollection'); ?></p>
                ...
                <div class="bg-white dark:bg-gray-800 p-4 rounded-lg shadow">
                    <p class="text-sm text-gray-600 dark:text-gray-400 mb-1"><?php echo app('translator')->get('modules.report.todaysOrders'); ?></p>
                    <p class="text-2xl font-bold text-gray-900 dark:text-white"><?php echo e($todayOrdersCount); ?></p>
                </div>
                <div class="bg-white dark:bg-gray-800 p-4 rounded-lg shadow">
                    <p class="text-sm text-gray-600 dark:text-gray-400 mb-1"><?php echo app('translator')->get('modules.report.todaysRevenue'); ?></p>
        ...
        <div class="grid grid-cols-1 gap-4 mb-6 sm:grid-cols-2 md:grid-cols-4">
            ...
            <div class="p-4 rounded-xl shadow-sm border" style="background-color: rgba(1, 22, 70, 0.05); border-color: rgba(1, 22, 70, 0.3);">
                <div class="flex items-center justify-between mb-2">
                    <h3 class="text-sm font-medium" style="color: #011646;"><?php echo app('translator')->get('modules.report.totalTaxes'); ?></h3>
            ...
            <div class="p-4 bg-purple-50 rounded-xl shadow-sm dark:bg-purple-900/10 border border-purple-100 dark:border-purple-800">
                <div class="flex items-center justify-between mb-2">
                    <h3 class="text-sm font-medium text-purple-600 dark:text-purple-400"><?php echo app('translator')->get('modules.report.totalItemsSold'); ?></h3>
...
<?php endif; ?>
            ...
            <ul class="flex flex-wrap items-center -mb-px settings-tab-bar">
                <li class="me-2">
                    <span wire:click="$set('activeTab', 'byTaxType')" class="<?php echo \Illuminate\Support\Arr::toCssClasses([
                        ...
                        <?php echo app('translator')->get('modules.report.taxBreakdownByTaxType'); ?>
                    </span>
                </li>
                <li class="me-2">
                    <span wire:click="$set('activeTab', 'byDate')" class="<?php echo \Illuminate\Support\Arr::toCssClasses([
                        ...
                        <?php echo app('translator')->get('modules.report.taxBreakdownByDate'); ?>
                    </span>
                </li>
                <li class="me-2">
                    <span wire:click="$set('activeTab', 'byOrder')" class="<?php echo \Illuminate\Support\Arr::toCssClasses([
                        ...
                        <?php echo app('translator')->get('modules.report.taxDetailsByOrder'); ?>
                    </span>
                </li>
            </ul>
        </div>
    ...
    <?php if($activeTab == 'byTaxType'): ?>
    <!--[if BLOCK]><![endif]--><?php if(count($taxBreakdown) > 0): ?>
    <div class="p-4 bg-white dark:bg-gray-800 mb-6">
        <div class="flex justify-between items-center mb-4">
            <h2 class="text-xl font-bold text-gray-900 dark:text-white"><?php echo app('translator')->get('modules.report.taxBreakdownByTaxType'); ?></h2>
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                    <tr>
                        <th scope="col" class="px-6 py-3"><?php echo app('translator')->get('modules.report.taxName'); ?></th>
                        <th scope="col" class="px-6 py-3"><?php echo app('translator')->get('modules.report.taxRatePercent'); ?></th>
                        <th scope="col" class="px-6 py-3"><?php echo app('translator')->get('modules.report.totalTaxAmount'); ?></th>
                        <th scope="col" class="px-6 py-3"><?php echo app('translator')->get('modules.report.itemsCount'); ?></th>
                        <th scope="col" class="px-6 py-3"><?php echo app('translator')->get('modules.report.ordersCount'); ?></th>
                    </tr>
                </thead>
                <tbody>
                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $taxBreakdown; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tax): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <tr class="bg-gray-100 dark:bg-gray-700 font-bold">
                        <td class="px-6 py-4" colspan="2"><?php echo app('translator')->get('modules.report.total'); ?></td>
    ...
    <?php if($activeTab == 'byDate'): ?>
    <!--[if BLOCK]><![endif]--><?php if(count($taxByDate) > 0): ?>
    <div class="p-4 bg-white dark:bg-gray-800 mb-6">
        <div class="flex justify-between items-center mb-4">
            <h2 class="text-xl font-bold text-gray-900 dark:text-white"><?php echo app('translator')->get('modules.report.taxBreakdownByDate'); ?></h2>
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                    <tr>
                        <th scope="col" class="px-6 py-3"><?php echo app('translator')->get('app.date'); ?></th>
                        <th scope="col" class="px-6 py-3"><?php echo app('translator')->get('modules.report.totalTaxes'); ?></th>
                        <th scope="col" class="px-6 py-3"><?php echo app('translator')->get('modules.report.totalRevenue'); ?></th>
                        <th scope="col" class="px-6 py-3"><?php echo app('translator')->get('modules.report.orders'); ?></th>
                        <th scope="col" class="px-6 py-3"><?php echo app('translator')->get('modules.report.itemsSold'); ?></th>
                        <th scope="col" class="px-6 py-3"><?php echo app('translator')->get('modules.report.taxBreakdown'); ?></th>
                    </tr>
                </thead>
                <tbody>
                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $taxByDate; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dateData): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700 cursor-pointer transition-colors"
                            ...
                            <td class="px-6 py-4">
                                <!--[if BLOCK]><![endif]--><?php if(count($dateData['tax_breakdown']) > 0): ?>
                                    <div class="space-y-1">
                                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $dateData['tax_breakdown']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $taxName => $taxInfo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="text-xs">
                                ...
                                <?php else: ?>
                                    <span class="text-gray-400 text-xs"><?php echo app('translator')->get('modules.report.noTaxBreakdown'); ?></span>
                                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                            </td>
                        </tr>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><!--[if ENDBLOCK]><![endif]-->
                    <tr class="bg-gray-100 dark:bg-gray-700 font-bold">
                        <td class="px-6 py-4"><?php echo app('translator')->get('modules.report.total'); ?></td>
    ...
    <!--[if BLOCK]><![endif]--><?php if($activeTab == 'byOrder'): ?>
    <div class="p-4 bg-white dark:bg-gray-800 mb-6">
        <div class="flex justify-between items-center mb-4">
            <h2 class="text-xl font-bold text-gray-900 dark:text-white"><?php echo app('translator')->get('modules.report.taxDetailsByOrder'); ?></h2>
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                    <tr>
                        <th scope="col" class="px-6 py-3"><?php echo app('translator')->get('modules.report.orderNumber'); ?></th>
                        <th scope="col" class="px-6 py-3"><?php echo app('translator')->get('app.dateTime'); ?></th>
                        <th scope="col" class="px-6 py-3"><?php echo app('translator')->get('modules.order.subTotal'); ?></th>
                        <th scope="col" class="px-6 py-3"><?php echo app('translator')->get('modules.report.taxBreakdown'); ?></th>
                        <th scope="col" class="px-6 py-3"><?php echo app('translator')->get('modules.report.totalTaxes'); ?></th>
                        <th scope="col" class="px-6 py-3"><?php echo app('translator')->get('modules.order.total'); ?></th>
                    </tr>
                </thead>
                <tbody>
                    <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $orderDetails; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $orderDetail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                            <td class="px-6 py-4 font-medium text-gray-900 dark:text-white">
                            ...
                            <td class="px-6 py-4">
                                <?php echo e(\Carbon\Carbon::parse($orderDetail['order']->date_time)->format('M d, Y h:i A')); ?>
                            ...
                            <td class="px-6 py-4">
                                <!--[if BLOCK]><![endif]--><?php if(count($orderDetail['tax_breakdown']) > 0): ?>
                                    <div class="space-y-1">
                                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $orderDetail['tax_breakdown']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $taxName => $taxInfo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="text-xs">
                                                <span class="font-medium"><?php echo e($taxName); ?></span>
                                                <span class="text-green-600 dark:text-green-400">(<?php echo e(number_format($taxInfo['percent'], 2)); ?>%)</span>:
                                                <span class="font-semibold"><?php echo e(currency_format($taxInfo['amount'], restaurant()->currency_id)); ?></span>
                                ...
                                <?php else: ?>
                                    <span class="text-gray-400"><?php echo app('translator')->get('modules.report.noTaxBreakdown'); ?></span>
                                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                            </td>
                            <td class="px-6 py-4 font-semibold">
...
<?php $component->withAttributes(['wire:model.live' => 'showDateOrdersModal','maxWidth' => '4xl','maxHeight' => 'full']); ?>
         <?php $__env->slot('title', null, []); ?> 
            <div class="flex items-center gap-2">
                ...
                <span><?php echo app('translator')->get('modules.report.taxDetailsFor'); ?> <?php echo e($selectedDate ? \Carbon\Carbon::createFromFormat('Y-m-d', $selectedDate)->format('M d, Y') : ''); ?></span>
            </div>
         <?php $__env->endSlot(); ?>

         <?php $__env->slot('content', null, []); ?> 
            <!--[if BLOCK]><![endif]--><?php if(count($selectedDateOrders) > 0): ?>
            <div class="overflow-x-auto max-h-[70vh]">
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    ...
                    <tbody>
                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $selectedDateOrders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $orderDetail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="text-center py-8 text-gray-500 dark:text-gray-400">
                ...
                <p><?php echo app('translator')->get('modules.report.noOrdersFoundForThisDate'); ?></p>
            </div>
            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
         <?php $__env->endSlot(); ?>
...
<?php /**PATH C:\xampp\htdocs\script\resources\views/livewire/reports/tax-report.blade.php ENDPATH**/ ?>