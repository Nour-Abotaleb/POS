<div>
    ...
    <div class="w-full">
        ...
        <ul class="divide-y divide-gray-200 dark:divide-gray-700">
            <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $paymentMethods; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    ...
                    <div class="flex items-center space-x-4 rtl:space-x-reverse">
                        <div class="flex-1 min-w-0">
                            <p class="text-base text-gray-900 truncate dark:text-white flex items-center gap-1">
                                ...
                                <!--[if BLOCK]><![endif]--><?php if(!in_array($item->payment_method, ['razorpay', 'stripe'])): ?>
                        ...
                        <div class="inline-flex items-center text-base font-medium text-gray-900 dark:text-white">
                            <?php echo currency_format($item->total_amount, restaurant()->currency_id); ?>
...
<?php /**PATH C:\xampp\htdocs\script\resources\views/livewire/dashboard/today-payment-method-earnings.blade.php ENDPATH**/ ?>