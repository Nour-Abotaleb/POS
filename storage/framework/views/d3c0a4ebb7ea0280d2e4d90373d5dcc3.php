    ...
    <div class="p-4 bg-white dark:bg-gray-800">
        ...
        <div class="grid grid-cols-1 gap-4 mb-4 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <div class="p-4 bg-yellow-50 rounded-xl shadow-sm dark:bg-yellow-900/10 border border-yellow-100 dark:border-yellow-800">
                ...
                <?php if(!empty($topCancelledReasons)): ?>
                    <div class="space-y-2">
                        <?php $__currentLoopData = $topCancelledReasons; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $reason): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <?php $__empty_1 = true; $__currentLoopData = $cancelledOrders ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
                        ...
                        <td class="p-4 text-sm text-gray-900 dark:text-white">
                            ...
                            <?php endif; ?>
                            <?php if($order->waiter_id && $order->waiter && $order->waiter->roles->pluck('display_name')->contains('Waiter')): ?>
                                <?php if($order->table): ?>
                                    <br>
                                <?php endif; ?>
                            ...
                            <?php endif; ?>
                            <?php if(!$order->table && !($order->waiter_id && $order->waiter && $order->waiter->roles->pluck('display_name')->contains('Waiter'))): ?>
