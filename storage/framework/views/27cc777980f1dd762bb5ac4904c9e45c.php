        ...
        <div class="mb-10">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 items-stretch">
                <?php $__currentLoopData = $modules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $module): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a href="<?php echo e($module['product_link']); ?>" target="_blank" class="block">
                        <div class="bg-white rounded-xl shadow-md hover:shadow-xl transition-all duration-300 flex flex-col items-center p-4 relative group cursor-pointer">
                            ...
                            <div class="bg-gray-100 rounded-lg shadow p-1 mb-3 flex items-center justify-center">
                                <img src="<?php echo e($module['product_thumbnail']); ?>" alt="<?php echo e($module['product_name']); ?>"
                                     class="w-[80px] h-[80px] object-cover rounded-md" />
                            </div>

                            <!-- Content -->
                            <h3 class="text-base font-bold text-gray-900 text-center mb-1"><?php echo e(str_replace('for Tabletrack', '', $module['product_name'])); ?></h3>

                            <!-- Version and Sales -->
                            <div class="flex items-center gap-2 mb-2">
                                <span class="text-xs text-gray-500 bg-gray-100 px-2 py-0.5 rounded">
                                    v<?php echo e($module['version']); ?>

                                </span>
                                <span class="text-xs text-gray-500 bg-green-100 px-2 py-0.5 rounded">
                                    <?php echo e($module['number_of_sales']); ?> sales
                                </span>
                            </div>

                            <!-- Rating -->
                            <?php if($module['rating_count'] > 0): ?>
                                <div class="flex items-center mb-2">
                                    <div class="flex items-center">
                                        <?php for($i = 1; $i <= 5; $i++): ?>
                                            <svg class="w-3 h-3 <?php echo e($i <= $module['rating'] ? 'text-yellow-400' : 'text-gray-300'); ?>" fill="currentColor" viewBox="0 0 20 20">
                                                <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"/>
                                            </svg>
                                        <?php endfor; ?>
                                    </div>
                                    <span class="text-xs text-gray-500 ml-1">(<?php echo e($module['rating_count']); ?>)</span>
                                </div>
                            <?php else: ?>
                                <div class="flex items-center mb-2">
                            ...
                            <?php if($module['summary']): ?>
                                <p class="text-xs text-gray-600 text-center mb-3 line-clamp-3"><?php echo e($module['summary']); ?></p>
                            <?php endif; ?>
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\script\resources\views/vendor/froiden-envato/plugins.blade.php ENDPATH**/ ?>