            ...
            <div class="space-y-4">
                ...
                <div class="bg-gray-50 dark:bg-gray-800 rounded-lg p-4 border border-gray-200 dark:border-gray-600">
                    ...
                    <div class="relative mt-3" @click.away="$wire.call('resetSearch')">
                        <!--[if BLOCK]><![endif]--><?php if($availableResults && count($availableResults) > 0): ?>
                            <div class="absolute z-50 w-full bg-white dark:bg-gray-800 rounded-lg shadow-lg border border-gray-200 dark:border-gray-600 overflow-hidden">
                                <div class="max-h-60 overflow-y-auto">
                                    ...
                                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $availableResults; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $result): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="relative">
                                ...
                                <!--[if BLOCK]><![endif]--><?php if($selectedCustomerId): ?>
                                    <button type="button"
                                        ...
                                        <!--[if BLOCK]><![endif]--><?php if($editingFields['name']): ?>
                                ...
                                <div class="flex-1 relative">
                                    ...
                                    <!--[if BLOCK]><![endif]--><?php if($selectedCustomerId): ?>
                                        <button type="button"
                                                ...
                                                class="absolute inset-y-0 right-0 pr-3 flex items-center text-gray-400 hover:text-gray-600 transition-colors">
                                            <!--[if BLOCK]><![endif]--><?php if($editingFields['phone']): ?>
                                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/>
                                                </svg>
                                            <?php else: ?>
                        ...
                        <div class="relative">
                            ...
                            <!--[if BLOCK]><![endif]--><?php if($selectedCustomerId): ?>
                                <button type="button"
                                        ...
                                        class="absolute inset-y-0 right-0 pr-3 flex items-center text-gray-400 hover:text-gray-600 transition-colors">
                                    <!--[if BLOCK]><![endif]--><?php if($editingFields['email']): ?>
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/>
                                        </svg>
                                    <?php else: ?>
                        ...
                        <div class="relative">
                            ...
                            <!--[if BLOCK]><![endif]--><?php if($selectedCustomerId): ?>
                                <button type="button"
                                    ...
                                    <!--[if BLOCK]><![endif]--><?php if($editingFields['address']): ?>
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/>
                                        </svg>
                                    <?php else: ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\script\resources\views/livewire/customer/add-customer.blade.php ENDPATH**/ ?>