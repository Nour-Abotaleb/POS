<?php $__env->startSection('content'); ?>
    ...
    <div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto space-y-8">
        ...
        <!-- End Title -->
        <!-- Grid -->
            <?php $__currentLoopData = $frontFeatures; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $feature): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <?php $__currentLoopData = $frontFeatures; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $feature): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div>
                        <div
                            ...
                            <?php else: ?>
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#011646"
                                    class="bi bi-qr-code-scan size-6" style="color: #011646; fill: #011646;" viewBox="0 0 16 16">
                                    <path
                        ...
                        <div class="mt-5">
                            ...
                            <p class="mt-1 text-gray-600 dark:text-neutral-400"><?php echo $feature->description; ?></p>
                        </div>
                    </div>
                    <!-- End Icon Block -->
                    <?php endif; ?>
    ...
    <div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                <?php $__currentLoopData = $frontReviews; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $review): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <!-- Card -->
    ...
    <div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto" id="user-faqs">
        ...
        <div class="max-w-2xl mx-auto text-center mb-10 lg:mb-14">
            ...
            <p class="mt-1 text-gray-600 dark:text-neutral-400"><?php echo $frontDetails->faq_description ?? __('landing.faqSubTitle1'); ?></p>
        </div>
        <!-- End Title -->
            <div class="max-w-5xl mx-auto">
                <!-- Grid -->
                <div class="grid sm:grid-cols-2 gap-6 md:gap-12">
                    <?php $__currentLoopData = $frontFaqs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $frontFaq): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div>
    ...
    <div class="max-w-7xl px-4 lg:px-8 py-12 lg:py-24 mx-auto">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 lg:items-center gap-6 md:gap-8 lg:gap-12">
            ...
            <?php if(!empty($frontContact->image)): ?>
...
<?php echo $__env->make('layouts.landing', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\script\resources\views/landing/dynamic-index.blade.php ENDPATH**/ ?>