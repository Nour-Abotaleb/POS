                ...
                <div class="overflow-hidden shadow">
                    <table class="min-w-full divide-y divide-gray-200 table-fixed dark:divide-gray-600">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700" wire:key='reason-list-<?php echo e(microtime()); ?>'>
                            ...
                            <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $reasons; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $reason): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="hover:bg-gray-100 dark:hover:bg-gray-700" wire:key='reason-<?php echo e($reason->id . rand(1111, 9999) . microtime()); ?>' wire:loading.class.delay='opacity-10'>
                                ...
                                <td class="py-2.5 px-4 text-base text-gray-900 whitespace-nowrap dark:text-white">
                                    <div class="flex items-center gap-2">
                                        <!--[if BLOCK]><![endif]--><?php if($reason->cancel_order): ?>
                                        ...
                                        <!--[if BLOCK]><![endif]--><?php if($reason->cancel_kot): ?>
                                ...
                                <td class="py-2.5 px-4 space-x-2 whitespace-nowrap text-right">
                                    <!--[if BLOCK]><![endif]--><?php if(strtolower($reason->reason) === 'other'): ?>
...
$__html = app('livewire')->mount($__name, $__params, 'lw-4242075352-0', $__slots ?? [], get_defined_vars());
...
<?php echo e(__("modules.settings.editKotCancelReason")); ?>
 ...
 <?php $__env->slot('content', null, []); ?> 
<!--[if BLOCK]><![endif]--><?php if($reasonToEdit): ?>
    <?php
$__split = function ($name, $params = []) {
    return [$name, $params];
};
...
$__html = app('livewire')->mount($__name, $__params, $reasonToEdit->id, $__slots ?? [], get_defined_vars());
...
<?php /**PATH C:\xampp\htdocs\script\resources\views/livewire/settings/cancellation-settings.blade.php ENDPATH**/ ?>