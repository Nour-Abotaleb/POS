                    ...
                    <table class="min-w-full divide-y divide-gray-200 table-fixed dark:divide-gray-600">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700" wire:key='member-list-<?php echo e(microtime()); ?>'>
                            ...
                            <tr class="hover:bg-gray-100 dark:hover:bg-gray-700" wire:key='member-<?php echo e($item->id . rand(1111, 9999) . microtime()); ?>' wire:loading.class.delay='opacity-10'>
                                ...
                                <td class="py-2.5 px-4 text-base text-gray-900 whitespace-nowrap dark:text-white">
                                    <?php echo currency_format(12345.6789, $item->id); ?>
...
<?php endif; ?>
                                    ...
                                    <!--[if BLOCK]><![endif]--><?php if($item->id != restaurant()->currency_id): ?>
...
$__html = app('livewire')->mount($__name, $__params, 'lw-1912298920-0', $__slots ?? [], get_defined_vars());
...
<?php /**PATH E:\nomu\testfood\POS\resources\views/livewire/settings/currency-settings.blade.php ENDPATH**/ ?>