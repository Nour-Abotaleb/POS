...
<div
    ...
    style="display: none; z-index: 100; <?php echo e($forceAboveHeader ? 'padding-top: 5rem;' : ''); ?>"
>
    ...
    <div x-show="show" class="mb-6 bg-white dark:bg-gray-800 rounded-lg overflow-hidden shadow-xl transform transition-all sm:w-full <?php echo e($maxWidth); ?> <?php echo e($maxHeight); ?> sm:mx-auto overflow-y-auto"
...
<?php /**PATH C:\xampp\htdocs\script\resources\views/components/modal.blade.php ENDPATH**/ ?>