...
$__html = app('livewire')->mount($__name, $__params, 'lw-468379259-0', $__slots ?? [], get_defined_vars());
...
?>
    ...
    <div class="overflow-hidden rounded-lg bg-gray-50 dark:bg-gray-800">
        ...
        <div class="px-4 py-3 border-gray-200 bg-gray-50 dark:bg-gray-700 dark:border-gray-600">
            <!--[if BLOCK]><![endif]--><?php if($order->order_status->value === 'cancelled'): ?>
            ...
            <?php else: ?>
                ...
                <div>
                    ...
                    <div class="left-0 hidden w-full h-0.5 bg-gray-200 rounded sm:block top-5 mt-5 dark:bg-gray-600">
                        <div class="h-0.5 progress-bar-fill rounded bg-[var(--brand-primary)]/80 dark:bg-[var(--brand-primary)]/90"
                    ...
                    <div class="flex flex-col justify-between text-gray-500 sm:flex-row sm:items-center sm:-mt-5 dark:text-gray-400">
                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $steps; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="<?php echo \Illuminate\Support\Arr::toCssClasses([
                                ...
                                <div class="<?php echo \Illuminate\Support\Arr::toCssClasses([
                                    ...
                                    'bg-[var(--brand-primary)] text-white shadow-lg shadow-[var(--brand-primary)]/25' => $index == $currentStepIndex,
                                    'bg-[var(--brand-primary)] text-white' => $index < $currentStepIndex,
                                    ...
                                    <!--[if BLOCK]><![endif]--><?php if($index <= $currentStepIndex): ?>
                                ...
                                <!--[if BLOCK]><![endif]--><?php if(!$loop->last): ?>
                                    <div class="top-8 left-4 h-full w-0.5 bg-gray-200 dark:bg-gray-600 hidden">
                                        <!--[if BLOCK]><![endif]--><?php if($index < $currentStepIndex): ?>
                                            <div class="h-full transition-all duration-700 ease-out bg-[var(--brand-primary)]/60 dark:bg-[var(--brand-primary)]/80"></div>
                                        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                    </div>
                                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                ...
                                <div class="<?php echo \Illuminate\Support\Arr::toCssClasses([
                                    ...
                                    <p class="<?php echo \Illuminate\Support\Arr::toCssClasses([
                                        ...
                                        'text-[var(--brand-primary)] dark:text-[var(--brand-primary)]/90' => $index == $currentStepIndex,
                                        'text-[var(--brand-primary)] dark:text-[var(--brand-primary)]/90' => $index <= $currentStepIndex,
    ...
    <div class="p-3 mb-3 rounded-lg shadow-sm bg-gray-50 dark:bg-gray-800">
        ...
        <div class="flex flex-col justify-between gap-3 mb-3 md:flex-row">
            <div class="flex flex-col gap-1.5">
                ...
                <div class="flex flex-wrap gap-3 text-xs text-gray-600 dark:text-gray-400">
                    ...
                    <div class="flex items-center gap-1.5">
                        ...
                        <?php echo e($order->date_time->timezone(timezone())->translatedFormat('M d, Y h:i A')); ?>
                    ...
                    <!--[if BLOCK]><![endif]--><?php if($order->table_id): ?>
                        <div class="flex items-center gap-1.5">
                            ...
                            <span class="px-1.5 py-0.5 bg-[var(--brand-primary)] text-gray-100 rounded-full text-xs font-medium">
            ...
            <div class="flex items-center gap-1 md:flex-col md:items-end">
                <div class="text-lg font-bold text-gray-900 md:text-xl dark:text-white">
                    <?php echo currency_format($order->total, $restaurant->currency_id); ?>
        ...
        <!-- Delivery Address -->
        <!--[if BLOCK]><![endif]--><?php if($order->order_type === 'delivery' && $order->delivery_address): ?>
            <div class="p-2 mt-3 rounded-lg bg-[var(--brand-primary)]/5 dark:bg-gray-700/30" wire:key="delivery-address">
                <div class="flex items-center gap-2">
        ...
        <div class="p-2 mt-3 rounded-lg bg-[var(--brand-primary)]/15">
            <div class="flex items-center gap-2 text-[var(--brand-primary)]">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
                <span class="text-xs font-medium text-[var(--brand-primary)]">
                    <?php
                        $timeValue = null;
                        $timeLabel = null;
                    ...
                    <!--[if BLOCK]><![endif]--><?php if($timeValue): ?>
                    ...
                    <div class="p-3 hover:bg-gray-50 dark:hover:bg-gray-700/50">
                        <div class="flex items-center gap-3">
                            ...
                            <div class="flex-1 min-w-0">
                                <div class="flex items-start justify-between gap-3">
                                    <div class="space-y-1">
                                        <div class="flex flex-wrap items-center gap-1.5">
                                            ...
                                            <!--[if BLOCK]><![endif]--><?php if(isset($item->menuItemVariation)): ?>
                                        ...
                                        <div class="flex flex-wrap items-center gap-1.5 text-xs text-gray-600 dark:text-gray-400">
                                            ...
                                            ?>
                                            <!--[if BLOCK]><![endif]--><?php if($taxMode === 'item' && $restaurant?->tax_inclusive && $item->tax_amount > 0): ?>
                                                <span class="font-medium">
                                                    <?php echo currency_format(($item->price + $modifierTotal) - ($item->tax_amount / $item->quantity), $restaurant->currency_id); ?>
                                            ...
                                            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                            <span class="font-medium">
                                                <?php echo currency_format($item->price + $modifierTotal, $restaurant->currency_id); ?>
                                    ...
                                    <div class="space-y-1 text-xs">
                                        ...
                                        <!--[if BLOCK]><![endif]--><?php if($order->kot->isNotEmpty()): ?>
                                            <?php
                                    ...
                                    <span class="text-sm font-semibold text-gray-900 dark:text-white whitespace-nowrap">
                                        <?php echo currency_format(($item->price + $modifierTotal) * $item->quantity, $restaurant->currency_id); ?>

                                    </span>
                                </div>

                                <!--[if BLOCK]><![endif]--><?php if($item->modifierOptions->isNotEmpty()): ?>
                                    <div class="flex flex-wrap gap-1.5 mt-2">
                                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $item->modifierOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $modifier): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <span class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium bg-[var(--brand-primary)]/10 text-[var(--brand-primary)]">
                                                <?php echo e($modifier->name ?? $modifier->pivot->modifier_option_name); ?>

                                                <span class="ml-1 text-[var(--brand-primary)]">
                                                    (+<?php echo currency_format($modifier->pivot->modifier_option_price ?? $modifier->price, $restaurant->currency_id); ?>)
                                                </span>
                                            </span>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><!--[if ENDBLOCK]><![endif]-->
                                    </div>
                                ...
                                <!--[if BLOCK]><![endif]--><?php if($item->note): ?>
                ...
                <div class="space-y-2">
                    <div class="flex items-center justify-between">
                        ...
                        <span class="font-medium text-gray-900 dark:text-white">
                            <?php echo currency_format($order->sub_total, $restaurant->currency_id); ?>

                        </span>
                    </div>

                    <!--[if BLOCK]><![endif]--><?php if(!is_null($order->discount_amount)): ?>
                        <div wire:key="discountAmount"
                            class="flex justify-between text-xs text-green-500 dark:text-green-400">
                            <div>
                                <?php echo app('translator')->get('modules.order.discount'); ?> <!--[if BLOCK]><![endif]--><?php if($order->discount_type == 'percent'): ?>
                                    (<?php echo e(rtrim(rtrim(number_format($order->discount_value, 2), '0'), '.')); ?>%)
                                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                            </div>
                            <div>
                                -<?php echo currency_format($order->discount_amount, $restaurant->currency_id); ?>
                    ...
                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $order->charges; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="flex justify-between text-xs text-gray-600 dark:text-gray-400">
                            <div class="inline-flex items-center gap-x-1">
                                <?php echo e($item->charge->charge_name); ?>

                                <!--[if BLOCK]><![endif]--><?php if($item->charge->charge_type == 'percent'): ?>
                                    (<?php echo e($item->charge->charge_value); ?>%)
                                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                            </div>
                            <div class="text-gray-900 dark:text-white">
                                <?php echo currency_format(($item->charge->getAmount($order->sub_total - ($order->discount_amount ?? 0))) , $restaurant->currency_id); ?>

                            </div>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><!--[if ENDBLOCK]><![endif]-->

                    <!--[if BLOCK]><![endif]--><?php if($taxMode == 'order'): ?>
                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $order->taxes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="flex items-center justify-between text-xs">
                                <span class="text-gray-600 dark:text-gray-400">
                                    <?php echo e($item->tax->tax_name); ?> (<?php echo e($item->tax->tax_percent); ?>%)
                                </span>
                                <span class="text-gray-900 dark:text-white">
                                    <?php echo currency_format(($item->tax->tax_percent / 100) * ($order->sub_total - ($order->discount_amount ?? 0)), $restaurant->currency_id); ?>

                                </span>
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><!--[if ENDBLOCK]><![endif]-->
                    <?php else: ?>
                        <!--[if BLOCK]><![endif]--><?php if($order->total_tax_amount > 0): ?>
                        <?php
                            $taxTotals = [];
                            $totalTax = 0;
                        ...
                        <div class="mt-2">
                            <div class="space-y-1">
                                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $taxTotals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $taxName => $taxInfo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="flex justify-between text-xs text-gray-400 dark:text-gray-500">
                                    ...
                                    <span><?php echo currency_format($taxInfo['amount'], $restaurant->currency_id); ?></span>
                                </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><!--[if ENDBLOCK]><![endif]-->
                            </div>
                            <div class="flex justify-between text-sm text-gray-500 dark:text-gray-400">
                                ...
                                <div>
                                    <span class="text-gray-900 dark:text-white"><?php echo currency_format($totalTax, $restaurant->currency_id); ?></span>
                                </div>
                            </div>
                        </div>
                        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                    ...
                    <!--[if BLOCK]><![endif]--><?php if($order->order_type === 'delivery' && !is_null($order->delivery_fee)): ?>
                        <div class="flex justify-between text-xs text-gray-500 dark:text-gray-400">
                            <div>
                                <?php echo app('translator')->get('modules.delivery.deliveryFee'); ?>
                            </div>
                            <div>
                                <!--[if BLOCK]><![endif]--><?php if($order->delivery_fee > 0): ?>
                                    <span class="text-gray-900 dark:text-white">
                                        <?php echo currency_format($order->delivery_fee, $restaurant->currency_id); ?>
                    ...
                    <!--[if BLOCK]><![endif]--><?php if($canAddTip || $order->tip_amount > 0): ?>
                        <div class="border-t border-gray-200 dark:border-gray-700" wire:key="tip-details-and-amounts">
                            <div class="flex items-center justify-between gap-3 mt-2">
                                <!-- Left Section: Icon and Text -->
                                <div class="flex items-center gap-2">
                                    <div class="p-1.5 rounded-lg bg-[var(--brand-primary)]/10">
                                        <svg class="w-3.5 h-3.5 text-[var(--brand-primary)]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <div>
                                        ...
                                        <!--[if BLOCK]><![endif]--><?php if($order->tip_amount > 0 && $order->tip_note): ?>
                                ...
                                <div class="flex items-center gap-2">
                                    <!--[if BLOCK]><![endif]--><?php if($order->tip_amount > 0 && !$canAddTip): ?>
                                        <span class="text-xs font-medium dark:text-white"><?php echo currency_format($order->tip_amount, $restaurant->currency_id); ?></span>
                                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->

                                    <!--[if BLOCK]><![endif]--><?php if($canAddTip): ?>
...
<?php $component->withAttributes(['wire:click' => 'addTipModal','class' => 'flex items-center text-xs']); ?>
                                            <!--[if BLOCK]><![endif]--><?php if($order->tip_amount > 0): ?>
                                                <span class="font-medium"><?php echo currency_format($order->tip_amount, $restaurant->currency_id); ?></span>
...
<?php endif; ?>
        ...
        <div class="p-3 my-3 shadow-sm bg-gray-50 dark:bg-gray-800 rounded-xl">
            ...
            <!-- Payment History -->
            <!--[if BLOCK]><![endif]--><?php if($order->payments->count()): ?>
                <div class="mb-3 space-y-3">
                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $order->payments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="flex items-start justify-between gap-3">
                                ...
                                <div class="flex items-start gap-2">
                                    ...
                                    <div class="p-1.5 bg-gray-100 rounded-full dark:bg-gray-500">
                                        <!--[if BLOCK]><![endif]--><?php switch($payment->payment_method):
                                            case ('stripe'): ?>
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm text-gray-500 dark:text-gray-400">
                                            <?php echo e($payment->created_at->timezone(timezone())->translatedFormat('M d, Y h:i A')); ?>

                                        </p>
                                        <!--[if BLOCK]><![endif]--><?php if($payment->transaction_id): ?>
                                ...
                                <div class="text-right">
                                    <span class="text-lg font-semibold text-gray-900 dark:text-white">
                                        <?php echo currency_format($payment->amount, $restaurant->currency_id); ?>

                                    </span>
                                    <!--[if BLOCK]><![endif]--><?php if($payment->balance > 0): ?>
                                        <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                                            <?php echo app('translator')->get('modules.order.balanceReturn'); ?>:
                                            <span class="font-medium">
                                                <?php echo currency_format($payment->balance, $restaurant->currency_id); ?>
...
<?php $component->withAttributes([]); ?>
                    ...
                    <!--[if BLOCK]><![endif]--><?php if($order->status === 'pending_verification'): ?>
...
<?php endif; ?>
                ...
                <div class="flex gap-4">
                    <!--[if BLOCK]><![endif]--><?php if(is_null($customer) && ($restaurant->customer_login_required || $orderType == 'delivery')): ?>
                        <?php if (isset($component)) { $__componentOriginale67687e3e4e61f963b25a6bcf3983629 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginale67687e3e4e61f963b25a6bcf3983629 = $attributes; } ?>
<?php $component = App\View\Components\Button::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('button'); ?>
...
<?php endif; ?>
                    <?php else: ?>
                        <div class="grid w-full grid-cols-2 gap-4">
                            <!--[if BLOCK]><![endif]--><?php if($paymentGateway->is_qr_payment_enabled || $paymentGateway->stripe_status || $paymentGateway->razorpay_status || $paymentGateway->is_offline_payment_enabled || $paymentGateway->flutterwave_status || $paymentGateway->paypal_status || $paymentGateway->epay_status): ?>
                                <!--[if BLOCK]><![endif]--><?php if($order && $order->order_status->value !== 'cancelled' && $order->status !== 'pending_verification'): ?>
                                    <?php if (isset($component)) { $__componentOriginale67687e3e4e61f963b25a6bcf3983629 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginale67687e3e4e61f963b25a6bcf3983629 = $attributes; } ?>
<?php $component = App\View\Components\Button::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('button'); ?>
             ...
             <?php $__env->slot('content', null, []); ?> 
                <div class="flex items-center justify-between p-2 mb-4 rounded-md cursor-pointer bg-gray-50 dark:bg-gray-800">
                    ...
                    <div class="inline-flex flex-col text-base font-semibold text-right text-gray-900 dark:text-white">
                        <div><?php echo currency_format($total, $restaurant->currency_id); ?></div>
                    </div>
                </div>

                <!--[if BLOCK]><![endif]--><?php if($showQrCode || $showPaymentDetail): ?>
...
<?php endif; ?>
                    ...
                    <div class="flex items-center mt-2">
                        <!--[if BLOCK]><![endif]--><?php if($showQrCode): ?>
                            <img src="<?php echo e($paymentGateway->qr_code_image_url); ?>" alt="QR Code Preview"
                                class="object-cover rounded-md h-30 w-30">
                        <?php else: ?>
                            <span class="p-3 font-bold text-gray-700 rounded dark:text-gray-400"><?php echo app('translator')->get('modules.billing.accountDetails'); ?></span>
                ...
                <?php else: ?>
                    <div class="grid items-center w-full grid-cols-1 gap-4 mt-4 md:grid-cols-2">
                        <!--[if BLOCK]><![endif]--><?php if($paymentGateway->stripe_status): ?>
...
<?php endif; ?>
                            ...
                            <!--[if BLOCK]><![endif]--><?php if($paymentGateway->razorpay_status): ?>
                                <?php if (isset($component)) { $__componentOriginal3b0e04e43cf890250cc4d85cff4d94af = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3b0e04e43cf890250cc4d85cff4d94af = $attributes; } ?>
...
<?php endif; ?>
                            ...
                            <!--[if BLOCK]><![endif]--><?php if($paymentGateway->flutterwave_status): ?>
                            <?php if (isset($component)) { $__componentOriginal3b0e04e43cf890250cc4d85cff4d94af = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3b0e04e43cf890250cc4d85cff4d94af = $attributes; } ?>
...
<?php endif; ?>
                            ...
                            <!--[if BLOCK]><![endif]--><?php if($paymentGateway->paypal_status): ?>
                            <?php if (isset($component)) { $__componentOriginal3b0e04e43cf890250cc4d85cff4d94af = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3b0e04e43cf890250cc4d85cff4d94af = $attributes; } ?>
...
<?php endif; ?>
                            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                             ...
                             <!--[if BLOCK]><![endif]--><?php if($paymentGateway->payfast_status): ?>
                                <?php if (isset($component)) { $__componentOriginal3b0e04e43cf890250cc4d85cff4d94af = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3b0e04e43cf890250cc4d85cff4d94af = $attributes; } ?>
...
<?php endif; ?>
                        ...
                        <!--[if BLOCK]><![endif]--><?php if($paymentGateway->paystack_status): ?>
                            <?php if (isset($component)) { $__componentOriginal3b0e04e43cf890250cc4d85cff4d94af = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3b0e04e43cf890250cc4d85cff4d94af = $attributes; } ?>
...
<?php endif; ?>
                        ...
                        <!--[if BLOCK]><![endif]--><?php if($paymentGateway->xendit_status): ?>
                            <?php if (isset($component)) { $__componentOriginal3b0e04e43cf890250cc4d85cff4d94af = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3b0e04e43cf890250cc4d85cff4d94af = $attributes; } ?>
...
<?php endif; ?>
                        ...
                        <!--[if BLOCK]><![endif]--><?php if($paymentGateway->epay_status): ?>
                            <?php if (isset($component)) { $__componentOriginal3b0e04e43cf890250cc4d85cff4d94af = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3b0e04e43cf890250cc4d85cff4d94af = $attributes; } ?>
...
<?php endif; ?>
                        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                            ...
                            <!--[if BLOCK]><![endif]--><?php if($paymentGateway->is_qr_payment_enabled && $paymentGateway->qr_code_image_url): ?>
                                <!-- Button -->
                                <?php if (isset($component)) { $__componentOriginal3b0e04e43cf890250cc4d85cff4d94af = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3b0e04e43cf890250cc4d85cff4d94af = $attributes; } ?>
...
<?php endif; ?>
                            ...
                            <!--[if BLOCK]><![endif]--><?php if($paymentGateway->is_offline_payment_enabled && $paymentGateway->offline_payment_detail): ?>
                                <!-- Button -->
                                <?php if (isset($component)) { $__componentOriginal3b0e04e43cf890250cc4d85cff4d94af = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3b0e04e43cf890250cc4d85cff4d94af = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.secondary-button','data' => ['wire:click' => 'togglePaymentDetail']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('secondary-button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:click' => 'togglePaymentDetail']); ?>
                                    <span class="inline-flex items-center">
...
<?php endif; ?>
                            ...
                            <!--[if BLOCK]><![endif]--><?php if($paymentGateway->is_cash_payment_enabled): ?>
                            <?php if (isset($component)) { $__componentOriginal3b0e04e43cf890250cc4d85cff4d94af = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3b0e04e43cf890250cc4d85cff4d94af = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.secondary-button','data' => ['wire:click' => 'makePayment('.e($paymentOrder->id).', \'cash\')']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('secondary-button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:click' => 'makePayment('.e($paymentOrder->id).', \'cash\')']); ?>
                                <span class="inline-flex items-center">
             ...
             <?php $__env->slot('content', null, []); ?> 
                ...
                <div class="p-4 mb-6 rounded-lg bg-gray-50 dark:bg-gray-700">
                    <div class="flex justify-between mb-2">
                        ...
                        <span class="font-medium"><?php echo currency_format($order->total - $order->tip_amount, $restaurant->currency_id); ?></span>
                    </div>
                    <div class="flex justify-between text-[var(--brand-primary)]">
                        <span><?php echo app('translator')->get('modules.order.tipAmount'); ?></span>
                        <span class="font-medium">+ <?php echo currency_format($tipAmount ?? 0, $restaurant->currency_id); ?></span>
                    </div>
                    <div class="pt-2 mt-2 border-t border-gray-200 dark:border-gray-800">
                        <div class="flex justify-between">
                            ...
                            <span class="text-lg font-bold">
                                <?php echo currency_format(($order->total - $order->tip_amount + ($tipAmount ?: 0)), $restaurant->currency_id); ?>
...
<?php endif; ?>
                    <div class="grid grid-cols-4 gap-3">
                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = [5, 10, 15, 20]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $percentage): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php
                            ...
                            <button type="button"
                                ...
                                class="relative px-4 py-3 text-sm font-medium rounded-xl border-2
                                    <?php echo e($tipAmount == $calculatedTip
                                        ...
                                        : 'border-gray-200 dark:border-gray-600 hover:border-[var(--brand-primary)] hover:bg-[var(--brand-primary)]/5'); ?>"
                            >
                                <div class="font-bold"><?php echo e($percentage); ?>%</div>
                                <div class="text-xs text-gray-500 break-words dark:text-gray-400">
                                    <?php echo currency_format($calculatedTip, $restaurant->currency_id); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.textarea','data' => ['id' => 'tipNote','dataGramm' => 'false','class' => 'block w-full rounded-xl','wire:model' => 'tipNote','placeholder' => ''.e(__('placeholders.addNotePlaceholder')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'tipNote','data-gramm' => 'false','class' => 'block w-full rounded-xl','wire:model' => 'tipNote','placeholder' => ''.e(__('placeholders.addNotePlaceholder')).'']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
                    ...
                    function payViaEpay(payment) {
                        ...
                        try {
                            ...
                            if (paymentData.order?.customer) {
                                ...
                                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                <!--[if BLOCK]><![endif]--><?php if($customer->name): ?>
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\xampp\htdocs\script\resources\views/livewire/shop/order-detail.blade.php ENDPATH**/ ?>