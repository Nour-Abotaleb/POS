...
$__html = app('livewire')->mount($__name, $__params, 'lw-761776794-0', $__slots ?? [], get_defined_vars());
...
<?php $component->withAttributes(['wire:model.live' => 'showVariationModal','maxWidth' => 'xl']); ?>
             ...
             <?php $__env->slot('content', null, []); ?> 
                <?php if($showVariationModal && $menuItem): ?>
                <?php
$__split = function ($name, $params = []) {
    return [$name, $params];
};
...
$__html = app('livewire')->mount($__name, $__params, 'lw-761776794-1', $__slots ?? [], get_defined_vars());
...
<?php $component->withAttributes(['wire:model.live' => 'showModifiersModal','maxWidth' => 'xl']); ?>
             ...
             <?php $__env->slot('content', null, []); ?> 
                <?php if($showModifiersModal && $selectedModifierItem): ?>
                    <?php
$__split = function ($name, $params = []) {
    return [$name, $params];
};
