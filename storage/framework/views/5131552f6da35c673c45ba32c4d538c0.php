                ...
                <div class="flex flex-wrap justify-between items-center mx-auto">
                    ...
                    <div class="hidden justify-between items-center w-full bg-gray-50 dark:bg-gray-700 mt-4 rounded-md"
                        ...
                        <ul class="flex flex-col font-medium ">
                            ...
                            <?php $__currentLoopData = $customMenu; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if($menu->is_active && $menu->position == 'header'): ?>
                                    <li>
        ...
        <div class="mx-auto max-w-screen-xl">
            <div class="sm:flex sm:items-center sm:justify-between flex-wrap gap-4">
                ...
                <ul class="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0 rtl:space-x-reverse">
                    <?php $__currentLoopData = $customMenu; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if($menu->is_active && $menu->position == 'footer'): ?>
                            <li>
                                <a href="<?php echo e(route('customMenu', ['slug' => $menu->menu_slug])); ?>" class="<?php echo \Illuminate\Support\Arr::toCssClasses([
                                    'transition-all duration-300 block py-2 pr-4 pl-3 rounded lg:bg-transparent lg:p-0 text-gray-700 dark:text-white',
                                ]); ?>"
...
$__html = app('livewire')->mount($__name, $__params, 'lw-3751523723-0', $__slots ?? [], get_defined_vars());
...
?>
                    ...
                    <?php if(global_setting()->facebook_link): ?>
                    ...
                    <?php if(global_setting()->instagram_link): ?>
                    ...
                    <?php if(global_setting()->twitter_link): ?>
                    ...
                    <?php if(global_setting()->yelp_link): ?>
...
<?php /**PATH C:\xampp\htdocs\script\resources\views/layouts/landing.blade.php ENDPATH**/ ?>