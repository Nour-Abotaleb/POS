<div>
    <!--[if BLOCK]><![endif]--><?php if(!$restaurant->enable_customer_reservation): ?>
    ...
    <section class="bg-white dark:bg-gray-900 hidden lg:block px-4">
        <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12 bg-[var(--brand-primary)]/10 dark:bg-gray-800 rounded-lg">
    ...
    <div class="space-y-8 max-w-4xl mx-auto lg:mt-20 p-4">
        ...
        <div class="grid lg:grid-cols-3 lg:gap-6 gap-4">
            ...
            <div class="relative">
                ...
                <div wire:key='reservation-date-1' id="dropdownHover1" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-full dark:bg-gray-700 max-w-60">
                    <ul class="py-2 text-gray-700 dark:text-gray-200" aria-labelledby="dropdownHoverButton1">
                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $period; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dateObj): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php
                            ...
                            <li>
                                <a href="javascript:;"
                                    wire:click="setReservationDate('<?php echo e($dateStr); ?>')"
                                    class="<?php echo \Illuminate\Support\Arr::toCssClasses([
                                        ...
                                        <?php echo e($dateObj->translatedFormat('d M, l')); ?>
            ...
            <div class="relative">
                ...
                <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['numberOfGuests'];
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
            ...
            <div class="relative">
                ...
                <div wire:key='reservation-date-3' id="dropdownHover3" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-full dark:bg-gray-700 max-w-60">
                    <ul class="py-2 text-gray-700 dark:text-gray-200 max-h-72 overflow-auto" aria-labelledby="dropdownHoverButton3">
                        ...
                        ?>
                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $slotTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php
        ...
        <div class="relative">
            ...
            <div wire:loading.class="opacity-50 pointer-events-none" class="mt-2 space-y-2">
                <!--[if BLOCK]><![endif]--><?php if(empty($timeSlots) || !$this->isSlotTypeAvailable()): ?>
...
<?php endif; ?>
                    ...
                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $timeSlots; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $timeSlot): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <li wire:key="timeSlot.<?php echo e($loop->index); ?>">
                            ...
                            <label for="timeSlot<?php echo e($loop->index); ?>"
                                class="<?php echo \Illuminate\Support\Arr::toCssClasses([
                                    'inline-flex items-center justify-center w-full p-3 text-gray-500 bg-white border border-gray-200 rounded-lg dark:border-gray-700 dark:peer-checked:text-[var(--brand-primary)] peer-checked:border-[var(--brand-primary)] peer-checked:text-[var(--brand-primary)] dark:text-gray-400 dark:bg-gray-800 transition-all duration-200',
                ...
                <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['availableTimeSlots'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['type' => 'button','wire:click' => '$dispatch(\'showSignup\')','class' => 'w-full md:w-auto inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-white rounded-lg hover:opacity-90 focus:ring-4 focus:ring-[var(--brand-primary)]/30 transition-all duration-200','style' => 'background-color: var(--brand-primary);']); ?>
...
<?php $component->withAttributes(['type' => 'button','wire:click' => 'submitReservation','wire:loading.attr' => 'disabled','class' => 'w-full md:w-auto inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-white rounded-lg hover:opacity-90 focus:ring-4 focus:ring-[var(--brand-primary)]/30 transition-all duration-200','style' => 'background-color: var(--brand-primary);']); ?>
                        ...
                        <svg wire:loading.remove wire:target="submitReservation" class="w-4 h-4 me-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
...
<?php /**PATH C:\xampp\htdocs\script\resources\views/livewire/shop/book-a-table.blade.php ENDPATH**/ ?>