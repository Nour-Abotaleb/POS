...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'showLogoText','id' => 'showLogoText','wire:model' => 'showLogoText']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
            ...
            <div class="p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                <div class="flex items-center justify-between">
                    <div class="flex items-center space-x-3">
                        <?php if (isset($component)) { $__componentOriginal74b62b190a03153f11871f645315f4de = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal74b62b190a03153f11871f645315f4de = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.checkbox','data' => ['name' => 'pwaAlertShow','id' => 'pwaAlertShow','wire:model' => 'pwaAlertShow']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('checkbox'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'pwaAlertShow','id' => 'pwaAlertShow','wire:model' => 'pwaAlertShow']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal74b62b190a03153f11871f645315f4de)): ?>
<?php $attributes = $__attributesOriginal74b62b190a03153f11871f645315f4de; ?>
...
<?php endif; ?>
    ...
    <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-3">
        <?php $__currentLoopData = ['upload_fav_icon_android_chrome_192', 'upload_fav_icon_android_chrome_512', 'upload_fav_icon_apple_touch_icon', 'upload_favicon_16', 'upload_favicon_32', 'favicon']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="flex flex-col items-center space-y-2">
                    ...
                    <div class="text-center w-full">
                        ...
                        <input type="file" id="<?php echo e($name); ?>" class="hidden"
                            ...
                            wire:model="<?php echo e($name); ?>" x-ref="<?php echo e($name); ?>"
                            x-on:change="
                                const reader = new FileReader();
                                reader.onload = (e) => {
                ...
                <div class="mt-4 space-y-6">
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="flex flex-wrap gap-2">
                            <?php $__currentLoopData = ['#2563EB', '#059669', '#7C3AED', '#0891B2', '#EA580C', '#4F46E5', '#0D9488', '#9333EA']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $color): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="flex flex-wrap gap-2">
                            <?php $__currentLoopData = ['#93C5FD', '#86EFAC', '#FDE68A', '#FDBA74', '#DDD6FE', '#99F6E4', '#FCA5A5', '#A5B4FC']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $color): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <button type="button" wire:click="$set('themeColor', '<?php echo e($color); ?>')"
                                    class="w-8 h-8 rounded-full border-2 border-white dark:border-gray-700 shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-100 dark:focus:ring-offset-gray-800 hover:scale-110 transition-transform"
                                    style="background-color: <?php echo e($color); ?>" title="<?php echo e($color); ?>">
                                </button>
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="flex flex-wrap gap-2">
                            <?php $__currentLoopData = ['#F97316', '#DC2626', '#D946EF', '#EC4899', '#F43F5E', '#FB923C', '#E11D48', '#F59E0B']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $color): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <button type="button" wire:click="$set('themeColor', '<?php echo e($color); ?>')"
                                    class="w-8 h-8 rounded-full border-2 border-white dark:border-gray-700 shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-100 dark:focus:ring-offset-gray-800 hover:scale-110 transition-transform"
                                    style="background-color: <?php echo e($color); ?>" title="<?php echo e($color); ?>">
                                </button>
...
<?php /**PATH C:\xampp\htdocs\script\resources\views\livewire\settings\superadmin-theme-settings.blade.php ENDPATH**/ ?>