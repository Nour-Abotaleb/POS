...
<div class="payment_methods">
    ...
    <?php if($showOnline && $paymentGatewayActive): ?>
        <div class="grid items-baseline grid-cols-1 gap-4 space-y-4 md:grid-cols-3">
            ...
            <?php endif; ?>
            <?php if($stripeSettings->razorpay_status === 1): ?>
            ...
            <?php endif; ?>
            <?php if($stripeSettings->flutterwave_status === 1): ?>
            ...
            <?php endif; ?>
            <?php if($stripeSettings->paypal_status === 1): ?>
            ...
            <?php endif; ?>
            <?php if($stripeSettings->payfast_status === 1): ?>
            ...
            <?php endif; ?>
            <?php if($stripeSettings->paystack_status === 1): ?>
            ...
            <?php endif; ?>
            <?php if($stripeSettings->xendit_status === 1): ?>
            ...
            <?php endif; ?>
            <?php if($stripeSettings->paddle_status === 1): ?>
                <button
            ...
            <?php if($offlinePaymentGateways > 0): ?>
    ...
    <?php if(!$showOnline && $offlinePaymentGateways > 0): ?>
        <?php if($paymentGatewayActive): ?>
