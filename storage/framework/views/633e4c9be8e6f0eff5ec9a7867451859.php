            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        ...
                        <?php if(config(strtolower($universalBundle->getName()) . '.setting')): ?>
                ...
                <!-- Toggle Switch -->
                <?php if(!config(strtolower($universalBundle->getName()) . '.name')): ?>
                ...
                <?php if($fetchSetting): ?>
                    <div class="flex flex-col sm:flex-row items-stretch sm:items-center gap-2">
                        <?php if(config(strtolower($universalBundle->getName()) . '.verification_required')): ?>
                        ...
                        <?php if($plugins->where('envato_id', config(strtolower($universalBundle->getName()) . '.envato_item_id'))->first()): ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\script\resources\views\custom-modules\sections\universal-bundle.blade.php ENDPATH**/ ?>