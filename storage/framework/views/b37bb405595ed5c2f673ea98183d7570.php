        ...
        <div class="w-full mb-4">
            <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white flex justify-between items-center">
                <div class="flex items-center gap-2">
                    <!--[if BLOCK]><![endif]--><?php if($showAllKitchens): ?>
                ...
                <!--[if BLOCK]><![endif]--><?php if(!$showAllKitchens && $kotPlace && $kotPlace->printerSetting): ?>
...
<?php endif; ?>
                            ...
                            <?php if (isset($component)) { $__componentOriginaled2cde6083938c436304f332ba96bb7c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginaled2cde6083938c436304f332ba96bb7c = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.select','data' => ['id' => 'dateRangeType','class' => 'w-full md:w-48','wire:model' => 'dateRangeType','wire:change' => 'setDateRange']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('select'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'dateRangeType','class' => 'w-full md:w-48','wire:model' => 'dateRangeType','wire:change' => 'setDateRange']); ?>
...
<?php endif; ?>
            ...
            <div class="<?php echo \Illuminate\Support\Arr::toCssClasses([
                ...
                <!--[if BLOCK]><![endif]--><?php if($kotSettings->default_status == 'pending'): ?>
                    <div wire:click="$set('filterOrders', 'pending_confirmation')"
                        style="<?php echo e($filterOrders == 'pending_confirmation' ? 'border: 2px solid #011646;' : ''); ?>"
                ...
                <div wire:click="$set('filterOrders', 'in_kitchen')"
                    style="<?php echo e($filterOrders == 'in_kitchen' ? 'border: 2px solid #011646;' : ''); ?>"
                    class="<?php echo \Illuminate\Support\Arr::toCssClasses([
                    'whitespace-nowrap items-center font-medium
                                                    cursor-pointer p-2 text-center rounded-md text-sm border hover:text-gray-900 bg-white
                ...
                <div wire:click="$set('filterOrders', 'food_ready')"
                    style="<?php echo e($filterOrders == 'food_ready' ? 'border: 2px solid #011646;' : ''); ?>"
                    class="<?php echo \Illuminate\Support\Arr::toCssClasses([
                    'whitespace-nowrap items-center font-medium
                                                    cursor-pointer p-2 text-center rounded-md text-sm border hover:text-gray-900 bg-white
                                                    hover:bg-gray-200 w-full dark:bg-gray-800 dark:hover:bg-gray-700
                ...
                <div wire:click="$set('filterOrders', 'cancelled')"
                    style="<?php echo e($filterOrders == 'cancelled' ? 'border: 2px solid #011646;' : ''); ?>"
                    class="<?php echo \Illuminate\Support\Arr::toCssClasses([
                    'whitespace-nowrap items-center font-medium
                                                    cursor-pointer p-2 text-center rounded-md text-sm border hover:text-gray-900 bg-white
                                                    hover:bg-gray-200 w-full dark:bg-gray-800 dark:hover:bg-gray-700
        ...
        <div class="flex flex-col my-4">
            ...
            <div class="space-y-4">
                <div class="grid sm:grid-cols-3 2xl:grid-cols-4 gap-3 sm:gap-4" wire:key="kots-grid" wire:loading.class.delay="opacity-50">
                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $kots; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php
...
$__html = app('livewire')->mount($__name, $__params, 'kot-' . $item->id, $__slots ?? [], get_defined_vars());
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.confirmation-modal','data' => ['wire:model' => 'confirmDeleteKotModal']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:model' => 'confirmDeleteKotModal']); ?>
...
<?php endif; ?>
        ...
        <?php if (isset($component)) { $__componentOriginal5b8b2d0f151a30be878e1a760ec3900c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal5b8b2d0f151a30be878e1a760ec3900c = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.confirmation-modal','data' => ['wire:model' => 'confirmDeleteKotItemModal','maxWidth' => 'xl']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('confirmation-modal'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:model' => 'confirmDeleteKotItemModal','max-width' => 'xl']); ?>

             <?php $__env->slot('title', null, []); ?> 
                <div>
                    <h3 class="text-xl font-bold text-gray-900 dark:text-white">
                        <?php echo app('translator')->get('modules.order.cancelKotItem'); ?>
                        <!--[if BLOCK]><![endif]--><?php if($this->selectedKotItem): ?>
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\xampp\htdocs\script\resources\views/livewire/kot/kots.blade.php ENDPATH**/ ?>