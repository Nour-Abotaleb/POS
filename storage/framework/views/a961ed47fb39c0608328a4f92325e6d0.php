...
<?php endif; ?>
                <div class="space-y-3">
                    <label class="flex items-center">
                        <input type="checkbox" wire:model="cancel_order" class="w-4 h-4 bg-gray-100 rounded border-gray-300 text-skin-base focus:ring-skin-base dark:focus:ring-skin-base dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" <?php if($cancel_order): echo 'checked'; endif; ?>>
                    ...
                    <label class="flex items-center">
                        <input type="checkbox" wire:model="cancel_kot" class="w-4 h-4 bg-gray-100 rounded border-gray-300 text-skin-base focus:ring-skin-base dark:focus:ring-skin-base dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" <?php if($cancel_kot): echo 'checked'; endif; ?>>
...
<?php /**PATH C:\xampp\htdocs\script\resources\views\livewire\forms\edit-kot-cancel-reason.blade.php ENDPATH**/ ?>