...
<?php endif; ?>
                ...
                <?php if(user_can('Create Expense')): ?>
                                    ...
                                    <?php $__currentLoopData = $expenseCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $expenseCategory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                            ...
                                            <td class="py-2.5 px-4 space-x-2 text-end">
                                                ...
                                                <?php if(user_can('Update Expense Category')): ?>
...
<?php endif; ?>
                                                <?php endif; ?>
                                                <?php if(user_can('Delete Expense Category')): ?>
...
$__html = app('livewire')->mount($__name, $__params, 'lw-570043713-0', $__slots ?? [], get_defined_vars());
