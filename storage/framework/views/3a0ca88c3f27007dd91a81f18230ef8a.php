         ...
         <?php $__env->slot('title', null, []); ?> 
            ...
            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2 sm:gap-0">
                ...
                <div class="flex items-center gap-2 sm:gap-4 mt-2 sm:mt-0">
                    ...
                    <span class="text-lg sm:text-xl font-bold text-skin-base"><?php echo currency_format($order->total, restaurant()->currency_id); ?></span>
                </div>
            </div>
                    ...
                    <div class="w-full md:flex-1">
                        ...
                        <div class="<?php echo \Illuminate\Support\Arr::toCssClasses([
                            ...
                            <button wire:click="addTipModal"
                                ...
                                <!--[if BLOCK]><![endif]--><?php if($order && $order->tip_amount > 0): ?>
                                    <div class="text-sm">
                                        <span class="font-medium text-green-600 dark:text-green-400"><?php echo app('translator')->get('modules.order.tipAdded'); ?></span>
                                        <span class="block text-green-500 dark:text-green-300"><?php echo currency_format($order->tip_amount, restaurant()->currency_id); ?></span>
                                    </div>
                                <?php else: ?>
                        ...
                        <div class="mt-4 space-y-4">
                            ...
                            <div class="hidden">
                                ...
                                <div class="w-full text-2xl p-3 rounded-lg border-gray-300 bg-gray-100 ">
                                    <?php echo currency_format($returnAmount, restaurant()->currency_id); ?>
                                        ...
                                        <div x-data="{ showTipBreakdown: false }" class="space-y-2">
                                            ...
                                            <div x-show="showTipBreakdown"  x-cloak
                                                ...
                                                <div class="flex justify-between text-gray-600 dark:text-gray-300">
                                                    ...
                                                    <span><?php echo currency_format($order->total - $order->tip_amount, restaurant()->currency_id); ?></span>
                                                </div>
                                                <div class="flex justify-between text-green-600 dark:text-green-400">
                                                    <span><?php echo e(__('modules.order.tipAmount')); ?></span>
                                                    <span>+ <?php echo currency_format($order->tip_amount, restaurant()->currency_id); ?></span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="flex justify-between items-center cursor-pointer text-gray-800 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 rounded"
                                                ...
                                                <span class="font-medium"><?php echo currency_format($order->total, restaurant()->currency_id); ?></span>
                                            </div>
                                        </div>
                                        <?php else: ?>
                    ...
                    <div class="w-full md:w-72">
                        ...
                        <div class="grid grid-cols-2 gap-2 mb-3">
                            ...
                            <button wire:click="quickAmount(<?php echo e($amount); ?>)" class="p-2 text-center border rounded-lg hover:bg-gray-50 w-full text-sm sm:text-base">
                                <span class="font-medium"><?php echo currency_format($amount, restaurant()->currency_id); ?></span>
                            </button>
                ...
                <div x-show="showSplitOptions"
                    ...
                    <div class="flex-1 overflow-y-auto my-4">
                        ...
                        <div x-show="splitType === 'equal'" class="h-full flex flex-col">
                            <div class="flex flex-col sm:flex-row items-start sm:items-center gap-2 border-b pb-4">
                                <div class="flex flex-wrap gap-2 flex-1">
                                    <!--[if BLOCK]><![endif]--><?php for($i = 1; $i <= $numberOfSplits; $i++): ?>
                                        <div class="flex items-center gap-1">
                                            <div class="px-4 py-2 rounded-lg text-sm border">
                                                <span>Split <?php echo e($i); ?></span>
                                            </div>
                                            <!--[if BLOCK]><![endif]--><?php if($numberOfSplits > 2): ?>
                        ...
                        <div x-show="splitType === 'custom'" class="h-full flex flex-col">
                            <div class="flex flex-col sm:flex-row items-start sm:items-center gap-2 border-b pb-4">
                                <div class="flex flex-wrap gap-2 flex-1">
                                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $customSplits; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $splitNumber): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="flex items-center gap-1">
                                            <div class="px-4 py-2 rounded-lg text-sm border">
                                                <span>Split <?php echo e($splitNumber); ?></span>
                                            </div>
                                            <!--[if BLOCK]><![endif]--><?php if(count($customSplits) > 2): ?>
                        ...
                        <div x-show="splitType === 'items'" class="space-y-6">
                            ...
                            <div class="flex flex-col sm:flex-row items-start sm:items-center gap-2 border-b pb-4">
                                <div class="flex flex-wrap gap-2 flex-1">
                                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $splits; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $splitId => $split): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="flex items-center gap-1">
                                            ...
                                            <!--[if BLOCK]><![endif]--><?php if(count($splits) > 1 && $splitId !== 1): ?>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div class="space-y-3">
                                    ...
                                    <div class="space-y-2 max-h-[300px] sm:max-h-[400px] overflow-y-auto">
                                        <?php $__currentLoopData = $availableItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <!--[if BLOCK]><![endif]--><?php if($item['remaining'] > 0): ?>
                                            <div class="p-3 border rounded-lg hover:bg-gray-50 dark:hover:bg-gray-600 flex justify-between items-center">
                                                <div>
                                                    ...
                                                    <div class="text-xs text-gray-500 dark:text-gray-400">
                                                        ...
                                                        <span><?php echo e(__('modules.order.base')); ?>: <?php echo currency_format($item['base_price'], restaurant()->currency_id); ?></span>
                                                        <!--[if BLOCK]><![endif]--><?php if($item['discount'] > 0): ?>
                                                            <span>- <?php echo e(__('modules.order.discount')); ?>: <?php echo currency_format($item['discount'], restaurant()->currency_id); ?></span>
                                                        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                                        <!--[if BLOCK]><![endif]--><?php if($item['tax_amount'] > 0): ?>
                                                            <span>+ <?php echo e(__('modules.order.tax')); ?>: <?php echo currency_format($item['tax_amount'], restaurant()->currency_id); ?></span>
                                                        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                                        <!--[if BLOCK]><![endif]--><?php if($item['extra_charges'] > 0): ?>
                                                            <span>+ <?php echo e(__('modules.order.extraCharges')); ?>: <?php echo currency_format($item['extra_charges'], restaurant()->currency_id); ?></span>
                                                        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                                        <!--[if BLOCK]><![endif]--><?php if($item['tip'] > 0): ?>
                                                            <span>+ <?php echo e(__('modules.order.tipAmount')); ?>: <?php echo currency_format($item['tip'], restaurant()->currency_id); ?></span>
                                                        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                                        )
                                                    </div>
                                                </div>
                                                ...
                                                <div class="text-right ml-4">
                                                    <span class="font-semibold text-base dark:text-gray-300">
                                                        <?php echo currency_format($item['price'] * $item['remaining'], restaurant()->currency_id); ?>
                                ...
                                <div class="space-y-3">
                                        ...
                                        <div class="flex-1 flex justify-between items-center text-gray-500 dark:text-gray-300">
                                            ...
                                            <div class="text-sm">
                                                <span class="font-semibold">
                                                    <?php echo e(__('modules.order.total')); ?>: <?php echo currency_format(($splits[$activeSplitId]['total'] ?? 0), restaurant()->currency_id); ?>

                                                </span>
                                                <!--[if BLOCK]><![endif]--><?php if(restaurant()->tax_mode === 'item' && isset($splits[$activeSplitId]['tax_total']) && $splits[$activeSplitId]['tax_total'] > 0): ?>
                                                    <span class="text-xs text-gray-500 dark:text-gray-400 ml-2">
                                                        (<?php echo e(__('modules.order.tax')); ?>: <?php echo currency_format($splits[$activeSplitId]['tax_total'], restaurant()->currency_id); ?>)
                                                    </span>
                                                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                            </div>
                                        </div>
                                    ...
                                    <div class="space-y-2 max-h-[300px] sm:max-h-[400px] overflow-y-auto">
                                        <!--[if BLOCK]><![endif]--><?php if(empty($splits[$activeSplitId]['items'])): ?>
                                        ...
                                        <?php else: ?>
                                            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $splits[$activeSplitId]['items']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="p-3 border rounded-lg hover:bg-gray-50 dark:hover:bg-gray-600">
                                                <div class="flex justify-between items-center font">
                                                    ...
                                                    <div class="text-right">
                                                        <span class="font-semibold text-base dark:text-gray-300">
                                                            <?php echo currency_format($item['price'] * $item['quantity'], restaurant()->currency_id); ?>
                                ...
                                <div class="space-y-2">
                                    ...
                                    <template x-if="splitType === 'equal'">
                                        <div class="flex justify-between text-blue-600 dark:text-blue-400 pt-2 border-t">
                                            ...
                                            <span class="font-medium"><?php echo currency_format(($order->total - $paidAmount) / $numberOfSplits, restaurant()->currency_id); ?></span>
                                        </div>
                                    </template>
                                    ...
                                    <template x-if="splitType === 'custom'">
                                        <div>
                                            <div class="flex justify-between text-blue-600 dark:text-blue-400 pt-2 border-t">
                                                ...
                                                <span class="font-medium"><?php echo currency_format(collect($splits)->sum(function($split) { return (float)($split['amount'] ?? 0); }), restaurant()->currency_id); ?></span>
                                            </div>
                                            <!--[if BLOCK]><![endif]--><?php if(($balanceAmount > 0 || $returnAmount > 0)): ?>
                                                <div class="<?php echo \Illuminate\Support\Arr::toCssClasses([
                                                    ...
                                                    <span class="font-medium"><?php echo currency_format($balanceAmount > 0 ? $balanceAmount : $returnAmount, restaurant()->currency_id); ?></span>
                                                </div>
                                            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                        </div>
                                    </template>
                                    ...
                                    <template x-if="splitType === 'items'">
                                        <div>
                                            <div class="flex justify-between text-blue-600 dark:text-blue-400 pt-2 border-t">
                                                <span><?php echo e(__('modules.order.splitTotal')); ?></span>
                                                <span class="font-medium"><?php echo currency_format(collect($splits)->sum('total'), restaurant()->currency_id); ?></span>
                                            </div>
                                            <div class="flex justify-between text-orange-600 dark:text-orange-400">
                                                <span><?php echo e(__('modules.order.remainingAmount')); ?></span>
                                                <span class="font-medium"><?php echo currency_format(($order->total - $paidAmount - collect($splits)->sum('total')), restaurant()->currency_id); ?></span>
                                            </div>
                                        </div>
                                    </template>
                                </div>
...
<?php endif; ?>
<?php $component->withAttributes(['wire:click' => 'submitForm','class' => 'flex-1 px-6 py-3 text-base font-medium bg-skin-base text-white rounded-lg hover:bg-skin-base/90']); ?>
...
<?php endif; ?>
                ...
                <div class="grid grid-cols-4 gap-2 mb-4">
                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = [5, 10, 15, 20]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <button wire:click="setTip('<?php echo e($tipMode); ?>', <?php echo e($value); ?>)"
                            ...
                            <div class="px-3 py-3 text-sm rounded-lg border transition-all duration-200
                                ...
                                <span class="block font-medium text-base">
                                    <!--[if BLOCK]><![endif]--><?php if($tipMode === 'percentage'): ?>
                                        <?php echo e($value); ?>%
                                    <?php else: ?>
                                        <?php echo currency_format($value, restaurant()->currency_id); ?>
                                ...
                                <div class="absolute inset-x-0 -bottom-6 group-hover:bottom-0 transition-all duration-200 text-xs bg-gray-100 dark:bg-gray-700 dark:text-white py-1">
                                    <!--[if BLOCK]><![endif]--><?php if($tipMode === 'percentage'): ?>
                                        <?php echo currency_format($order->total * $value / 100, restaurant()->currency_id); ?>
...
<?php /**PATH C:\xampp\htdocs\script\resources\views/livewire/order/add-payment.blade.php ENDPATH**/ ?>