        ...
        <div
            ...
            <div class="flow-root">
                ...
                <div class="divide-y divide-gray-200 dark:divide-gray-700">
                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $notificationSettings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <!-- Item 1 -->
                    <div class="flex items-center justify-between py-4">
                        <div class="flex flex-col flex-grow">
                            <div class="text-lg font-semibold text-gray-900 dark:text-white">
                                <!--[if BLOCK]><![endif]--><?php if(\Lang::has('multipos::app.notifications.' . $item->type)): ?>
                            ...
                            <div class="text-base font-normal text-gray-500 dark:text-gray-400">
                                <!--[if BLOCK]><![endif]--><?php if(\Lang::has('multipos::app.notifications.' . $item->type . '_info')): ?>
...
</div><?php /**PATH C:\xampp\htdocs\script\resources\views/livewire/settings/notification-settings.blade.php ENDPATH**/ ?>