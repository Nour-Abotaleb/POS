        ...
        <div class="relative flex flex-col flex-1 min-h-0 pt-0 bg-gray-50 ltr:border-r rtl:border-l border-gray-200 dark:bg-gray-800 dark:border-gray-700">
            <div class="flex flex-col flex-1 pt-5 pb-4 overflow-y-auto mb-16 [&::-webkit-scrollbar]:w-1.5
                ...
                <div class="flex-1 px-3 space-y-1 bg-gray-50 divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                    ...
                    <?php if(user()->hasRole('Admin_'.user()->restaurant_id)): ?>
                        <?php
...
$__html = app('livewire')->mount($__name, $__params, 'lw-191613972-0', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'lw-191613972-1', $__slots ?? [], get_defined_vars());
...
?>
                        ...
                        <?php if($this->hasModule('Menu') || $this->hasModule('Menu Item') || $this->hasModule('Item Category')): ?>
                            <?php if(user_can('Show Menu') || user_can('Show Menu Item') || user_can('Show Item Category')): ?>
...
<?php $component->withAttributes([]); ?>
                                    <?php if($this->hasModule('Menu')): ?>
                                        <?php if(user_can('Show Menu')): ?>
                                            <?php
$__split = function ($name, $params = []) {
    return [$name, $params];
};
...
$__html = app('livewire')->mount($__name, $__params, 'lw-191613972-2', $__slots ?? [], get_defined_vars());
...
?>
                                    ...
                                    <?php if($this->hasModule('Menu Item')): ?>
                                        <?php if(user_can('Show Menu Item')): ?>
                                            <?php
$__split = function ($name, $params = []) {
    return [$name, $params];
};
...
$__html = app('livewire')->mount($__name, $__params, 'lw-191613972-3', $__slots ?? [], get_defined_vars());
...
?>
                                    ...
                                    <?php if($this->hasModule('Item Category')): ?>
                                        <?php if(user_can('Show Item Category')): ?>
                                            <?php
$__split = function ($name, $params = []) {
    return [$name, $params];
};
...
$__html = app('livewire')->mount($__name, $__params, 'lw-191613972-4', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'lw-191613972-5', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'lw-191613972-6', $__slots ?? [], get_defined_vars());
...
<?php endif; ?>
                        ...
                        <?php if($this->hasModule('Area') || $this->hasModule('Table')): ?>
                            <?php if(user_can('Show Area') || user_can('Show Table')): ?>
                                <?php if (isset($component)) { $__componentOriginaleeb5c1102f81a48057b5d734c9cff39b = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginaleeb5c1102f81a48057b5d734c9cff39b = $attributes; } ?>
...
$__html = app('livewire')->mount($__name, $__params, 'lw-191613972-7', $__slots ?? [], get_defined_vars());
...
?>
                                    ...
                                    <?php if($this->hasModule('Table')): ?>
                                        <?php if(user_can('Show Table')): ?>
                                            <?php
$__split = function ($name, $params = []) {
    return [$name, $params];
};
...
$__html = app('livewire')->mount($__name, $__params, 'lw-191613972-8', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'lw-191613972-9', $__slots ?? [], get_defined_vars());
...
<?php endif; ?>
                        ...
                        <?php if($this->hasModule('Waiter Request') && user_can('Manage Waiter Request')): ?>
                            <?php
$__split = function ($name, $params = []) {
    return [$name, $params];
};
...
$__html = app('livewire')->mount($__name, $__params, 'lw-191613972-10', $__slots ?? [], get_defined_vars());
...
?>
                        ...
                        <?php if($this->hasModule('Reservation') && user_can('Show Reservation')): ?>
                            <?php
$__split = function ($name, $params = []) {
    return [$name, $params];
};
...
$__html = app('livewire')->mount($__name, $__params, 'lw-191613972-11', $__slots ?? [], get_defined_vars());
...
?>
                        ...
                        <?php if($this->hasModule('Order') && user_can('Create Order')): ?>
                            <?php
$__split = function ($name, $params = []) {
    return [$name, $params];
};
...
$__html = app('livewire')->mount($__name, $__params, 'lw-191613972-12', $__slots ?? [], get_defined_vars());
...
?>
                        ...
                        <?php if($this->hasModule('Kitchen') && in_array('kitchen', custom_module_plugins())): ?>
...
$__html = app('livewire')->mount($__name, $__params, 'lw-191613972-13', $__slots ?? [], get_defined_vars());
...
?>
                        ...
                        <?php else: ?>
                            <?php if($this->hasModule('Order') || $this->hasModule('KOT')): ?>
                                <?php if(user_can('Show Order') || user_can('Manage KOT')): ?>
                                    <?php if (isset($component)) { $__componentOriginaleeb5c1102f81a48057b5d734c9cff39b = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginaleeb5c1102f81a48057b5d734c9cff39b = $attributes; } ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                                        <?php if($this->hasModule('KOT')): ?>
                                            <?php if(user_can('Manage KOT')): ?>
                                                <?php
$__split = function ($name, $params = []) {
    return [$name, $params];
};
...
$__html = app('livewire')->mount($__name, $__params, 'lw-191613972-14', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'lw-191613972-15', $__slots ?? [], get_defined_vars());
...
<?php endif; ?>
                        ...
                        <?php if($this->hasModule('Customer')): ?>
                            <?php if(user_can('Show Customer')): ?>
                                <?php
$__split = function ($name, $params = []) {
    return [$name, $params];
};
...
$__html = app('livewire')->mount($__name, $__params, 'lw-191613972-16', $__slots ?? [], get_defined_vars());
...
?>
                        ...
                        <?php if($this->hasModule('Staff')): ?>
                            <?php if(user_can('Show Staff Member')): ?>
                                <?php
$__split = function ($name, $params = []) {
    return [$name, $params];
};
...
$__html = app('livewire')->mount($__name, $__params, 'lw-191613972-17', $__slots ?? [], get_defined_vars());
...
?>
                        ...
                        <?php if($this->hasModule('Delivery Executive')): ?>
                            <?php if(user_can('Show Delivery Executive')): ?>
                                <?php
$__split = function ($name, $params = []) {
    return [$name, $params];
};
...
$__html = app('livewire')->mount($__name, $__params, 'lw-191613972-18', $__slots ?? [], get_defined_vars());
...
?>
                        ...
                        <?php if($this->hasModule('Expense') && user_can('Show Expense')): ?>
                            <?php if (isset($component)) { $__componentOriginaleeb5c1102f81a48057b5d734c9cff39b = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginaleeb5c1102f81a48057b5d734c9cff39b = $attributes; } ?>
...
$__html = app('livewire')->mount($__name, $__params, 'lw-191613972-19', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'lw-191613972-20', $__slots ?? [], get_defined_vars());
...
<?php endif; ?>
                        ...
                        <?php if($this->hasModule('Payment')): ?>
                            <?php if(user_can('Show Payments')): ?>
                                <?php if (isset($component)) { $__componentOriginaleeb5c1102f81a48057b5d734c9cff39b = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginaleeb5c1102f81a48057b5d734c9cff39b = $attributes; } ?>
...
$__html = app('livewire')->mount($__name, $__params, 'lw-191613972-21', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'lw-191613972-22', $__slots ?? [], get_defined_vars());
...
<?php endif; ?>
                            <?php endif; ?>
                        <?php endif; ?>
                        <?php if($this->hasModule('Report')): ?>
                            <?php if(user_can('Show Reports')): ?>
                                <?php if (isset($component)) { $__componentOriginaleeb5c1102f81a48057b5d734c9cff39b = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginaleeb5c1102f81a48057b5d734c9cff39b = $attributes; } ?>
...
$__html = app('livewire')->mount($__name, $__params, 'lw-191613972-23', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'lw-191613972-24', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'lw-191613972-25', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'lw-191613972-26', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'lw-191613972-27', $__slots ?? [], get_defined_vars());
...
?>
                                    <?php endif; ?>
                                    <?php if(module_enabled('MultiPOS')): ?>
                                        <?php
$__split = function ($name, $params = []) {
    return [$name, $params];
};
...
$__html = app('livewire')->mount($__name, $__params, 'lw-191613972-28', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'lw-191613972-29', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'lw-191613972-30', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'lw-191613972-31', $__slots ?? [], get_defined_vars());
...
<?php endif; ?>
                        ...
                        <?php $__currentLoopData = custom_module_plugins(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <?php if($this->hasModule('Settings')): ?>
                            <?php if(user_can('Manage Settings')): ?>
                                <?php
$__split = function ($name, $params = []) {
    return [$name, $params];
};
...
$__html = app('livewire')->mount($__name, $__params, 'lw-191613972-32', $__slots ?? [], get_defined_vars());
