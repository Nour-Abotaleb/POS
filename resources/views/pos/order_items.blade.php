            ...
            @if ($orderType == 'dine_in')
                ...
                @if (user_can('Update Order') && !auth()->user()->roles->pluck('display_name')->contains('Waiter'))
                    <div class="inline-flex items-center gap-2">
                        <x-select class="text-xs w-36 xl:w-fit" wire:model.live='selectWaiter'>
            ...
            @if ($hasItems)
                ...
                <div class="flex flex-col gap-2">
                    @forelse ($orderItemList as $key => $item)
                        ...
                        <div class="border border-gray-100 dark:border-gray-700 rounded-md p-3 flex flex-col gap-2 bg-white dark:bg-gray-800 shadow-sm" wire:key='menu-item-{{ $key }}' wire:loading.class.delay='opacity-40'>
