<div class="relative z-40 flex flex-col h-full min-h-0 flex-shrink-0 px-2 py-4 pr-4 bg-white border-l dark:border-gray-700 dark:bg-gray-800 overflow-y-auto overflow-x-hidden self-stretch w-full max-w-full">
    <div>
        ...
        <div class="flex flex-col rounded ">
            <table class="flex-1 min-w-full divide-y divide-gray-200 table-fixed dark:divide-gray-600">
                ...
                <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700" wire:key="menu-item-list">
                    ...
                    @endphp
                    <tr class="hover:bg-gray-100 dark:hover:bg-gray-700" wire:key='menu-item-{{ $key }}' wire:loading.class.delay='opacity-10'>
