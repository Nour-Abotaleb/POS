<div class="relative">
    ...
    <span
        class="inline-flex items-center justify-center px-1 xl:px-2 py-0.5 ms-0.5 xl:ms-2 text-xs font-semibold text-white bg-[var(--brand-primary)] rounded-md" style="background-color: var(--brand-primary); border-color: var(--brand-primary);">
        {{ $count }}
    </span>
</a>
