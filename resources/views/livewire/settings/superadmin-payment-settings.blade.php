    ...
    <div
        ...
        <div class="text-sm font-medium text-center text-gray-500 border-b border-gray-200 dark:text-gray-400 dark:border-gray-700">
            <ul class="flex flex-wrap items-center -mb-px settings-tab-bar">
                <!-- Razorpay -->
                <li class="me-2">
                    <span wire:click="activeSetting('razorpay')" style="{{ $activePaymentSetting == 'razorpay' ? 'color: var(--brand-primary); border-bottom-color: var(--brand-primary);' : '' }}" @class(["inline-flex items-center gap-x-1 cursor-pointer select-none p-4 border-b-2 rounded-t-lg hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300", 'border-transparent' => ($activePaymentSetting != 'razorpay'), 'active' => ($activePaymentSetting == 'razorpay')])>
                ...
                <li wire:click="activeSetting('stripe')" class="me-2">
                    <span style="{{ $activePaymentSetting == 'stripe' ? 'color: var(--brand-primary); border-bottom-color: var(--brand-primary);' : '' }}" @class(["inline-flex items-center gap-x-1 cursor-pointer select-none p-4 border-b-2 rounded-t-lg hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300", 'border-transparent' => ($activePaymentSetting != 'stripe'), 'active' => ($activePaymentSetting == 'stripe')])>
                ...
                <li wire:click="activeSetting('flutterwave')" class="me-2">
                    <span style="{{ $activePaymentSetting == 'flutterwave' ? 'color: var(--brand-primary); border-bottom-color: var(--brand-primary);' : '' }}" @class(["inline-flex items-center gap-x-1 cursor-pointer select-none p-4 border-b-2 rounded-t-lg hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300", 'border-transparent' => ($activePaymentSetting != 'flutterwave'), 'active' => ($activePaymentSetting == 'flutterwave')])>
                ...
                <li wire:click="activeSetting('paypal')" class="me-2">
                    <span style="{{ $activePaymentSetting == 'paypal' ? 'color: var(--brand-primary); border-bottom-color: var(--brand-primary);' : '' }}" @class(["inline-flex items-center gap-x-1 cursor-pointer select-none p-4 border-b-2 rounded-t-lg hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300", 'border-transparent' => ($activePaymentSetting != 'paypal'), 'active' => ($activePaymentSetting == 'paypal')])>
                ...
                <li wire:click="activeSetting('payfast')" class="me-2">
                    <span style="{{ $activePaymentSetting == 'payfast' ? 'color: var(--brand-primary); border-bottom-color: var(--brand-primary);' : '' }}" @class(["inline-flex items-center gap-x-1 cursor-pointer select-none p-4 border-b-2 rounded-t-lg hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300", 'border-transparent' => ($activePaymentSetting != 'payfast'), 'active' => ($activePaymentSetting == 'payfast')])>
                ...
                <li wire:click="activeSetting('paystack')" class="me-2">
                    <span style="{{ $activePaymentSetting == 'paystack' ? 'color: var(--brand-primary); border-bottom-color: var(--brand-primary);' : '' }}" @class(["inline-flex items-center gap-x-1 cursor-pointer select-none p-4 border-b-2 rounded-t-lg hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300", 'border-transparent' => ($activePaymentSetting != 'paystack'), 'active' => ($activePaymentSetting == 'paystack')])>
                ...
                <li wire:click="activeSetting('xendit')" class="me-2">
                    <span style="{{ $activePaymentSetting == 'xendit' ? 'color: var(--brand-primary); border-bottom-color: var(--brand-primary);' : '' }}" @class(["inline-flex items-center gap-x-1 cursor-pointer select-none p-4 border-b-2 rounded-t-lg hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300", 'border-transparent' => ($activePaymentSetting != 'xendit'), 'active' => ($activePaymentSetting == 'xendit')])>
                ...
                <li wire:click="activeSetting('paddle')" class="me-2">
                    <span style="{{ $activePaymentSetting == 'paddle' ? 'color: var(--brand-primary); border-bottom-color: var(--brand-primary);' : '' }}" @class(["inline-flex items-center gap-x-1 cursor-pointer select-none p-4 border-b-2 rounded-t-lg hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300", 'border-transparent' => ($activePaymentSetting != 'paddle'), 'active' => ($activePaymentSetting == 'paddle')])>
                ...
                <li wire:click="activeSetting('offline_payment_method')" class="me-2">
                    <span style="{{ $activePaymentSetting == 'offline_payment_method' ? 'color: var(--brand-primary); border-bottom-color: var(--brand-primary);' : '' }}" @class(["inline-flex items-center gap-x-2 cursor-pointer select-none p-4 border-b-2 rounded-t-lg hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300", 'border-transparent' => ($activePaymentSetting != 'offline_payment_method'), 'active' => ($activePaymentSetting == 'offline_payment_method')])>
