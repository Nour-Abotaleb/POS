        ...
        <ul class="flex flex-wrap -mb-px settings-tab-bar">
            ...
            <li class="me-2">
                <a href="{{ route('settings.index').'?tab=restaurant' }}" wire:navigate
                    style="{{ $activeSetting == 'restaurant' ? 'color: #011646; border-bottom-color: #011646;' : '' }}"
            ...
            <li class="me-2">
                ...
                style="{{ $activeSetting == 'app' ? 'color: #011646; border-bottom-color: #011646;' : '' }}"
            ...
            <li class="me-2">
                ...
                style="{{ $activeSetting == 'currency' ? 'color: #011646; border-bottom-color: #011646;' : '' }}"
            ...
            <li class="me-2">
                ...
                style="{{ $activeSetting == 'email' ? 'color: #011646; border-bottom-color: #011646;' : '' }}"
            ...
            <li class="me-2">
                ...
                style="{{ $activeSetting == 'tax' ? 'color: #011646; border-bottom-color: #011646;' : '' }}"
            ...
            <li class="me-2">
                ...
                style="{{ $activeSetting == 'payment' ? 'color: #011646; border-bottom-color: #011646;' : '' }}"
            ...
            <li class="me-2">
                ...
                style="{{ $activeSetting == 'theme' ? 'color: #011646; border-bottom-color: #011646;' : '' }}"
            ...
            <li class="me-2">
                ...
                style="{{ $activeSetting == 'role' ? 'color: #011646; border-bottom-color: #011646;' : '' }}"
            ...
            <li class="me-2">
                ...
                style="{{ $activeSetting == 'billing' ? 'color: #011646; border-bottom-color: #011646;' : '' }}"
            ...
            <li class="me-2">
                ...
                style="{{ $activeSetting == 'reservation' ? 'color: #011646; border-bottom-color: #011646;' : '' }}"
            ...
            <li class="me-2">
                ...
                style="{{ $activeSetting == 'aboutus' ? 'color: #011646; border-bottom-color: #011646;' : '' }}"
            ...
            <li class="me-2">
                ...
                style="{{ $activeSetting == 'customerSite' ? 'color: #011646; border-bottom-color: #011646;' : '' }}"
              ...
              <li class="me-2">
                ...
                style="{{ $activeSetting == 'receipt' ? 'color: #011646; border-bottom-color: #011646;' : '' }}"
             ...
             <li class="me-2">
                ...
                style="{{ $activeSetting == 'printer' ? 'color: #011646; border-bottom-color: #011646;' : '' }}"
            ...
            <li class="me-2">
                ...
                style="{{ $activeSetting == 'deliverySettings' ? 'color: #011646; border-bottom-color: #011646;' : '' }}"
            ...
            <li class="me-2">
                ...
                style="{{ $activeSetting == 'kotSettings' ? 'color: #011646; border-bottom-color: #011646;' : '' }}"
            ...
            <li class="me-2">
                ...
                style="{{ $activeSetting == 'cancelSettings' ? 'color: #011646; border-bottom-color: #011646;' : '' }}"
            ...
            <li class="me-2">
                ...
                style="{{ $activeSetting == 'orderSettings' ? 'color: #011646; border-bottom-color: #011646;' : '' }}"
