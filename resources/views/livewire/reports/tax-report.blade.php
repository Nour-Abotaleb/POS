    ...
    <div class="p-4 bg-white dark:bg-gray-800">
        ...
        <div class="mb-6 p-6 rounded-xl border" style="background: rgba(194, 194, 194, 0.08); border-color: rgba(206, 206, 206, 0.25);">
            <h2 class="text-xl font-bold text-gray-900 dark:text-white mb-4 flex items-center gap-2">
                <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" style="color: var(--brand-primary);">
            ...
            <div class="grid grid-cols-1 gap-4 sm:grid-cols-3">
                <div class="bg-white dark:bg-gray-800 p-4 rounded-lg shadow">
                    ...
                    <p class="text-2xl font-bold" style="color: var(--brand-primary);">
                ...
                <tbody>
                    @foreach($taxByDate as $dateData)
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700 cursor-pointer transition-colors"
                            ...
                            <td class="px-6 py-4 font-semibold" style="color: var(--brand-primary);">
                    ...
                    <tr class="bg-gray-100 dark:bg-gray-700 font-bold">
                        ...
                        <td class="px-6 py-4" style="color: var(--brand-primary);">
                            {!! currency_format($totalTax, restaurant()->currency_id) !!}
                        </td>
    ...
    <x-dialog-modal wire:model.live="showDateOrdersModal" maxWidth="4xl" maxHeight="full">
        <x-slot name="title">
            <div class="flex items-center gap-2">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" style="color: var(--brand-primary);">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path>
                </svg>
