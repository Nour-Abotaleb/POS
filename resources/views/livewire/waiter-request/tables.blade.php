<div @if(!pusherSettings()->is_enabled_pusher_broadcast && $pollingEnabled) wire:poll.{{ $pollingInterval }}s @endif>
    <div class="p-4 bg-white block  dark:bg-gray-800 dark:border-gray-700 w-full">
        <div class="flex flex-wrap items-center justify-between gap-4 mb-4 w-full">
            <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white shrink-0">@lang('menu.waiterRequest') ({{ $tables->sum(function($area) { return $area->tables->count(); }) }})</h1>
