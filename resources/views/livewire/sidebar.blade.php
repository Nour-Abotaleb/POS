<div>
    <aside id="sidebar"
        class="fixed top-0 ltr:left-0 rtl:right-0 z-20 flex flex-col flex-shrink-0 hidden w-64 h-full pt-16 font-normal duration-75 {{ request()->routeIs('pos.*') ? '' : 'lg:flex' }} transition-width menu-collapsed:hidden"
        aria-label="Sidebar">
