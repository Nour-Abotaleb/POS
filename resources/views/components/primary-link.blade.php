<a {{ $attributes->merge(['class' => 'text-white justify-center sm:w-auto font-semibold rounded-lg text-sm px-5 py-2.5 text-center', 'style' => 'background-color: #011646; border-color: #011646;']) }}
