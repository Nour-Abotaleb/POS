          ...
          <div class="grid gap-4 sm:gap-6 md:gap-8 lg:gap-12">
            ...
            <div class="flex gap-4">
                ...
                <div class="grow">
                  ...
                  <p>
                    <a class="relative inline-block font-medium text-black before:absolute before:bottom-0.5 before:start-0 before:-z-[1] before:w-full before:h-1 before:bg-[#011646] hover:before:bg-black focus:outline-none focus:before:bg-black dark:text-white dark:hover:before:bg-white dark:focus:before:bg-white" href="mailto:@lang('landing.contactEmail')">
