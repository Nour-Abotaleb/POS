    ...
    <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
        ...
        <div class="flex flex-col mb-8 lg:mb-16 space-y-4 sm:flex-row sm:justify-center sm:space-y-0 sm:space-x-4 rtl:space-x-reverse">
            <a href="{{ route('restaurant_signup') }}"
                class="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-white rounded-lg bg-[var(--brand-primary)] hover:bg-[var(--brand-primary)]/[0.7] focus:ring-4 focus:ring-[var(--brand-primary)] dark:focus:ring-[var(--brand-primary)]">
                @if($trialPackage)
        ...
        <div class="relative  max-w-screen-lg flex justify-center mx-auto">
            ...
            <div class="hidden md:block absolute top-0 end-0 -translate-y-12 translate-x-20">
                <svg class="w-16 h-auto" style="color: var(--brand-primary);" width="121" height="135" viewBox="0 0 121 135" fill="none"
                    xmlns="http://www.w3.org/2000/svg">
...
<div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto" id="icon-features">
    ...
    <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-12">
        ...
        <!-- Icon Block -->
        <div>
            <div class="relative flex justify-center items-center size-12 bg-white rounded-xl dark:bg-neutral-900">
                <svg class="size-6 text-[var(--brand-primary)] dark:text-white/90" fill="currentColor" viewBox="0 0 16 16">
        ...
        <div>
            <div class="relative flex justify-center items-center size-12 bg-white rounded-xl dark:bg-neutral-900">
                <svg class="size-6 text-[var(--brand-primary)] dark:text-white/90" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div class="grid gap-4 sm:gap-6 md:gap-8 lg:gap-12">
            ...
            <div class="flex gap-4">
                ...
                <div class="grow">
                  ...
                  <p>
                    <a class="relative inline-block font-medium text-black before:absolute before:bottom-0.5 before:start-0 before:-z-[1] before:w-full before:h-1 before:bg-[var(--brand-primary)] hover:before:bg-black focus:outline-none focus:before:bg-black dark:text-white dark:hover:before:bg-white dark:focus:before:bg-white" href="mailto:@lang('landing.contactEmail')">
