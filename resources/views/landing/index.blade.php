    ...
    <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-12">
        ...
        <div>
            <div class="relative flex justify-center items-center size-12 bg-white rounded-xl dark:bg-neutral-900">
                <svg class="size-6 text-[#011646] dark:text-white/90" fill="currentColor" viewBox="0 0 16 16">
        ...
        <div>
            <div class="relative flex justify-center items-center size-12 bg-white rounded-xl dark:bg-neutral-900">
                <svg class="size-6 text-[#011646] dark:text-white/90" fill="currentColor" viewBox="0 0 24 24">
