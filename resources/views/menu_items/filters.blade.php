    ...
    <div>
        <x-dropdown align="left">
            ...
            <x-slot name="content">
                <div class="block px-4 py-2 text-sm font-medium text-gray-500">
                    <h6 class="text-sm font-medium text-gray-900 dark:text-white">
                        @lang('modules.menu.itemsPerPage')
                    </h6>
                </div>
                @foreach ($perPageOptions as $option)
                    <x-dropdown-link class="flex items-center" wire:key="perpage-option-{{ $option }}">
                        <input id="perpage-{{ $option }}" type="radio" value="{{ $option }}" wire:model.live='perPage'
                            class="w-4 h-4 bg-gray-100 border-gray-300 rounded text-gray-600 focus:ring-gray-500 dark:focus:ring-gray-600 dark:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500" />
                        <label for="perpage-{{ $option }}" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-100">
                            {{ $option }} @lang('modules.menu.items')
                        </label>
                    </x-dropdown-link>
                @endforeach
            </x-slot>
