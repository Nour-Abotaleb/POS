<template>
    ...
    >
        ...
        <div
            class="flex-shrink-0 pb-8 pt-2 bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700 shadow-[0_-4px_12px_rgba(0,0,0,0.05)]"
        >
            <div
                class="h-auto p-4 select-none bg-gray-50 dark:bg-gray-700 space-y-2"
                v-if="cartItems.length > 0"
            >
                <div
            ...
            <div class="h-auto pb-4 pt-3 select-none text-center w-full">
                ...
                <div class="flex gap-3 mt-3">
                    ...
                    <button
                        class="rounded bg-amber-500 text-white w-full p-2 relative"
                        @click="handleSaveOrder('draft')"
                        :disabled="saving"
                        :class="{ 'opacity-50 cursor-not-allowed': saving }"
                    >
                        <span v-if="!saving">Save as draft</span>
                        <span v-else class="inline-flex items-center">
                            <svg
                                class="animate-spin -ml-1 mr-2 h-4 w-4 text-white"
                                xmlns="http://www.w3.org/2000/svg"
